    ...
    public class YYSqlHelper
    {
        ...
        private static string _connectionString
        {
            ...
            get
            {
                ...
                {
                    _connectionString_inner = ConfigurationManager.ConnectionStrings["ConnectionStringYY"].ToString(); 
        ...
        {
            return DecryptPassword(ConfigurationManager.ConnectionStrings["ConnectionStringYY"].ToString());
        }
        ...
        private class ConnectAssistTag : XBase.Data.DBHelper.Utility.IConnectAssist
        {
            ...
            private SqlConnectionStringBuilder builder = new SqlConnectionStringBuilder(YYSqlHelper._connectionString);
            /// <summary>
            /// 更改服务器
            /// </summary>
            ...
            {
               YYSqlHelper._connectionString = builder.ConnectionString;
            }
            ...
            public void ReSet()
            {
                YYSqlHelper._connectionString = ConfigurationManager.ConnectionStrings["ConnectionStringYY"].ToString();
            }
            ...
            {
                YYSqlHelper._connectionString = connectionString;
            }
