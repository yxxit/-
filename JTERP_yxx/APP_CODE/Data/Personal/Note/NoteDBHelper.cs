...
namespace XBase.Data.Personal.Note
{
    ...
    public class PersonalNoteDBHelper
    {
        ...
        /// <returns></returns>
        public static DataTable GetAllReport(DateTime reportDate, UserInfoUtil userInfo)
        {
...
WHERE pda.CompanyCD=@CompanyCD 
	    ...
	    AND DATEDIFF(DAY,pda.StartDate,@Time)>=0 AND DATEDIFF(DAY,@Time, pda.EndDate)>=0 AND pda.Status<>'2' ";
            SqlParameter[] parameters = new SqlParameter[] 
                        {
