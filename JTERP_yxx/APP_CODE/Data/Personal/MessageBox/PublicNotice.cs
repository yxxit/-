...
namespace XBase.Data.Personal.MessageBox
{
	...
	public class PublicNotice
	{
        ...
        {
            string sqlstr = "select top 10 *,convert(varchar(10),CreateDate,120) as ShortCreateDate from  [officedba].PublicNotice  where IsShow='1'  and  CompanyCD='" + CompanyCD + "'   And Status = '1'   order by CreateDate Desc  ";
