        ...
        public static bool InsertScratchpad(string[]  parm  ) {
          ...
          VALUES
           ...
           ,@Remark)";
            ...
            comm.Parameters.Add("@CompanyCD", SqlDbType.VarChar);
            comm.Parameters.Add("@Owner", SqlDbType.Int);
            comm.Parameters.Add("@Title", SqlDbType.VarChar);
            comm.Parameters.Add("@Content", SqlDbType.VarChar);
            comm.Parameters.Add("@RecordsDate", SqlDbType.DateTime);
            comm.Parameters.Add("@Remark", SqlDbType.VarChar);
