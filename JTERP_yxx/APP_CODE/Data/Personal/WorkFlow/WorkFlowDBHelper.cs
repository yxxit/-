...
namespace XBase.Data.Personal.WorkFlow
{
    public class WorkFlowDBHelper
    {
       ...
       /// <summary>
        ...
        {
              string sqlstr ="select  * from  officedba.VFlowWaitProcess  where  Actor= @modifyid and billtypeflag<>15  order    by   ApplyDate desc   ";
              SqlCommand comm = new SqlCommand();
              comm.CommandText = sqlstr;
              comm.Parameters.Add("@modifyid",SqlDbType.Int);
        ...
        /// <param name="userID"></param>
        /// <returns></returns>
        public DataTable GetDeskTopVFlowWaitProcessList_YY(int modifyid)
        {
            string sqlstr = "select  * from  officedba.VFlowWaitProcess  where  Actor= @modifyid and billtypeflag=15  order    by   ApplyDate desc   ";
            SqlCommand comm = new SqlCommand();
            comm.CommandText = sqlstr;
