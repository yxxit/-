   ...
   public class OfficeThingsStorageDBHelper
    {
        ...
        public static bool InserInstorageInfo(OfficeThingsBuyModel OfficeThingsBuyM, string OfficeThingsInStorageInfos)
        {
            try
            {
                ...
                #region 设置参数
                SqlParameter[] paramgas = new SqlParameter[15];
        ...
        public static bool InsertAll(string OfficeThingsBuySql, string OfficeThingsInStorageInfos, string BuyRecordNo, string CompanyCD, string UserID, SqlParameter[] paramgas)
        {
            try
            {
                ...
                for (int i = 1; i < OfficeThingsInStorageArrary.Length; i++) //循环数组
                {
                    ...
                    #endregion
                    #region 设置参数
                    SqlParameter[] OfficeThingsBuyDetailParams = new SqlParameter[9];
        ...
        public static DataTable GetOfficeThingsInstorageInfoList(string BuyRecordNo, string Title, string ThingName, string txtJoinUser, string BuyDeptID, string StartDate, string EndDate, string CompanyID,int pageIndex,int pageCount,string ord, ref int TotalCount)
        {
        ...
        /// <returns>DataTable</returns>
        public static DataTable GetOfficeThingsStorageInfoByID(string ID, string CompanyID)//isnull(sd.ApplyNo,'') as fromBillNo,
        {
