   ...
   public class SalaryPersonalRoyaltySetDBHelper
    {
        ...
        /// </summary>
        /// <returns></returns>
        public static DataTable GetCustList(string OrderNo, string BigType, string Title, string model, int pageIndex, int pageCount, string ord, ref int TotalCount)
        {
            string strCompanyCD = string.Empty;//单位编号
