...
namespace XBase.Data.Office.HumanManager
{
    ...
    public class DeptInfoDBHelper
    {
        ...
        #endregion
        public static int ISHaveRoot()
        {

            #region 查询语句
            //查询SQL拼写
            StringBuilder searchSql = new StringBuilder();
            searchSql.AppendLine(" select count(*) as EmpCount from  officedba.DeptInfo where  CompanyCD = @CompanyCD AND  SuperDeptID is   NULL               ");
        ...
        public static string GETDetptNo()
        {

            #region 查询语句
            //查询SQL拼写
            StringBuilder searchSql = new StringBuilder();
            searchSql.AppendLine(" select deptNo   from  officedba.DeptInfo where  CompanyCD = @CompanyCD AND  SuperDeptID is NULL               ");
            ...
            //执行查询
            return Convert.ToString(SqlHelper.ExecuteScalar(searchSql.ToString(), param));
        }
