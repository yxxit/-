...
namespace XBase.Data.Office.HumanManager
{
    ...
    public class EmployeeInfoDBHelper
    {
        ...
        public static EmployeeInfoModel GetEmployeeInfoWithID(int employeeID)
        {
            ...
            searchSql.AppendLine("      ,A.UFUserId              ");
            searchSql.AppendLine("      ,A.UFUserName            ");
            searchSql.AppendLine("      ,A.ufemployeeid           ");
            searchSql.AppendLine("      ,A.ufemployeename         ");
            searchSql.AppendLine("      ,A.custid           ");
            searchSql.AppendLine("      ,A.custname         ");
            searchSql.AppendLine("      ,isnull(A.roletype,1) as roletype         ");
        ...
        public static DataTable SearchEmployeeWorkInfo(EmployeeSearchModel searchModel,int pageIndex,int pageCount,string ord, ref int TotalCount)
        {
         ...
         //   searchSql.AppendLine(" 	AND A.Flag = @Flag                                               ");
            searchSql.AppendLine(" 	AND (A.Flag = 1 )                                              ");
            #endregion
        ...
        private static EmployeeInfoModel ChangeEmplDataToModel(DataRow data)
        {
            ...
            if (data != null)
            {
                ...
                model.UfpersonId = GetSafeData.ValidateDataRow_String(data, "UFUserId");
                model.Ufpersonname = GetSafeData.ValidateDataRow_String(data, "UFUserName");
                model.UfEmployeeId = GetSafeData.ValidateDataRow_String(data, "ufemployeeid");
                model.UfEmployeename = GetSafeData.ValidateDataRow_String(data, "ufemployeename");
                model.Custid = GetSafeData.ValidateDataRow_String(data, "custid");
                model.Custname = GetSafeData.ValidateDataRow_String(data, "custname");
                model.Roletype = GetSafeData.ValidateDataRow_String(data, "roletype");
                ...
                model.DeptID =data["DeptID"].ToString()==""?0: Convert.ToInt32(data["DeptID"].ToString());
                model.DeptName = data["DeptName"].ToString();
                model.AdminLevelID =data["AdminLevelID"].ToString()==""?0: Convert.ToInt32(data["AdminLevelID"].ToString());
        ...
        public static bool InsertEmployeeInfo(EmployeeInfoModel model)
        {
            ...
            //insertSql.AppendLine("           ,NationalID             ");  //民族
            ...
            //insertSql.AppendLine("           ,Resume,CorrLinkMan,UFUserId,UFUserName,ufemployeeid,ufemployeename,custid,custname,roletype )                ");
            ...
            insertSql.AppendLine("           ,@EnterDate)             ");
            //insertSql.AppendLine("           ,@ProfessionalDes              ");
            //insertSql.AppendLine("           ,@Resume,@CorrLinkMan)");//,'"+model.UfpersonId+"','"+model.Ufpersonname+"','"+model.UfEmployeeId+"','"+model.UfEmployeename+"','"+model.Custid+"','"+model.Custname+"','"+model.Roletype+"' )               ");
            //--------------------------------------------------------------------//
            #endregion
        ...
        public static bool UpdateEmployeeInfo(EmployeeInfoModel model)
        {
            ...
            //updateSql.AppendLine("      ,UFUserId = @UFUserId            ");
            //updateSql.AppendLine("      ,UFUserName = @UFUserName            ");
            //updateSql.AppendLine("      ,ufemployeeid = @ufemployeeid            ");
            //updateSql.AppendLine("      ,ufemployeename = @ufemployeename            ");
            //updateSql.AppendLine("      ,custid = @custid            ");
            //updateSql.AppendLine("      ,custname = @custname            ");
            //updateSql.AppendLine("      ,roletype = @roletype            ");
            //-------------------------------------------------------------------------//
        ...
        private static void SetSaveParameter(SqlCommand comm, EmployeeInfoModel model)
        {
            ...
            //---------------------------金泰恒业 刘锦旗20140331-----------------------------------//
            //comm.Parameters.Add(SqlHelper.GetParameterFromString("@UFUserId", model.UfpersonId));	//员工编码
            //comm.Parameters.Add(SqlHelper.GetParameterFromString("@UFUserName", model.Ufpersonname));	//员工编码

            //comm.Parameters.Add(SqlHelper.GetParameterFromString("@ufemployeeid", model.UfEmployeeId));	//员工编码
            //comm.Parameters.Add(SqlHelper.GetParameterFromString("@ufemployeename", model.UfEmployeename));	//员工编码

            //comm.Parameters.Add(SqlHelper.GetParameterFromString("@custid", model.Custid));	//客户单位编码
            //comm.Parameters.Add(SqlHelper.GetParameterFromString("@custname", model.Custname));	//客户单位名称

            //comm.Parameters.Add(SqlHelper.GetParameterFromString("@roletype", model.Roletype));	//角色分类
            ...
            if (model.EnterDate.ToString()=="0001-01-01 00:00:00")
            {
                model.EnterDate = null;
            }
            ...
            //comm.Parameters.Add(SqlHelper.GetParameterFromString("@CorrLinkMan", model.CorrLinkMan.ToString()));	//关联客户联系人
            //-------------------------------------------------------------------------------------//
        }
        #endregion
        ...
        public static int InsertEmployeeInfoReg(EmployeeInfoModel emploM, TransactionManager tran)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into officedba.EmployeeInfo (");
            strSql.Append("CompanyCD,EmployeeNo,EmployeeName,Sex,CorrLinkMan,Flag,DeptID,AdminLevelID,TotalSeniority,QuarterID,Mobile )");
            strSql.Append(" values (");
            strSql.Append("@CompanyCD,@EmployeeNo,@EmployeeName,@Sex,@CorrLinkMan,'1',0,0,0.0,0,@HandSet )");
            ...
            SqlParameter[] parameters = {
					...
					new SqlParameter("@EmployeeName", SqlDbType.VarChar,50),
                     ...
                     new SqlParameter("@CorrLinkMan",SqlDbType.Int,4),
                      new SqlParameter("@HandSet",SqlDbType.VarChar,20),
                      new SqlParameter("@ID", SqlDbType.Int,0)
					};
            parameters[0].Value =emploM.CompanyCD;
            parameters[1].Value = emploM.EmployeeNo;
            parameters[2].Value = emploM.EmployeeName;
            parameters[3].Value = emploM.Sex;
            parameters[4].Value = emploM.CorrLinkMan;
            parameters[5].Value = emploM.Mobile;
        ...
        //Updateemployeeinfo deptid
        public static void UpdateEmployeeInfo(int empID, int deptID,string CompanyCD,TransactionManager tran)
        {
            StringBuilder sqlstr =new  StringBuilder();
            sqlstr.AppendLine("update officedba.EmployeeInfo set DeptID=@deptid where ID=@ID and CompanyCD=@CompanyCD");
            SqlParameter[] parameters = {
					new SqlParameter("@CompanyCD", SqlDbType.VarChar,8),
        ...
        //根据客户注册用户的employeeID查询负责该客户的主管业务员信息
        public static DataTable GetEmployeeInfoWithCustEmpID(string CompanyCD, int EmployeeID)
        {
            #region 查询SQL拼写
            //查询SQL拼写
            StringBuilder searchSql = new StringBuilder();
            ...
            searchSql.AppendLine("      ,Mobile                ");
            searchSql.AppendLine("  FROM officedba.EmployeeInfo ");
            searchSql.AppendLine(" WHERE ID = (                      ");
            searchSql.AppendLine("	select manager from officedba.custinfo where custno= ( ");
            searchSql.AppendLine("	 select a.CustNo from officedba.CustLinkMan a ");
            searchSql.AppendLine("     left join officedba.EmployeeInfo b on b.corrlinkman=a.id and a.companycd=b.companycd  ");
            searchSql.AppendLine("     where a.companycd='" + CompanyCD + "' and  b.id='" + EmployeeID.ToString() + "' ) ");
