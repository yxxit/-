   ...
   public class CodePublicTypeDBHelper
    {
       ...
       /// <returns></returns>
        ...
        /// <param name="model"></param>
        /// <returns></returns>
        public static bool CheckType(CodePublicTypeModel model)
        {
           
            string sql="select * from officedba.CodePublicType  WHERE  TypeFlag=@TypeFlag and TypeName = @TypeName  and TypeCode  = @TypeCode and   CompanyCD = @CompanyCD and ID<>@ID" ;
