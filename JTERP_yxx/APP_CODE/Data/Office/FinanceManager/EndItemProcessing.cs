...
namespace XBase.Data.Office.FinanceManager
{
  public  class EndItemProcessing
  {
        ...
        string CompanyCD, string ItemID, string PeriodNum, string IsAccount,out int ID)
      {
          ...
          CmdPeriodProced.Parameters.Add("@IsAccount", SqlDbType.VarChar).Value = IsAccount;
          #endregion
      ...
      #region 获取凭证登帐期末调汇信息
        ...
        public static bool UpdateSubjectsYInitialValue(ArrayList modelList)
        {
            ...
            if (modelList.Count > 0)
            {
                ...
                {
                    cmd = new SqlCommand();
                    cmd.Parameters.Add("@YInitialValue", SqlDbType.Decimal).Value = (modelList[i] as AccountSubjectsModel).YInitialValue;
                    cmd.Parameters.Add("@CompanyCD", SqlDbType.VarChar).Value = (modelList[i] as AccountSubjectsModel).CompanyCD;
                    cmd.Parameters.Add("@SubjectsCD", SqlDbType.VarChar).Value = (modelList[i] as AccountSubjectsModel).SubjectsCD;
