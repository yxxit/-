...
namespace XBase.Data.Office.FinanceManager
{
  public  class FixAssetInfoDBHelper
  {
      ...
      private static void InsertFixAssetDeprDetailInfo(ArrayList modelList, ArrayList lstCommand)
      {
          if (modelList.Count > 0)
          {
              ...
              for (int i = 0; i < modelList.Count; i++)
              {
                  ...
                  #region 参数赋值   
                  CmdFixAssetDetail.Parameters.Add("@CompanyCD", SqlDbType.VarChar).Value =(modelList[i] as FixAssetDeprDetailModel).CompanyCD;
                  CmdFixAssetDetail.Parameters.Add("@FixNo", SqlDbType.VarChar).Value = (modelList[i] as FixAssetDeprDetailModel).FixNo;
                  CmdFixAssetDetail.Parameters.Add("@FixName", SqlDbType.VarChar).Value = (modelList[i] as FixAssetDeprDetailModel).FixName;
                  CmdFixAssetDetail.Parameters.Add("@FixType", SqlDbType.Int).Value = (modelList[i] as FixAssetDeprDetailModel).FixType;
                  CmdFixAssetDetail.Parameters.Add("@UsedDate", SqlDbType.DateTime).Value = (modelList[i] as FixAssetDeprDetailModel).UsedDate;
                  CmdFixAssetDetail.Parameters.Add("@Number", SqlDbType.Int).Value = (modelList[i] as FixAssetDeprDetailModel).Number;
                  CmdFixAssetDetail.Parameters.Add("@UsedYears", SqlDbType.Decimal).Value = (modelList[i] as FixAssetDeprDetailModel).UsedYears;
                  CmdFixAssetDetail.Parameters.Add("@EstimateUse", SqlDbType.Decimal).Value = (modelList[i] as FixAssetDeprDetailModel).EstimateUse;
                  CmdFixAssetDetail.Parameters.Add("@OriginalValue", SqlDbType.Decimal).Value = (modelList[i] as FixAssetDeprDetailModel).OriginalValue;
                  CmdFixAssetDetail.Parameters.Add("@MDeprPrice", SqlDbType.Decimal).Value = (modelList[i] as FixAssetDeprDetailModel).MDeprPrice;
                  CmdFixAssetDetail.Parameters.Add("@TotalDeprPrice", SqlDbType.Decimal).Value = (modelList[i] as FixAssetDeprDetailModel).TotalDeprPrice;
                  CmdFixAssetDetail.Parameters.Add("@EndNetValue", SqlDbType.Decimal).Value = (modelList[i] as FixAssetDeprDetailModel).EndNetValue;
                  CmdFixAssetDetail.Parameters.Add("@TotalImpairment", SqlDbType.Decimal).Value = (modelList[i] as FixAssetDeprDetailModel).TotalImpairment;
                  CmdFixAssetDetail.Parameters.Add("@Creator", SqlDbType.Int).Value = (modelList[i] as FixAssetDeprDetailModel).Creator;
                  #endregion
        ...
        string CompanyCD, string ItemID, string PeriodNum, ArrayList lstCommand, ref SqlParameter parms)
      {
          ...
          #region 参数定义
          CmdPeriodProced.Parameters.Add("@CompanyCD", SqlDbType.VarChar).Value = CompanyCD;
          CmdPeriodProced.Parameters.Add("@ItemID", SqlDbType.Int).Value = ItemID;
          CmdPeriodProced.Parameters.Add("@PeriodNum", SqlDbType.VarChar).Value = PeriodNum;
          CmdPeriodProced.Parameters.Add("@IsAccount", SqlDbType.VarChar).Value = "1";
          //定义返回值参数
      ...
      public static bool BuildDepreDetailInfo(ArrayList modelList)
      {
          ...
          if (modelList.Count > 0)
          {
              ...
              {
                  cmd = new SqlCommand();
                  cmd.Parameters.Add("@AttestBillID", SqlDbType.Int).Value = (modelList[i] as AttestBillDetailsModel).AttestBillID;
                  cmd.Parameters.Add("@Abstract", SqlDbType.VarChar).Value = (modelList[i] as AttestBillDetailsModel).Abstract;
                  cmd.Parameters.Add("@SubjectsCD", SqlDbType.VarChar).Value = (modelList[i] as AttestBillDetailsModel).SubjectsCD;
                  cmd.Parameters.Add("@CurrencyTypeID", SqlDbType.Int).Value = (modelList[i] as AttestBillDetailsModel).CurrencyTypeID;
                  cmd.Parameters.Add("@ExchangeRate", SqlDbType.Decimal).Value = (modelList[i] as AttestBillDetailsModel).ExchangeRate;

                  cmd.Parameters.Add("@OriginalAmount", SqlDbType.Decimal).Value = (modelList[i] as AttestBillDetailsModel).OriginalAmount;
                  cmd.Parameters.Add("@DebitAmount", SqlDbType.Decimal).Value = (modelList[i] as AttestBillDetailsModel).DebitAmount;
                  cmd.Parameters.Add("@CreditAmount", SqlDbType.Decimal).Value = (modelList[i] as AttestBillDetailsModel).CreditAmount;
      ...
      public static bool BuildDepreAttestBill(AttestBillModel Attestmodel,out int ID,string ItemID, string PeriodNum)
      {
          ...
          CmdAttest.Parameters.Add("@CompanyCD", SqlDbType.VarChar).Value = Attestmodel.CompanyCD;
          CmdAttest.Parameters.Add("@VoucherDate", SqlDbType.DateTime).Value = Attestmodel.VoucherDate;
          CmdAttest.Parameters.Add("@AttestNo", SqlDbType.VarChar).Value = Attestmodel.AttestNo;
          CmdAttest.Parameters.Add("@AttestName", SqlDbType.VarChar).Value = Attestmodel.AttestName;
          CmdAttest.Parameters.Add("@Creator", SqlDbType.Int).Value = Attestmodel.Creator;
          CmdAttest.Parameters.Add("@status", SqlDbType.Int).Value = Attestmodel.status;
          CmdAttest.Parameters.Add("@FromTbale", SqlDbType.VarChar).Value = Attestmodel.FromTbale;
          CmdAttest.Parameters.Add("@FromValue", SqlDbType.VarChar).Value = Attestmodel.FromValue;
      ...
      public static void UpdateEndItemIsAccount(string ItemID,string PeriodNum, ArrayList lstCommand)
      {
          ...
          cmdOprt.Parameters.Add("@ID", SqlDbType.Int).Value = ItemID;
          cmdOprt.Parameters.Add("@PeriodNum", SqlDbType.VarChar).Value = PeriodNum;
          cmdOprt.Parameters.Add("@IsAccount", SqlDbType.VarChar).Value = '1';
          ...
          FixAssetDeprDetailModel model)
      {
          ...
          #region
          cmdUpdateNetValue.Parameters.Add("@CompanyCD", SqlDbType.VarChar).Value = CompanyCD;
          cmdUpdateNetValue.Parameters.Add("@EndNetValue", SqlDbType.Decimal).Value = EndNetValue;
          cmdUpdateNetValue.Parameters.Add("@FixNo", SqlDbType.VarChar).Value = FixNo;
          cmdUpdateNetValue.Parameters.Add("@AmorDeprRate", SqlDbType.Decimal).Value = AmorDeprRate;
          cmdUpdateNetValue.Parameters.Add("@AmorDeprM", SqlDbType.Decimal).Value = AmorDeprM;
          cmdUpdateNetValue.Parameters.Add("@TotalDeprPrice", SqlDbType.Decimal).Value = TotalDeprPrice;
          #endregion
          ...
          ArrayList DeprPeriodList, string CompanyCD, string PeriodNum, string ItemID, ref int PeriodID, ArrayList FixDeprAfterList)
      {
          ...
          if (DeprPeriodList.Count > 0)
          {
              for (int i = 0; i < DeprPeriodList.Count; i++)
              {
                  ...
                  cmdDeprDetail.Parameters.Add("@EndNetValue", SqlDbType.Decimal).Value = (DeprPeriodList[i] as FixAssetPeriodDeprModel).EndNetValue;
                  cmdDeprDetail.Parameters.Add("@AmorDeprRate", SqlDbType.Decimal).Value = (DeprPeriodList[i] as FixAssetPeriodDeprModel).AmorDeprRate;
                  cmdDeprDetail.Parameters.Add("@AmorDeprM", SqlDbType.Decimal).Value = (DeprPeriodList[i] as FixAssetPeriodDeprModel).AmorDeprM;
                  cmdDeprDetail.Parameters.Add("@TotalDeprPrice", SqlDbType.Decimal).Value = (DeprPeriodList[i] as FixAssetPeriodDeprModel).TotalDeprPrice;
                  cmdDeprDetail.Parameters.Add("@CompanyCD", SqlDbType.VarChar).Value = (DeprPeriodList[i] as FixAssetPeriodDeprModel).CompanyCD;
                  cmdDeprDetail.Parameters.Add("@FixNo", SqlDbType.VarChar).Value = (DeprPeriodList[i] as FixAssetPeriodDeprModel).FixNo;
           ...
           ArrayList cmdlist)        
      {
          ...
          if (DeprPeriodList.Count > 0)
          {
              for (int i = 0; i < DeprPeriodList.Count; i++)
              {
                  ...
                  cmdDeprDetailAfter.Parameters.Add("@CompanyCD", SqlDbType.VarChar).Value = (DeprPeriodList[i] as FixAssetDeprAfterModel).CompanyCD;
                  cmdDeprDetailAfter.Parameters.Add("@FixNo", SqlDbType.VarChar).Value = (DeprPeriodList[i] as FixAssetDeprAfterModel).FixNo;
                  cmdDeprDetailAfter.Parameters.Add("@PeriodNum", SqlDbType.Int).Value = (DeprPeriodList[i] as FixAssetDeprAfterModel).PeriodNum;
                  cmdDeprDetailAfter.Parameters.Add("@EndNetValue", SqlDbType.Decimal).Value = (DeprPeriodList[i] as FixAssetDeprAfterModel).EndNetValue;
                  cmdDeprDetailAfter.Parameters.Add("@TotalDeprPrice", SqlDbType.Decimal).Value = (DeprPeriodList[i] as FixAssetDeprAfterModel).TotalDeprPrice;
                  cmdDeprDetailAfter.Parameters.Add("@AmorDeprRate", SqlDbType.Decimal).Value = (DeprPeriodList[i] as FixAssetDeprAfterModel).AmorDeprRate;
                  cmdDeprDetailAfter.Parameters.Add("@AmorDeprM", SqlDbType.Decimal).Value = (DeprPeriodList[i] as FixAssetDeprAfterModel).AmorDeprM;
