    ...
    public  class AutoVoucherDBHelper
    {
        ...
        public static bool AutoVoucherInsert(int TemplateType, string CompanyCD, string IsVoucher, string IsApply, decimal BillAmount, string FromTBInfo, string CurrencyInfo, int ProOrCustID, out string returnV) 
        {
            ...
            if (IsVoucher == "1")//自动生成凭证
            {
                ...
                comm.Parameters.Add("@CompanyCD", SqlDbType.VarChar).Value = CompanyCD;
                comm.Parameters.Add("@TemType", SqlDbType.Int).Value = TemplateType;
                ...
                if (dt != null && dt.Rows.Count > 0)
                {
                    ...
                    cmd.Parameters.Add("@CompanyCD", SqlDbType.VarChar).Value = CompanyCD;
                    cmd.Parameters.Add("@TemNo", SqlDbType.VarChar).Value = dt.Rows[0]["TemNo"].ToString();
