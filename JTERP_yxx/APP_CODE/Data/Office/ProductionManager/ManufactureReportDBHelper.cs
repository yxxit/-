    ...
    public class ManufactureReportDBHelper
    {
        ...
        public static DataTable GetManufactureReportListBycondition(ManufactureReportModel model, string EFIndex, string EFDesc, int pageIndex, int pageCount, string OrderBy, ref int totalCount)
        {
           ...
           // searchSql.AppendLine("  (select COUNT(*) from officedba.FlowTaskHistory where FlowNo=(SELECT TOP 1 FlowNo FROM officedba.FlowInstance WHERE BillID = a.ID AND BillTypeFlag = @BillTypeFlag AND BillTypeCode = @BillTypeCode) AND BillID = a.ID   AND operateUserId = '" + userInfo.UserID + "')>0 ");
            ...
            searchSql.AppendLine("  (a.Creator IN (SELECT EmployeeID from  officedba.UserInfo where UserID = '" + userInfo.UserID + "')) OR (a.Reporter IN (SELECT EmployeeID from  officedba.UserInfo where UserID = '" + userInfo.UserID + "')) )");
        ...
        private static void GetExtAttrCmd(ManufactureReportModel model, Hashtable htExtAttr, SqlCommand cmd)
        {
            try
            {
                ...
                cmd.Parameters.Add("@ReportNo", model.ReportNo);
        ...
        public static DataTable GetManufactureReportListBycondition_Operating(string CompanyCD, int DeptID, string TaskNo, string ConfirmDateStart, string ConfirmDateEnd, int pageIndex, int pageCount, string OrderBy, ref int totalCount)
        {
            ...
            StringBuilder searchSql = new StringBuilder();
            searchSql.AppendLine("select * from(");
            searchSql.AppendLine("	select	a.ID,a.DeptID,c.DeptName,a.TaskNo,Convert(numeric(16," + point + "),b.CountTotal)CountTotal,Convert(char(20),Convert(numeric(16," + point + "),b.CountTotal))+'&nbsp;' as CountTotal1,isnull( CONVERT(CHAR(10), a.DailyDate, 23),'') as DailyDate,");
            searchSql.AppendLine("			Convert(numeric(16," + point + "),a.ProductionTotal) as ProductionTotal,Convert(char(20),Convert(numeric(16," + point + "),a.ProductionTotal))+'&nbsp;' as ProductionTotal1,a.CompanyCD,");
            searchSql.AppendLine("			Convert(numeric(16," + point + "),a.TakeNum) as TakeNum,Convert(char(20),Convert(numeric(16," + point + "),a.TakeNum))+'&nbsp;' as TakeNum1,Convert(numeric(16," + point + "),a.UsedNum) as UsedNum,Convert(char(20),Convert(numeric(16," + point + "),a.UsedNum))+'&nbsp;' as UsedNum1,");
            searchSql.AppendLine("			a.PlanHRs,a.RealHRs,a.PlanWorkTime,a.AddWorkTime,a.StopWorkTime,Convert(numeric(16," + point + "),a.RealWorkTime)RealWorkTime,Convert(char(20),Convert(numeric(16," + point + "),a.RealWorkTime))+'&nbsp;' as RealWorkTime1,");
            searchSql.AppendLine("			a.OpenCount,Convert(numeric(16," + point + "),a.OpenTime)OpenTime,Convert(char(20),Convert(numeric(16," + point + "),a.OpenTime))+'&nbsp;' as OpenTime1,Convert(numeric(16," + point + "),a.UsePercent)UsePercent,Convert(char(20),Convert(numeric(16," + point + "),a.UsePercent))+'&nbsp;' as UsePercent1,a.Reporter,d.EmployeeName as ReporterReal,");
