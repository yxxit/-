                    ...
                    foreach (string name in ColName)
                    {
                        switch (hs[name].ToString().Split('|')[1].ToLower())
                        {
                            ...
                            case "datetime":
                                ...
                                break;
                            case "float":
                                comm.Parameters.Add("@" + name, SqlDbType.Float);
                            ...
                            case "decimal":
                                ...
                                break;
                            case "text":
                                comm.Parameters.Add("@" + name, SqlDbType.Text);
                                comm.Parameters["@" + name].Value = hs[name].ToString().Split('|')[0] + "";
                                break;
                            case "numeric":
                                comm.Parameters.Add("@" + name, SqlDbType.Decimal);
        ...
        private static bool AddDetailsTable(string DetailsInfoString, string CompanyCD, int pid)
        {
            ...
            foreach (string OntDetailsTableInfo in AllDetailsInfo)
            {
                ...
                foreach (string OneRecord in DetailsRecords)
                {
                    ...
                    {
                        case "varchar":
                            comm.Parameters.Add("@" + ColInfo[0] + ColInfo[1] + tempindex.ToString(), SqlDbType.VarChar);
                            string str = ColInfo[9];
                            comm.Parameters["@" + ColInfo[0] + ColInfo[1] + tempindex.ToString()].Value = ColInfo[9];
                            break;
                        case "int":
                            comm.Parameters.Add("@" + ColInfo[0] + ColInfo[1] + tempindex.ToString(), SqlDbType.Int);
                            str = ColInfo[9];
                            comm.Parameters["@" + ColInfo[0] + ColInfo[1] + tempindex.ToString()].Value = int.Parse(ColInfo[9]);
                            break;
                        case "datetime":
                            comm.Parameters.Add("@" + ColInfo[0] + ColInfo[1] + tempindex.ToString(), SqlDbType.DateTime);
                            if (ColInfo[9] != "")
                            {
                                try
                                {
                            ...
                            break;
                        case "float":
                            comm.Parameters.Add("@" + ColInfo[0] + ColInfo[1] + tempindex.ToString(), SqlDbType.Float);
                            str = ColInfo[9];
                            comm.Parameters["@" + ColInfo[0] + ColInfo[1] + tempindex.ToString()].Value = float.Parse(ColInfo[9]);
                            break;
                        case "char":
                            comm.Parameters.Add("@" + ColInfo[0] + ColInfo[1] + tempindex.ToString(), SqlDbType.Char);
                            comm.Parameters["@" + ColInfo[0] + ColInfo[1] + tempindex.ToString()].Value = char.Parse(ColInfo[9]);
                            break;
                        case "decimal":
                            str = ColInfo[9];
                            comm.Parameters.Add("@" + ColInfo[0] + ColInfo[1] + tempindex.ToString(), SqlDbType.Decimal);
                            if (ColInfo[9] == "")
                            {
                        ...
                        case "text":
                            str = ColInfo[9];
                            comm.Parameters.Add("@" + ColInfo[0] + ColInfo[1] + tempindex.ToString(), SqlDbType.Text);
                            comm.Parameters["@" + ColInfo[0] + ColInfo[1] + tempindex.ToString()].Value = ColInfo[9];
                            break;
                        case "numeric":
                            str = ColInfo[9];
                ...
                col += "pid";
                val += "@pid" + tempindex;
                comm.Parameters.Add("@pid" + tempindex, SqlDbType.Int);
