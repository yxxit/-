        ...
        public static bool ImportContact(List<XBase.Model.Office.CustManager.LinkManModel> modeList)
        {
            ...
            else
            {
                ...
                foreach (XBase.Model.Office.CustManager.LinkManModel model in modeList)
                {
                    ...
                    sbSql.AppendLine(" (CompanyCD,CustNo,LinkType,LinkManName,Sex,Important,Age,Operation,Company,Position,Department,WorkTel,Fax,Handset,HomeTel,MailAddress,CreatedDate,Creator,CanViewUser,Skype,QQ,MSN ) VALUES ");
                    sbSql.AppendLine(" (@CompanyCD,@CustNo,@LinkType,@LinkManName,@Sex,@Important,@Age,@Operation,@Company,@Position,@Department,@WorkTel,@Fax,@Handset,@HomeTel,@MailAddress,@CreatedDate,@Creator,@CanViewUser,@Skype,@QQ,@MSN )");
                    ...
                    sqlParams[index++] = SqlHelper.GetParameter("@Skype", model.Skype);
                    sqlParams[index++] = SqlHelper.GetParameter("@QQ", model.QQ);
                    sqlParams[index++] = SqlHelper.GetParameter("@MSN", model.MSN);
                    #endregion
