...
namespace XBase.Data.Office.SellManager
{
    public class SellOrderDBHelper
    {
        ...
        public static bool Insert(Hashtable ht, SellOrderModel sellOrderModel, List<SellOrderDetailModel> sellOrderDetailModellList,
            List<SellOrderFeeDetailModel> sellOrderFeeDetailModelList, out string strMsg, string[] strCustomdetail)
        {
            ...
            if (NoIsExist(sellOrderModel.OrderNo))
            {
                ...
                try
                {
                    ...
                    InsertSellOrderDetail(sellOrderDetailModellList, tran, strCustomdetail);
        ...
        /// <param name="tran"></param>
        private static void InsertSellOrderDetail(List<SellOrderDetailModel> sellOrderDetailModellList, TransactionManager tran, string[] strCustomdetail)
        {
            int j = 1;
            foreach (SellOrderDetailModel sellOrderDetailModel in sellOrderDetailModellList)
            {
                ...
                strSql.Append(@"CompanyCD,OrderNo,SortNo,ProductID,ProductCount,UnitID,UnitPrice,TaxPrice,Discount,TaxRate,TotalFee,TotalPrice,TotalTax,SendTime,Package,Remark,UsedUnitID,UsedUnitCount,UsedPrice,ExRate,ProductAlias");
                if (((UserInfoUtil)SessionUtil.Session["UserInfo"]).Version == "floor")
                {
                    strSql.Append(@",TotalSquare,Pnumberid,Pnumber,AbrasionResistid,AbrasionResist,BalancePaperid,BalancePaper,BaseMaterialid,BaseMaterial,SurfaceTreatment,BackBottomPlate,BuckleType,PieceCount,TotalNumber");
                }
                //添加扩展项
                ...
                if (((UserInfoUtil)SessionUtil.Session["UserInfo"]).Version == "floor")
                {
                    if (!string.IsNullOrEmpty(sellOrderDetailModel.TotalSquare.ToString()))
                    {
                        strSql.Append(",'" + sellOrderDetailModel.TotalSquare + "'");
                    }
                    else
                    {
                        strSql.Append(",null");
                    }
                    if (!string.IsNullOrEmpty(sellOrderDetailModel.Pnumberid.ToString()))
                    {
                        strSql.Append(",'" + sellOrderDetailModel.Pnumberid + "'");
                    }
                    else
                    {
                        strSql.Append(",null");
                    }
                    if (!string.IsNullOrEmpty(sellOrderDetailModel.Pnumber.ToString()))
                    {
                        strSql.Append(",'" + sellOrderDetailModel.Pnumber + "'");
                    }
                    else
                    {
                        strSql.Append(",null");
                    }
                    if (!string.IsNullOrEmpty(sellOrderDetailModel.AbrasionResistid.ToString()))
                    {
                        strSql.Append(",'" + sellOrderDetailModel.AbrasionResistid + "'");
                    }
                    else
                    {
                        strSql.Append(",null");
                    }
                    if (!string.IsNullOrEmpty(sellOrderDetailModel.AbrasionResist.ToString()))
                    {
                        strSql.Append(",'" + sellOrderDetailModel.AbrasionResist + "'");
                    }
                    else
                    {
                        strSql.Append(",null");
                    }
                    if (!string.IsNullOrEmpty(sellOrderDetailModel.BalancePaperid.ToString()))
                    {
                        strSql.Append(",'" + sellOrderDetailModel.BalancePaperid + "'");
                    }
                    else
                    {
                        strSql.Append(",null");
                    }
                    if (!string.IsNullOrEmpty(sellOrderDetailModel.BalancePaper.ToString()))
                    {
                        strSql.Append(",'" + sellOrderDetailModel.BalancePaper + "'");
                    }
                    else
                    {
                        strSql.Append(",null");
                    }
                    if (!string.IsNullOrEmpty(sellOrderDetailModel.BaseMaterialid.ToString()))
                    {
                        strSql.Append(",'" + sellOrderDetailModel.BaseMaterialid + "'");
                    }
                    else
                    {
                        strSql.Append(",null");
                    }
                    if (!string.IsNullOrEmpty(sellOrderDetailModel.BaseMaterial.ToString()))
                    {
                        strSql.Append(",'" + sellOrderDetailModel.BaseMaterial + "'");
                    }
                    else
                    {
                        strSql.Append(",null");
                    }
                    if (!string.IsNullOrEmpty(sellOrderDetailModel.SurfaceTreatment.ToString()))
                    {
                        strSql.Append(",'" + sellOrderDetailModel.SurfaceTreatment + "'");
                    }
                    else
                    {
                        strSql.Append(",null");
                    }
                    if (!string.IsNullOrEmpty(sellOrderDetailModel.BackBottomPlate.ToString()))
                    {
                        strSql.Append(",'" + sellOrderDetailModel.BackBottomPlate + "'");
                    }
                    else
                    {
                        strSql.Append(",null");
                    }
                    if (!string.IsNullOrEmpty(sellOrderDetailModel.BuckleType.ToString()))
                    {
                        strSql.Append(",'" + sellOrderDetailModel.BuckleType + "'");
                    }
                    else
                    {
                        strSql.Append(",null");
                    }
                    if (!string.IsNullOrEmpty(sellOrderDetailModel.PieceCount.ToString()))
                    {
                        strSql.Append(",'" + sellOrderDetailModel.PieceCount + "'");
                    }
                    else
                    {
                        strSql.Append(",null");
                    }
                    if (!string.IsNullOrEmpty(sellOrderDetailModel.TotalNumber.ToString()))
                    {
                        strSql.Append(",'" + sellOrderDetailModel.TotalNumber + "'");
                    }
                    else
                    {
                        strSql.Append(",null");
                    }
                    //strSql.Append( "','" + sellOrderDetailModel.BackBottomPlate + "','" + sellOrderDetailModel.BuckleType + "','" + sellOrderDetailModel.PieceCount + "','" + sellOrderDetailModel.TotalNumber + "'");
                }
                //扩展项值
                ...
                SqlParameter[] parameters = {
                    ...
                    //,
                    //new SqlParameter("@TotalSquare", SqlDbType.Decimal,9),
                    //new SqlParameter("@Pnumberid", SqlDbType.Int,4),
                    //new SqlParameter("@Pnumber", SqlDbType.VarChar,200),
                    //new SqlParameter("@AbrasionResistid", SqlDbType.Int,4),
                    //new SqlParameter("@AbrasionResist", SqlDbType.VarChar,200),
                    //new SqlParameter("@BalancePaperid", SqlDbType.Int,4),
                    //new SqlParameter("@BalancePaper", SqlDbType.VarChar,200),
                    //new SqlParameter("@BaseMaterialid", SqlDbType.Int,4),
                    //new SqlParameter("@BaseMaterial", SqlDbType.VarChar,200),
                    //new SqlParameter("@SurfaceTreatment", SqlDbType.VarChar,200),
                    //new SqlParameter("@BackBottomPlate", SqlDbType.VarChar,200),
                    //new SqlParameter("@BuckleType", SqlDbType.VarChar,200)
                                            };
                ...
                parameters[20].Value = sellOrderDetailModel.ProductAlias;
        ...
        /// <returns></returns>
        public static DataTable GetOrderList(SellOrderModel sellOrderModel, decimal? TotalPrice1, string SendPro, int? FlowStatus,string EFIndex,string EFDesc, int pageIndex, int pageCount, string ord, ref int TotalCount,string time1,string time2,string prodid,string EFIndexP,string EFDescP)
        {
            ...
            strSql += "select * from ( SELECT s.ID, s.OrderNo,p.productname,Convert(decimal(22," + sellpoint + "), isnull(de.productcount,0)) productcount,";
            if (isMoreUnit)
            {
            ...
            strSql+=" ,s.Title,s.ModifiedDate, CONVERT(varchar(100), s.OrderDate, 23) AS OrderDate,                                          ";
            //strSql += " Convert(decimal(22," + sellpoint + "), isnull(s.RealTotal,0)) RealTotal, c.CustName, e.EmployeeName,                                                                                      ";
            strSql += " Convert(decimal(22," + sellpoint + "), isnull(de.totalPrice,0)) RealTotal, c.CustName, e.EmployeeName, ";
            ...
            strSql += "FROM officedba.SellOrder AS s left join officedba.SellOrderdetail de on s.companycd=de.companycd and s.orderno=de.orderno left join officedba.productinfo p on p.id=de.productid  LEFT JOIN      ";
            ...
            strSql += " (select COUNT(*) from officedba.FlowTaskHistory where FlowNo=(SELECT TOP 1 FlowNo FROM officedba.FlowInstance WHERE BillID = s.ID AND BillTypeFlag = 5 AND BillTypeCode = 3) AND BillID = s.ID  AND operateUserId = '" + userInfo.UserID + "')>0 ";
           ...
           //过滤单据：显示当前用户拥有权限查看的单据
            ...
            strSql += " or ( charindex('," + empid + ",' , ','+s.CanViewUser+',')>0 )) ";
           ...
           if (sellOrderModel.TotalPrice != null && TotalPrice1 != null)
            {
                strSql += " and s.RealTotal  >= @RealTotal and s.RealTotal <= @TotalPrice1 ";
                arr.Add(new SqlParameter("@RealTotal",sellOrderModel.TotalPrice));
            ...
            else
            {
                ...
                {
                    strSql += " and s.RealTotal  >= @RealTotal";
                    arr.Add(new SqlParameter("@RealTotal", sellOrderModel.TotalPrice));
                }
                if (TotalPrice1 != null)
                {
                    strSql += " and s.RealTotal <= @RealTotal";
                    arr.Add(new SqlParameter("@RealTotal", TotalPrice1));
                }
            }
            ...
            if (time1 != "" && time2 != "")
            {
                strSql += " and s.OrderDate between '" + time1 + "' and '" + time2 + "' ";
            }
            else if (time1 == "" && time2 != "")
            {
                strSql += " and s.OrderDate<='" + time2 + "' ";
            }
            else if (time1 != "" && time2 == "")
            {
                strSql += " and s.OrderDate>='" + time1 + "' ";
            }
            //扩展属性
            ...
            if (sellOrderModel.SellType != null)
            {
                strSql += " and s.SellType=@SellType ";
                arr.Add(new SqlParameter("@SellType", sellOrderModel.SellType));
            }
        ...
        public static DataTable GetOrderDetail(string orderNo)
        {
            ...
            string strSql = @"SELECT isnull(s.PieceCount,0)PieceCount,isnull(s.TotalNumber,0)TotalNumber,isnull(s.TotalSquare,0)TotalSquare,
isnull(s.Pnumber,'')Pnumber,isnull(s.Pnumberid,0)Pnumberid,isnull(s.Custom1,'')Custom1,isnull(s.Custom2,'')Custom2,isnull(s.Custom3,'')Custom3,isnull(s.Custom4,'')Custom4,isnull(s.Custom5,'')Custom5,
isnull(s.AbrasionResist,'')AbrasionResist,isnull(s.Custom6,'')Custom6,isnull(s.Custom7,'')Custom7,isnull(s.Custom8,'')Custom8,isnull(s.Custom9,'')Custom9,isnull(s.Custom10,'')Custom10
,isnull(s.AbrasionResistid,0)AbrasionResistid,isnull(s.BalancePaper,'')BalancePaper,isnull(s.BalancePaperid,0)BalancePaperid,isnull(s.BaseMaterial,'')BaseMaterial,isnull(s.BaseMaterialid,0)BaseMaterialid
,isnull(s.SurfaceTreatment,'')SurfaceTreatment,isnull(s.BackBottomPlate,'')BackBottomPlate,isnull(s.BuckleType,'')BuckleType,s.ProductID,s.ProductAlias, s.ProductCount, s.UnitID, s.UnitPrice, s.Discount, s.TaxRate,p.Specification, p.Size,";
        ...
        public static bool UnConfirmOrder(string OrderNO, out string strMsg)
        {
            ...
            if (isHandle(OrderNO, "2"))
            {
                ...
                if (IsRef(OrderNO))
                {
                    ...
                    strSq += " WHERE OrderNo = @OrderNo and CompanyCD=@CompanyCD and isOpenbill=@isOpenbill ";
                    ...
                    try
                    {
                        ...
                        int iiCount = 0;
                        iiCount = Convert.ToInt32(SqlHelper.ExecuteNonQuery(tran.Trans, CommandType.Text, strSq, paras));
                        if (iiCount > 0)
                        { 
                            FlowDBHelper.OperateCancelConfirm(strCompanyCD, 5, 3, OrderId, strUserID, tran);//撤销审批
