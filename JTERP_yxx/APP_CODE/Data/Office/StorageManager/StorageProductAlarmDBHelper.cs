...
namespace XBase.Data.Office.StorageManager
{
    public class StorageProductAlarmDBHelper
    {
        ...
        public static DataTable GetStorageProductAlarm(string AlarmType, StockAccountModel model, string BarCode, int pageIndex, int pageCount, string ord, ref int TotalCount)
        {
            ...
            sql.AppendLine(",ISNULL(d.CodeName,'') as TypeID ,a.Manufacturer ,a.Remark ,a.Size,a.BarCode,a.FromAddr,a.StandardCost,a.StandardSell,a.SellTax,a.SellPrice,a.StandardBuy,a.TaxBuy   ");
            ...
            switch (AlarmType)
            {
                case "0":
                    ...
                    sql.AppendLine("or b.ProductCount<a.MinStockNum)   and (a.MaxStockNum<>0 or a.MinStockNum<>0)					      ");
                    break;
                case "1":
                    sql.AppendLine("and b.ProductCount>a.MaxStockNum   and a.MaxStockNum<>0              ");
                    break;
                case "2":
                    sql.AppendLine("and b.ProductCount<a.MinStockNum    and a.MinStockNum<>0				  ");
                    break;
                default:
                    break;
            }
            sql.AppendLine(" and (a.MaxStockNum<>0 or a.MinStockNum<>0)	");
