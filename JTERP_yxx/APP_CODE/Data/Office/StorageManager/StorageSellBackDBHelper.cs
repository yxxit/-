...
namespace XBase.Data.Office.StorageManager
{
    public class StorageSellBackDBHelper
    {
        ...
        public static DataTable GetInfoByDetalIDList(string strDetailIDList, string CompanyCD)
        {
            ...
            {
             sql.AppendLine( ", p.Pnumber,p.Pnumberid, p.AbrasionResist,p.AbrasionResistid, p.BalancePaper,p.BalancePaperid, p.BaseMaterial,p.BaseMaterialid, p.SurfaceTreatment,p.BackBottomPlate, p.BuckleType ");
            }
