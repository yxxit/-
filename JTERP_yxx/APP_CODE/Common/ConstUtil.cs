...
namespace XBase.Common
{
    ...
    public class ConstUtil
    {
        ...
        #region 人事管理
        /* 人事档案 */
        public static string MODULE_ID_HUMAN_EMPLOYEE_ADD = "555221";//新建人员
        public static string MODULE_ID_HUMAN_EMPLOYEE_WORK = "555222";//在职人员列表
        public static string MODULE_ID_HUMAN_EMPLOYEE_RESERVE = "555223";//人才储备列表
        public static string MODULE_ID_HUMAN_EMPLOYEE_LEAVE = "555224";//离职人员列表
        ...
        public static string MODULE_ID_STORAGE_STORAGEINFO = "555262";//仓库设置
        ...
        public static string MODULE_ID_CAHIXIE = "2051503";//拆卸
        public static string MODULE_ID_ZUZHUANG = "2051505";//组装
        ...
        /*系统模块 添加人：钱锋锋*/
        public static string CODING_RULE_TABLE_Role = "RoleInfo";//角色表 
        public static string Role_EMPLOY_SELECT_Role = "Role_";//角色
        #endregion
        ...
        public static string CODING_RULE_STORAGE_CHAIXIE = "11";//库存盘点单
        public static string CODING_RULE_STORAGE_ZUZHUANG = "12";//库存盘点单
        #endregion
        ...
        public static string CODING_REP_ITEM_ADD= "9";//生产进度汇报
        #endregion
        ...
        //费用申请
        public const string EXPENSES_TYPE_FLAG = "5";  //费用类别分类
        public const string EXPENSES_TYPE_CODE = "6";  //费用类别标志
        public const string EXPENSES_CODINGTYPE = "2"; //费用编号分类标志
        public const string EXPENSES_ITEMTYPEID = "11"; //费用编号分类编码
        ...
        #region 基础属性设置
        //省份区域
        public static string AREA_TYPE_FLAG = "17";//省份设置模块
        public static string AREA_TYPE_CODE = "1";//省份类别标识
        //供应商模块
        public static string PROVIDER_TYPE_FLAGE = "20";//供应商分类模块
        public static string PROVIDER_TYPE_CODE = "1";//供应商类别标志
        //业务类型
        public static string BUSI_TYPE_FLAG = "21";//业务类型模块
        public static string BUSI_TYPE_CODE = "1";//业务类别标识
        //交货方式
        public static string TAKE_TYPE_FLAG = "22";//交货方式模块
        public static string TAKE_TYPE_CODE = "1";//交货类别标识
        //联络期限(天)
        public static string LINK_CYCLE_FLAG = "23";//联络期限(天)模块
        public static string LINK_CYCLE_CODE = "1";//联络期限(天)类别标识
        //支付方式
        public static string MONEY_TYPE_FLAG = "24";//支付方式模块
        public static string MONEY_TYPE_CODE = "1";//支付类别标识
        //结算币种
        public static string CURRENCY_TYPE_FLAG = "25";//结算币种模块
        public static string CURRENCY_TYPE_CODE = "1";//结算币种类别标识
        //发票类型
        public static string BILL_TYPE_FLAG = "26";//发票类型模块
        public static string BILL_TYPE_CODE = "1";//发票类别标识
        //单位性质
        public static string COMPANY_TYPE_FLAG = "27";//单位性质模块
        public static string COMPANY_TYPE_CODE = "1";//单位性质类别标识
        //结算方式
        public static string PAY_TYPE_FLAG = "16";//结算方式模块
        public static string PAY_TYPE_CODE = "1";//结算类别标识
        //运输类型
        public static string CARRY_TYPE_FLAG = "18";//运输类型模块
        public static string CARRY_TYPE_CODE = "1";//运输类型类别标识
        ...
        public static string CUST_TYPE_FLAG = "19";//客户分类模块
        public static string CUST_TYPE_CODE = "1";//客户类别标识
        //客户模块单据打印
        ...
        public static string MODULE_ID_CUST_INFO_ADD = "555231";//新建客户信息
        public static string MODULE_ID_CUST_INFO_LIST = "555232";//客户信息列表
        ...
        public static string SELL_CODINGTYPE = "2";//销售合同编号分类标志
        public static string SELL_ITEMTYPEID = "6";//销售合同编号分类编码
        ...
        public static string PURCHASE_CODINGTYPE = "2";//采购合同编号分类标志
        public static string PURCHASE_ITEMTYPEID = "2";//采购合同编号分类编码

        public static string INWARE_CODINGTYPE = "2";//采购入库编号分类标志
        public static string INWARE_ITEMTYPEID = "5";//采购入库编号分类编码
        #endregion
        ...
        public static string MODULE_ID_PurchaseContract_Add = "80021";//新建采购合同80021
        //public static string MODULE_ID_PurchaseContractInfo = "2041702";//采购合同列表
        public static string MODULE_ID_PurchaseContractInfo = "80022";//采购合同列表80022
        ...
        //供应商档案ModuleID
        public static string MODULE_ID_PROVIDERINFO_ADD = "555241";//新建供应商档案
        ...
        #endregion
        #region 供应链模块
        public static string Menu_AddProduct = "555252";//"2081601";//添加物品
        ...
        public static string MODULE_ID_REP_EDIT = "2061704";//生产进度汇报
        ...
        public static string MODULE_ID_SELLCONTRANCT_ADD = "80011";//销售合同添加
        ...
        //销售订单(外贸)ModelID
        public static string MODULE_ID_SELLORDERFOREIGN_ADD = "2101201";//外贸销售订单添加
        public static string MODULE_ID_SELLORDERFOREIGN_INFO = "2101202";//外贸销售订单列表
        public static string CODING_RULE_TABLE_SELLORDERFOREIGN = "officedba.SellOrderForeign";//销售订单表
        public static string CODING_RULE_COLUMN_SELLORDERFOREIGN_AUTONOPRE = "SDF";//销售订单
        public static string CODING_RULE_COLUMN_SELLORDERFOREIGN_NO = "OrderNo";//销售订单编号
        //成本核算(外贸)ModelID
        public static string MODULE_ID_COSTFOREIGN_ADD = "2101101";//成本核算添加
        public static string MODULE_ID_COSTFOREIGN_INFO = "2101102";//成本核算列表
        public static string CODING_RULE_TABLE_COSTFOREIGN = "officedba.CostForeign";//成本核算表
        public static string CODING_RULE_COLUMN_COSTFOREIGN_AUTONOPRE = "CB";//成本核算
        public static string CODING_RULE_COLUMN_COSTFOREIGN_NO = "CostNo";//成本核算编号

        //销售发货(外贸)ModelID
        public static string MODULE_ID_SELLSENDFOREIGN_ADD = "2101501";//销售出库添加
        public static string MODULE_ID_SELLSENDFOREIGN_INFO = "2101502";//销售出库列表
        public static string CODING_RULE_TABLE_SELLOUTSTORAGEFOREIGN = "officedba.SellOutStorageForeign";//销售出库表
        public static string CODING_RULE_TABLE_SELLSENDFOREIGN = "SellOutStorageForeign，SellOutStorageDetailForeign";//销售出库表

        //销售出库
        public static string CODING_RULE_TABLE_SELLOUTSTORAGE = "officedba.SellOutStorage";//销售出库表
        #endregion

        #region 采购模块ModuleID
        /*采购进货单 ModuleID Ellen*/
        public const string PURCHASE_INSTORAGE_SAVE = "2041901";
        public const string PURCHASE_INSTORAGE_LIST = "2041902";
        #endregion 
        ...
        public static string CODING_RULE_SELLOUT = "SC";//销售出库单编号前缀

        public static string SELLOUT_CODINGTYPE = "2";//采购合同编号分类标志
        public static string SELLOUT_ITEMTYPEID = "12";//采购合同编号分类编码
        #endregion

        #region 发票开票
        public static string MODULE_ID_INVOICEBill_ADD = "2031701";//申请单添加
        public static string MODULE_ID_INVOICEBill_INFO = "2031702";//申请单列表
        public static string CODING_RULE_COLUMN_INVOICEBill_AUTONOPRE = "SQ";//申请
        public static string CODING_RULE_TABLE_INVOICEBill = "officedba.InvoiceBill";//申请表
        public static string CODING_RULE_COLUMN_INVOICEBill = "InvNo";//申请单编号
        #endregion
        ...
        #region 系统管理
        /* 角色档案 */
        public static string MODULE_ID_HUMAN_Role_EDIT = "2011101";//角色设置
        public static string Menu_AddCompany = "21917";//添加帐套
        public static string CODING_RULE_TABLE_Company = "pubdba.company";//角色关联信息表

        #endregion

        #region 基础数据
        public static string CODING_RULE_BASE = "0";//基础数据
        public static string CODING_RULE_PROVIWER = "2";//供应商
        #endregion
    }
}
