...
namespace XBase.Business
{
    ...
    public class LoginBus
    {
        ...
        ///// <returns>DataTable 部门角色信息</returns>
        //public static char[] GetRoleRangeInfo(int RoleID)
        //{
        //    //定义返回的角色数组
        //    char[] role = new char[0];
        //    //获取角色信息
        //    DataTable dtRoleRange = LoginDBHelper.GetRoleRangeInfo(RoleID);
        //    //当角色存在的时候，设置角色到数组中
        //    if (dtRoleRange != null && dtRoleRange.Rows.Count > 0)
        //    {
        //        //获取角色个数
        //        int roleCount = dtRoleRange.Rows.Count;
        //        role = new char[roleCount];
        //        //遍历所有角色，并设值
        //        for (int i = 0; i < roleCount; i++)
        //        {
        //            //设置角色
        //            role[i] = (char)dtRoleRange.Rows[0]["RoleRange"];
        //        }
        //    }
        //    return role;
        //}
        ...
        public static DataTable GetCompany(string userID,string passwordInput)
        {
            ...
            try
            {
                return LoginDBHelper.GetCompany(userID,passwordInput);
            }
            catch (Exception ex)
            {
                return null;
