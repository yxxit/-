...
namespace XBase.Business.Office.SystemManager
{
    ...
    public class UserInfoBus
    {
        ...
        {
            return UserInfoDBHelper.GetUserNum(companyCD);
        }
        /// <summary>
        /// 修改密码
        /// </summary>
        ...
        public static DataTable GetEmployeeInfoDiff(string companyCD)
        {
            ...
            return UserInfoDBHelper.GetEmployeeInfoDiff(companyCD);
        }
        ///<summary>
        ///获取公司名称
        ///</summary>
        ...
        public static DataTable GetCompanyName(string companyCD)
        {
            ...
            return UserInfoDBHelper.GetCompanyName(companyCD);
        }
        ...
        public static bool InsertRegInfo(CustInfoModel CustInfoM, LinkManModel LinkManM, EmployeeInfoModel EmpLoM, UserInfoModel UserInfoM)
        {
            try
            {
                return UserInfoDBHelper.InsertRegInfo(CustInfoM, LinkManM, EmpLoM, UserInfoM);
            }
            catch (Exception ex)
            {
                return false;
