...
namespace XBase.Business.Office.SystemManager
{
    public class ParameterSettingBus
    {
        ...
        /// 定制打印模板宽度设置
        /// </summary>
        public static bool SetPrintWidth(string CompanyCD, string FunctionType, string Status)
        {
            return ParameterSettingDBHelper.SetPrintWidth(CompanyCD, FunctionType, Status);
        }
        #endregion
        #region 验证是否启用辅助核算
        /// <summary>
