...
namespace XBase.Business.Office.AdminManager
{
    public class MeetingRecordBus
    {
        ...
        public static DataTable GetMeetingRecordBycondition(MeetingRecordModel MeetingRecordM, string FileDateBegin, string FileDateEnd, int pageIndex, int pageCount, string ord, ref int TotalCount)
        {
            return MeetingRecordDBHelper.GetMeetingRecordBycondition(MeetingRecordM, FileDateBegin, FileDateEnd, pageIndex, pageCount, ord, ref TotalCount);
        }
        #endregion
