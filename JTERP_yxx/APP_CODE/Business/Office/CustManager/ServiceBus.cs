...
namespace XBase.Business.Office.CustManager
{
    public class ServiceBus
    {
        ...
        #region 根据客户编码获取客户服务信息
        /// <summary>
        /// 根据客户编码获取客户服务信息
        /// </summary>
        /// <param name="CustNo">编码</param>
        /// <returns>查询结果</returns>
        public static DataTable GetCustServiceByCustNo(string CompanyCD, string CustNo, int pageIndex, int pageCount, string OrderBy, ref int totalCount)
        {
            try
            {
                return ServiceDBHelper.GetCustServiceByCustNo(CompanyCD, CustNo, pageIndex, pageCount, OrderBy, ref totalCount);
            }
            catch (System.Exception ex)
            {
                return null;
        ...
        public static DataTable GetCustServiceCountNew(string CustName, string ServeType, string CompanyCD, string LinkDateBegin, string LinkDateEnd, string Executant, string Fashion, string State, string DateType, int pageIndex, int pageCount, string ord, ref int TotalCount)
        {
            try
            {
                return ServiceDBHelper.GetCustServiceCountNew(CustName, ServeType, CompanyCD, LinkDateBegin, LinkDateEnd, Executant, Fashion, State, DateType, pageIndex, pageCount, ord, ref TotalCount);
            }
            catch (Exception ex)
            {
                return null;
