...
namespace XBase.Business.Office.CustManager
{
    public class TalkBus
    {
        ...
        public static DataTable GetTalkInfoBycondition(string CanUserID, string CustName, CustTalkModel CustTalkM, string TalkBegin, string TalkEnd, int pageIndex, int pageCount, string ord, string IsOverTime, ref int totalCount)
        {
            ...
            DataTable dt = TalkDBHelper.GetTalkInfoBycondition(CanUserID,CustName, CustTalkM, TalkBegin, TalkEnd, pageIndex, pageCount, ord,IsOverTime, ref totalCount);
        ...
        public static DataTable GetTalkInfoByCustNo(string CompanyCD, string CustNo, int pageIndex, int pageCount, string OrderBy, ref int totalCount)
        {
            try
            {
                return TalkDBHelper.GetTalkInfoByCustNo(CompanyCD, CustNo, pageIndex, pageCount, OrderBy, ref totalCount);
            }
            catch (System.Exception ex)
            {
                return null;
        ...
        {
            return TalkDBHelper.GetCustContact(CompanyCD);
        }
        #endregion
        #region 获取最近7天待服务的客户
        public static DataTable GetCustService(string CompanyCD)
        {
            return TalkDBHelper.GetCustService(CompanyCD);
        }
        #endregion
    }
}
