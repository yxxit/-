...
namespace XBase.Business.Office.CustManager
{
    ...
    {       
        ...
        {
            return LinkManDBHelper.GetLinkManListEx(companyCD,CustType,Important);
        }
        ...
        /// <returns>联系人列表</returns>
         ...
         public static DataTable GetLinkManByCustNo1(string CompanyCD, string CustNo)
         {
             try
             {
                 return LinkManDBHelper.GetLinkManByCustNo1(CompanyCD, CustNo);
             }
             catch (System.Exception ex)
             {
                 return null;
         ...
         public static DataTable GetLinkManByCustNo2(string CompanyCD, string CustNo, int pageIndex, int pageCount, string OrderBy, ref int totalCount)
         {
             try
             {
                 return LinkManDBHelper.GetLinkManByCustNo2(CompanyCD, CustNo, pageIndex, pageCount, OrderBy, ref totalCount);
             }
             catch (System.Exception ex)
             {
                 return null;
        ...
        #region 根据联系人ID获取是否含有联系人的方法
         ...
         /// <returns></returns>
         public static bool GetLinkManByID(string CompanyCD,string[] LinkManID)
         {
             return LinkManDBHelper.GetLinkManByID(CompanyCD,LinkManID);
         }
        #endregion
