...
namespace XBase.Business.Office.CustManager
{
    public class CustInfoBus
    {
        ...
        public static DataTable GetAdvisoryPriceAttachInfo(CustInfoModel model)
        {
            try
            {
                return CustInfoDBHelper.GetAdvisoryPriceAttachInfo(model);
            }
            catch (System.Exception ex)
            {
                throw ex;
       ...
       
        {
            try
            {
               return CustInfoDBHelper.GetCustInfoBycondition(CustModel, Manager,pageIndex,pageCount,ord,ref TotalCount);
        ...
        {
            return CustInfoDBHelper.isdel(CustID);
        }
        #endregion
        ...
        {
            // return CustInfoDBHelper.ExportCustInfo(CustModel, Manager, CanUserID, CreatedBegin, CreatedEnd, Usebegin,Useend,Certibegin,Certiend,Warbegin,Warend,Powerbegin,Powerend,Gmspbegin,Gmspend,  ord);
        ...
        {
            return CustInfoDBHelper.InsertCustInfoRecord(dr, CompanyCD, EmployeeID, UserID);
        }
        #endregion
        ...
        public static DataTable GetCustTalkByPriorityDetails(string begindate, string enddate, string custName, string Priority, int pageIndex, int pageCount, string ord, ref int TotalCount)
        {
         ...
         #region 根据CustID获取是否含客户的方法
         /// <summary>
         /// 根据CustID获取是否含客户的方法
         /// </summary>
         /// <param name="CustID"></param>
         /// <returns></returns>
         public static bool GetCustInfoByID(string CompanyCD,string[] CustID,string[] CustNo)
         {
             return CustInfoDBHelper.GetCustInfoByID(CompanyCD,CustID, CustNo);
         }
         #endregion
        ...
        public static bool GetAttachment(string CompanyCD, string filename, string realname)
         {
        return CustInfoDBHelper.GetAttachment(CompanyCD, filename, realname);
         }
        #endregion
        ...
        public static string getcustcountbytype(string custtype, string manager,string time1,string time2)
        {
            ...
            return CustInfoDBHelper.getcustcountbytype(custtype, manager,time1,time2);
        }
        #endregion
        #region 获取洽谈次数
        public static string getQTcount(string custtype, string manager, string time1, string time2)
        {
            ...
            return CustInfoDBHelper.getQTcount(custtype, manager, time1, time2);
        }
        #endregion
        ...
        public static string getfwcount(string custtype, string manager, string time1, string time2)
        {
            ...
            return CustInfoDBHelper.getfwcount(custtype, manager, time1, time2);
        }
        #endregion
        #region 洽谈分析
        public static DataTable GetQTCountBytime(int custid, int manger, string begindate, string enddate, int timeType)
        {
            return CustInfoDBHelper.GetQTCountBytime(custid, manger, begindate, enddate, timeType);
        }
        ...
        {
            return CustInfoDBHelper.GetQTCountBytimeDetails(type,timetype,begindate, enddate, manger, CustID, pageIndex, pageCount, ord, ref TotalCount);
        }
        #endregion
        ...
        {
            return CustInfoDBHelper.GetCustsevicecountbytime(custid, manger, begindate, enddate, timeType);
        }
        ...
        {
            return CustInfoDBHelper.GetCustsevicecountbytimedetails(type, timetype, begindate, enddate, manger, CustID, pageIndex, pageCount, ord, ref TotalCount);
        }
        #endregion
        ...
        public static string GetCustNo(string CompanyCD,string CustName)
        {
            ...
            try
            {
                str= CustInfoDBHelper.GetCustNo(CompanyCD,CustName);
            }
            catch (System.Exception ex)
            {
                throw ex;
