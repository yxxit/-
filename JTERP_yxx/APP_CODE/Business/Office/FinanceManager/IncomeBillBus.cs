...
namespace XBase.Business.Office.FinanceManager
{
    public class IncomeBillBus
    {
        ...
        /// <returns>DataTable</returns>
        public static DataTable SearchIncomeInfo(string ProjectID, string IncomeBillNo,  string AcceWay,string CustName, string TotalPrice
            ...
            int pageIndex, int pageSize, string OrderBy, ref int totalCount)
        {
            ...
            try
            {
                return IncomeBillDBHelper.SearchIncomeInfo(ProjectID,CompanyCD,IncomeBillNo,  AcceWay,CustName,
        ...
        public static bool ConfirmIncomeBill(string ID, string billingid, string price, string incomeno)
        {
            ...
            try
            {
                ...
                isSucc = IncomeBillDBHelper.ConfirmIncomeBill(ID, Confirmor.ToString(), billingid, price, incomeno);
                //定义变量
                string remark;
                //成功时
                if (isSucc)
        ...
        public static bool ReConfirmIncomeBill(string ID, string billingid, string price)
        {
            ...
            try
            {
                isSucc = IncomeBillDBHelper.ReConfirmIncomeBill(ID, billingid, price);
                //定义变量
                string remark;
                //成功时
                if (isSucc)
