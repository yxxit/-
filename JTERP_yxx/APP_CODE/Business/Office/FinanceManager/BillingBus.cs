...
namespace XBase.Business.Office.FinanceManager
{
    public class BillingBus
    {
       ...
       /// <returns>decimal</returns>
        ...
        #region 添加开票信息明细
        public static DataTable getdetails(string ordertype,string orderno)
        {
            DataTable dt = new DataTable();
            try
            {
                dt = BillingDBHelper.getdetails(ordertype, orderno);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        #region 获取开票信息明细
        public static DataTable getlist(string ordertype, string orderno)
        {
            DataTable dt = new DataTable();
            try
            {
                dt = BillingDBHelper.getlist(ordertype, orderno);
            }
            catch (Exception ex)
            {
                throw ex;
