...
namespace XBase.Business.Office.PurchaseManager
{
    public class PurchaseAskPriceBus
    {
        ...
        public static bool InsertPurchaseAskPrice(PurchaseAskPriceModel PurchaseAskPriceM
            , List<PurchaseAskPriceDetailModel> PurchaseAskPriceDetailMList, out int IndexIDentity, Hashtable htExtAttr, string[] strCustomdetail)
        {
            try
            {
                ...
                {
                    SqlCommand AddDtl = PurchaseAskPriceDBHelper.InsertPurAskPriceDetail(PurchaseAskPriceDetailM,strCustomdetail,j);
                    lstAdd.Add(AddDtl);
                    j++;
                }
        ...
        private static void GetExtAttrCmd(PurchaseAskPriceModel model, Hashtable htExtAttr, SqlCommand cmd)
        {
            try
            {
                ...
                cmd.Parameters.Add("@CompanyCD",((UserInfoUtil)SessionUtil.Session["UserInfo"]).CompanyCD);
                cmd.Parameters.Add("@AskNo", model.AskNo );
        ...
        public static bool UpdatePurchaseAskPrice(PurchaseAskPriceModel PurchaseAskPriceM
            , List<PurchaseAskPriceDetailModel> PurchaseAskPriceDetailMList, Hashtable htExtAttr,string[] strCustomdetail)
        {
            try
            {
