...
namespace XBase.Business.Office.PurchaseManager
{
    public class PurchaseOrderBus
    {
        ...
        #region insert
        public static bool InsertPurchaseOrder(PurchaseOrderModel PurchaseOrderM, List<PurchaseOrderDetailModel> PurchaseOrderDetailMList, out int IndexIDentity, out string Reason, Hashtable htExtAttr, string[] strCustomdetail)
        {
            try
            {
                IndexIDentity = 0;
                ...
                {
                    SqlCommand AddDetail = PurchaseOrderDBHelper.InsertPurchaseOrderDetail(PurchaseOrderDetailM, OrderNo, strCustomdetail,j);
        ...
        public static bool UpdatePurchaseOrder(PurchaseOrderModel PurchaseOrderM, List<PurchaseOrderDetailModel> PurchaseOrderDetailMList
            , List<ProductModel> ProductMStorList, List<ProductModel> ProductMList, out string Reason, Hashtable htExtAttr, string[] strCustomdetail)
        {
            try
            {
                //判断引用源单数量有没有超过，超过了就不让保存
        ...
        public static DataTable GetPurchaseOrder(PurchaseOrderModel PurchaseOrderM, int pageIndex, int pageCount, string OrderBy, ref int totalCount,string time1,string time2,string prodid)
        {
            try
            {
                DataTable dt = PurchaseOrderDBHelper.GetPurchaseOrder(PurchaseOrderM,pageIndex,pageCount,OrderBy,ref totalCount,time1,time2,prodid);
        ...
        public static DataTable GetPurchaseOrder(PurchaseOrderModel PurchaseOrderM, string OrderBy,string time1,string time2,string prodid)
        {
            try
            {
                DataTable dt = PurchaseOrderDBHelper.GetPurchaseOrder(PurchaseOrderM,OrderBy,time1,time2,prodid);
                return dt;
            }
            catch (Exception ex)
            {
        ...
        public static bool ConfirmPuechaseOrder(string CompanyCD, string ID,string FromType, string OrderNo,out string Reason, List<ProductModel> ProductMList, List<ProductModel> ProductMStorList)
        {
            try
            {
                ...
                //要在采购到货单中做在途量的更新 del 20110503 lcb
                ////回写库存分仓存量表
        ...
        public static DataTable SelectPurchaseOrder(string CompanyCD, string BillStatus, string StartDate, string EndDate, int pageIndex, int pageCount, string OrderBy, ref int totalCount)
        {
            ...
            try
            {
                dt = PurchaseOrderDBHelper.SelectPurchaseOrder(CompanyCD, BillStatus, StartDate, EndDate, pageIndex, pageCount, OrderBy, ref totalCount);
            }
            catch (Exception ex)
            {
            }
            ...
            , int pageIndex, int pageSize, string OrderBy, ref int TotalCount)
        {
            try
            {
                return PurchaseOrderDBHelper.ProdOnRoadQry(CompanyCD, ProductID, ProviderID, StartDate, EndDate, pageIndex, pageSize, OrderBy, ref TotalCount);
            }
            catch (Exception ex)
            {
                throw ex;
