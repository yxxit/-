...
namespace XBase.Business.Office.PurchaseManager
{
    ...
    public class ProviderInfoBus
    {
        ...
        //----------------------------医药行业专用属性 2012-09-22-------------------------------------//
           public static DataTable SelectProviderInfo(int pageIndex, int pageCount, string orderBy, ref int TotalCount, string CustNo, string CustName,  string Manager)  
          //  public static DataTable SelectProviderInfo(int pageIndex, int pageCount, string orderBy, ref int TotalCount, string CustNo, string CustName, string CustNam, string PYShort, string CustType, string CustClass, string AreaID, string CreditGrade, string Manager, string StartCreateDate, string EndCreateDate)
       {
           try
           {
               ...
               return ProviderInfoDBHelper.SelectProviderInfoList(pageIndex, pageCount, orderBy, ref TotalCount, CustNo, CustName,  Manager);
           }
           catch (Exception ex)
           {
               throw ex;
           ...
           //public static DataTable SelectProviderInfo(int pageIndex, int pageCount, string orderBy, ref int TotalCount, string CustNo, string CustName, string CustNam, string PYShort, string CustType, string CustClass, string AreaID, string CreditGrade, string Manager, string StartCreateDate, string EndCreateDate, string Usebegin, string Useend, string Certibegin, string Certiend, string Warbegin, string Warend, string Powerbegin, string Powerend, string Gmspbegin, string Gmspend)
           //{
           //    try
           //    {
           //        return ProviderInfoDBHelper.SelectProviderInfoList(pageIndex, pageCount, orderBy, ref TotalCount, CustNo, CustName, CustNam, PYShort, CustType, CustClass, AreaID, CreditGrade, Manager, StartCreateDate, EndCreateDate);
        ...
        public static DataTable GetProviderInfoByCustNo(string CompanyCD,string CustName,string CustNo,string CustNam,int pageIndex, int pageCount, string order, ref int totalCount)
        {
            try
            {
                return ProviderInfoDBHelper.GetProviderInfoByCustNo(CompanyCD, CustName, CustNo, CustNam, pageIndex, pageCount, order, ref totalCount);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public static DataTable GetAdvisoryPriceAttachInfo(int ID)
        {
            try
            {
                return ProviderInfoDBHelper.GetAdvisoryPriceAttachInfo(ID);
            }
            catch (System.Exception ex)
            {
                throw ex;
        ...
        {
            return ProviderInfoDBHelper.CheckArea(AreaName, compid);
        }
        #endregion

        #region 检验供应商类别
        public static DataTable CheckCustType(string TypeName, string compid)
        {
            return ProviderInfoDBHelper.CheckCustType(TypeName, compid);
        }
        #endregion
        ...
        {
            return ProviderInfoDBHelper.CheckLinkCycle(TypeName, compid);
        }
        #endregion
        ...
        {
            return ProviderInfoDBHelper.InsertProviderInfoRecord(dr, CompanyCD, EmployeeID, UserID);
        }
        #endregion
