...
namespace XBase.Business.Office.PurchaseManager
{
    ...
    public class PurchaseRejectBus
    {
        ...
        public static DataTable SelectPurchaseReject(int pageIndex, int pageCount, string orderBy, ref int TotalCount, string RejectNo, string Title, string TypeID, string Purchaser, string FromType, string ProviderID, string BillStatus, string UsedStatus, string DeptID, string ProjectID, string EFIndex, string EFDesc,string time1,string time2,string prodid,string EFIndexP,string EFDescP)
        {
            try
            {
                return PurchaseRejectDBHelper.SelectRejectList(pageIndex, pageCount, orderBy, ref TotalCount, RejectNo, Title, TypeID, Purchaser, FromType, ProviderID, BillStatus, UsedStatus, DeptID, ProjectID, EFIndex, EFDesc,time1,time2,prodid,EFIndexP,EFDescP);
            }
            catch (Exception ex)
            {
                throw ex;
