...
namespace XBase.Business.Office.ProductionManager
{
    public class ManufactureTaskBus
    {
        ...
        /// <returns></returns>
        public static bool InsertManufactureTask(ManufactureTaskModel model, Hashtable ht, out string ID, string[] strCustomdetail)
        {
            ...
            try
            {
                ...
                succ = ManufactureTaskDBHelper.InsertManufactureTask(model, ht, loginUserID, out ID, strCustomdetail);
                if (!succ)
        ...
        /// <returns></returns>
        public static bool UpdateManufactureTaskInfo(ManufactureTaskModel model, Hashtable ht, string UpdateID, string[] strCustomdetail)
        {
            ...
            try
            {
                ...
                succ = ManufactureTaskDBHelper.UpdateManufactureTaskInfo(model, ht, loginUserID, UpdateID, strCustomdetail);
                if (!succ)
                    logModel.Remark = ConstUtil.LOG_PROCESS_FAILED;
                else
                    logModel.Remark = ConstUtil.LOG_PROCESS_SUCCESS;
        ...
        public static DataTable GetSellOreder(string CompanyCD, string strPlanID)
        {
            try
            {
                return ManufactureTaskDBHelper.GetSellOreder(CompanyCD, strPlanID);
            }
            catch (System.Exception ex)
            {
                throw ex;
        ...
        public static DataTable GetManufactureTaskListBycondition(ManufactureTaskModel model, int FlowStatus, int BillTypeFlag, int BillTypeCode, string CreateDate, string EFIndex, string EFDesc, int pageIndex, int pageCount, string OrderBy, ref int totalCount,string time1,string time2,string time11,string time12)
        {
            try
            {
                return ManufactureTaskDBHelper.GetManufactureTaskListBycondition(model, FlowStatus, BillTypeFlag, BillTypeCode, CreateDate, EFIndex, EFDesc, pageIndex, pageCount, OrderBy, ref totalCount,time1,time2,time11,time12);
            }
            catch (System.Exception ex)
            {
                throw ex;
        ...
        public static DataTable GetManufactureTaskListBycondition_Operating(string CompanyCD, int DeptID, string TaskNo, string MaterialsName, string ConfirmDateStart, string ConfirmDateEnd, int pageIndex, int pageCount, string OrderBy, ref int totalCount)
        {
            try
            {
                return ManufactureTaskDBHelper.GetManufactureTaskListBycondition_Operating(CompanyCD, DeptID,TaskNo,MaterialsName, ConfirmDateStart, ConfirmDateEnd, pageIndex, pageCount, OrderBy, ref totalCount);
            }
            catch (System.Exception ex)
            {
                throw ex;
        ...
        public static DataTable GetProductProgressreport(int pageIndex, int pageCount, string OrderBy, ref int totalCount, string TaskNo, string Productname, string hbno, string startdate1, string enddate1, string task)
        {
            try
            {
                return ManufactureTaskDBHelper.GetProductProgressreport(pageIndex, pageCount, OrderBy, ref totalCount, TaskNo, Productname, hbno, startdate1, enddate1, task);
            }
            catch (System.Exception ex)
            {
                throw ex;
