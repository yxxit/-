...
namespace XBase.Business.Office.ProductionManager
{
    public class MRPBus
    {
        ...
        /// </summary>
        /// <returns>DataTable</returns>
        public static DataTable GetPurchaseMRPDetailInfo(string CompanyCD, string ProductNo, string ProductName, string StartDate, string EndDate
            , int pageIndex, int pageCount, string OrderBy, string OrderByType, ref int totalCount)
        {
            try
            {
                return MRPDBHelper.GetPurchaseMRPDetail(CompanyCD, ProductNo, ProductName, StartDate, EndDate, pageIndex, pageCount, OrderBy, OrderByType, ref totalCount);
            }
            catch (System.Exception ex)
            {
                throw ex;
        ...
        public static Decimal GetStorage(string companycd, string proid)
        {
            try
            {
                return MRPDBHelper.GetStorage(companycd,proid);
            }
            catch (System.Exception ex)
            {
                throw ex;
        ...
        public static bool checkis(string CompanyCD, int ProductID)
        {
            try
            {
                return MRPDBHelper.checkis(CompanyCD, ProductID);
            }
            catch (System.Exception ex)
            {
                throw ex;
