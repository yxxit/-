...
namespace XBase.Business.Office.ProductionManager
{
    public class TakeMaterialBus
    {
        ...
        /// <returns></returns>
        public static bool InsertTakeMaterial(TakeMaterialModel model, Hashtable ht, out string ID, string[] strCustomdetail)
        {
            ...
            try
            {
                ...
                succ = TakeMaterialDBHelper.InsertTakeMaterial(model, ht, loginUserID, out ID, strCustomdetail);
                if (!succ)
        ...
        public static DataTable GetTakeDetailInfo1(string ids)
        {
            try
            {
                return TakeMaterialDBHelper.GetTakeDetailInfo1(ids);
            }
            catch (System.Exception ex)
            {
                throw ex;
        ...
        /// <returns></returns>
        public static bool UpdateTakeMaterialInfo(TakeMaterialModel model, Hashtable ht, string[] strCustomdetail)
        {
            UserInfoUtil userInfo = (UserInfoUtil)SessionUtil.Session["UserInfo"];
            try
            {
                ...
                succ = TakeMaterialDBHelper.UpdateTakeMaterialInfo(model, ht, loginUserID, strCustomdetail);
                if (!succ)
                    logModel.Remark = ConstUtil.LOG_PROCESS_FAILED;
                else
                    logModel.Remark = ConstUtil.LOG_PROCESS_SUCCESS;
        ...
        public static DataTable GetTakeMaterialListBycondition(TakeMaterialModel model, string TakeDateStart, string TakeDateEnd, int BillTypeFlag, int BillTypeCode, int FlowStatus, string EFIndex, string EFDesc, int pageIndex, int pageCount, string OrderBy, ref int totalCount,string time1,string time2,string prodid,string storageid)
        {
            try
            {
                return TakeMaterialDBHelper.GetTakeMaterialListBycondition(model, TakeDateStart, TakeDateEnd, BillTypeFlag, BillTypeCode, FlowStatus, EFIndex, EFDesc, pageIndex, pageCount, OrderBy, ref totalCount,time1,time2,prodid,storageid);
            }
            catch (System.Exception ex)
            {
                throw ex;
        ...
        public static bool ConfirmOrCompleteTakeMaterial(TakeMaterialModel model, int OperateType)
        {
            ...
            try
            {
                isscuss= TakeMaterialDBHelper.ConfirmOrCompleteTakeMaterial(model, loginUserID, OperateType);
            }
            catch (Exception ex)
            {
        ...
        public static DataTable GetTakeMaterialListBycondition_Operating(string CompanyCD, int ProcessDeptID, string TaskNo, string ProdNo, string ProductName, string ConfirmDateStart, string ConfirmDateEnd, int pageIndex, int pageCount, string OrderBy, ref int totalCount, string ProjectID, string sltManufactureType)
        {
            try
            {
                return TakeMaterialDBHelper.GetTakeMaterialListBycondition_Operating(CompanyCD,ProcessDeptID,TaskNo,ProdNo,ProductName,ConfirmDateStart,ConfirmDateEnd,pageIndex,pageCount,OrderBy,ref totalCount,ProjectID,sltManufactureType);
            }
            catch (System.Exception ex)
            {
                throw ex;
        ...
        {
            return TakeMaterialDBHelper.ISBigUseCountWhenCant(model);
        }
        #endregion
        ...
        public static DataTable GetTakeMaterialSum_Operating(string CompanyCD, string ProdNo, string ProductName, string ConfirmDateStart, string ConfirmDateEnd, int pageIndex, int pageCount, string OrderBy, ref int totalCount)
        {
            try
            {
                return TakeMaterialDBHelper.GetTakeMaterialSum_Operating(CompanyCD, ProdNo, ProductName, ConfirmDateStart, ConfirmDateEnd, pageIndex, pageCount, OrderBy, ref totalCount);
            }
            catch (System.Exception ex)
            {
                throw ex;
