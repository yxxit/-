...
namespace XBase.Business.Office.SupplyChain
{
    public class TableCellsBus
    {
        public static bool Add(TableExtFields tableExtFields, out string strMsg, string CustomValues,string pCustomValues)
        {
            ...
            try
            {
                isSuc = TableCellsDBHelper.Add(tableExtFields, out strMsg, CustomValues,pCustomValues);
                //设置操作成功标识
                remark = "成功";
        ...
        public static bool Update(TableExtFields tableExtFields, out string strMsg, string CustomValues,string pCustomValues)
        {
            ...
            try
            {
                isSuc = TableCellsDBHelper.Update(tableExtFields, out strMsg, CustomValues,pCustomValues);
                //设置操作成功标识
                remark = "成功";
        ...
        {
            return TableCellsDBHelper.Getlist(FunctionModule, FormType, CompanyCD, BranchID, EFDesc, ModelNo, pageIndex, pageCount, ord, ref  TotalCount);
        }
        ...
        {
            return TableCellsDBHelper.GetAllList(CompanyCD, BranchID, TableName);
        }
        ...
        {
            return TableCellsDBHelper.GetDataByNo(CompanyCD, BranchID, ModelNo);
        }
        /// <summary>
        /// 编辑查看
        /// </summary>
        ...
        {
            return TableCellsDBHelper.IsHaveRepeatNo(CompanyCD, BranchID, ModelNo);
        }
        /// <summary>
        /// 编辑查看
        /// </summary>
        ...
        {
            return TableCellsDBHelper.IsHaveAttr(CompanyCD, BranchID, TableName);
        }
        ...
        public static bool Delete(string strCompanyCD, string IDS, string BranchID, out string strMsg, out string strFieldText)
        {
            ...
            try
            {
                isSucc = TableCellsDBHelper.Delete(strCompanyCD, IDS, BranchID, out strMsg, out strFieldText);
                //设置操作成功标识
            ...
            {
                SellLogCommon.InsertLog(orderNoS[i], "2081310", "officedba.TableCells", remark, "删除");
            }
