...
namespace XBase.Business.Office.StorageManager
{
    public class StorageOutSellBus
    {
        ...
        {
            return StorageOutSellDBHelper.GetStorageOutSellTableBycondition(model, timeStart, timeEnd, SendNo, EFIndex,EFDesc,pageIndex, pageCount, ord, ref TotalCount,time1,time2,prodid,EFIndexP,EFDescP);
        }
        ...
        {
            return StorageOutSellDBHelper.GetStorageOutSellTableBycondition(model, IndexValue, TxtValue, timeStart, timeEnd, SendNo,BatchNo, orderby,time1,time2,prodid,EFIndexP,EFDescP);
        }
        #endregion
        ...
        {
            return StorageOutSellDBHelper.GetStorageOutSellDetailInfo1(model);
        }
        #endregion 
        ...
        /// <returns></returns>
        public static bool InsertStorageOutSell(StorageOutSellModel model, List<StorageOutSellDetailModel> modelList, Hashtable ht, out int IndexIDentity, string[] strCustomdetail)
        {
            IndexIDentity = 0;
            //获取登陆用户信息
            ...
            {
                //执行更新
                isSucc = StorageOutSellDBHelper.InsertStorageOutSell(model, modelList,ht, out IndexIDentity,strCustomdetail);
        ...
        /// <param name="modelList"></param>
        /// <returns></returns>
        public static bool UpdateStorageOutSell(StorageOutSellModel model, Hashtable ht, List<StorageOutSellDetailModel> modelList, string[] strCustomdetail)
        {
            //获取登陆用户信息
            UserInfoUtil userInfo = (UserInfoUtil)SessionUtil.Session["UserInfo"];
            //设置公司代码
            ...
            {
                //执行更新
                isSucc = StorageOutSellDBHelper.UpdateStorageOutSell(model, ht, modelList, strCustomdetail);
            }
            catch (Exception ex)
            {
                //输出日志
        ...
        public static bool unconfirm(StorageOutSellModel model)
        {
            ...
            {
                //执行更新
                isSucc = StorageOutSellDBHelper.unconfirm(model);
            }
            catch (Exception ex)
            {
                //输出日志
        ...
        {
            return StorageOutSellDBHelper.CheckIsUnfirm(model);
        }
        #endregion
        #region 获取销售发货通知单
        /// <summary>
        ...
        {
            return StorageOutSellDBHelper.GetSSDetailInfo(CompanyCD, SendNo, Title,CustID);
        }
        #endregion
