...
namespace XBase.Business.Office.StorageManager
{
    public class StorageInProcessBus
    {
        ...
        {
            return StorageInProcessDBHelper.GetStorageInProcessTableBycondition(BatchNo,model, timeStart, timeEnd, StorageID, FromBillNo, pageIndex, pageCount, ord, ref TotalCount,proname,time1,time2);
        }
        ...
        {
            return StorageInProcessDBHelper.GetStorageInProcessTableBycondition(BatchNo,model, timeStart, timeEnd, StorageID, FromBillNo, orderby,proname,time1,time2);
        }
        #endregion
        ...
        /// </summary>
        /// <returns>DataTable</returns>
        public static bool InsertStorageInProcess(StorageInProcessModel model, System.Collections.Generic.List<StorageInProcessDetailModel> modellist, Hashtable htExtAttr, out int IndexIDentity, string[] strCustomdetail)
        {
            IndexIDentity = 0;
            //获取登陆用户信息
            ...
            {
                //执行更新
                isSucc = StorageInProcessDBHelper.InsertStorageInProcess(model, modellist, htExtAttr, out IndexIDentity, strCustomdetail);
        ...
        public static bool UpdateStorageInProcess(StorageInProcessModel model, List<StorageInProcessDetailModel> modellist, Hashtable htExtAttr, string[] strCustomdetail)
        {
            ...
            {
                //执行更新
                isSucc = StorageInProcessDBHelper.UpdateStorageInProcess(model, modellist, htExtAttr, strCustomdetail);
            }
            catch (Exception ex)
            {
                //输出日志
        ...
        public static bool unconfirm(StorageInProcessModel model)
        {
            ...
            {
                //执行更新
                isSucc = StorageInProcessDBHelper.unconfirm(model);
            }
            catch (Exception ex)
            {
                //输出日志
        ...
        {
            return StorageInProcessDBHelper.CheckIsUnfirm(model);
        }
        #endregion
