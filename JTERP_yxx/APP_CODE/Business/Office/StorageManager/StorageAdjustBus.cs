  ...
  public  class StorageAdjustBus
    {
      ...
      {
          return StorageAdjustDBHelper.checkcount(id, type, ref msg);
      }
      public static bool ConfirmBill(string id)
      {
          return StorageAdjustDBHelper.ConfirmBill(id);
      }
      ...
      {
          return StorageAdjustDBHelper.GetAllAdjust(model, EFIndex, EFDesc,BetinTime,EndTime,FlowStatus,ref TotalCount,productname);
      }
      ...
      {
          return StorageAdjustDBHelper.UnConfirmBill(id);
      }
