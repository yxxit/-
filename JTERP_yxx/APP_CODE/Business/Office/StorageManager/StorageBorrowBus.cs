...
namespace XBase.Business.Office.StorageManager
{
    public class StorageBorrowBus
    {
        ...
        {
            return XBase.Data.Office.StorageManager.StorageBorrowDBHelper.GetStorageList(EFIndex, EFDesc,PageIndex, PageSzie, OrderBy, ref TotalCount, borrow, StartTime, EndTime, SubmitStatus,productname);
        }
        /*不分页*/
        ...
        {
            return XBase.Data.Office.StorageManager.StorageBorrowDBHelper.GetStorageList( EFIndex,  EFDesc,borrow,OrderBy,StartTime, EndTime, SubmitStatus,productname);
        }
        #endregion
