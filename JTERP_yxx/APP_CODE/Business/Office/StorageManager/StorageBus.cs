...
;
        ...
        public static DataTable GetStorageCompare(int storageID, string begindate, string enddate, int ByTimeType, int custid, string proname)
        {
            string companyCD = ((UserInfoUtil)SessionUtil.Session["UserInfo"]).CompanyCD;
            return StorageDBHelper.GetStorageCompare(companyCD, storageID, begindate, enddate, ByTimeType,custid,proname);
        }

        public static DataTable GetStorageCompareDetails(int storageID, int ProductID, string begindate, string enddate, int ByTimeType, string order, int pageindex, int pagesize, ref int recordCount, int custid, string proname)
        {
            string companyCD = ((UserInfoUtil)SessionUtil.Session["UserInfo"]).CompanyCD;
            return StorageDBHelper.GetStorageCompareDetails(companyCD, storageID, ProductID, begindate, enddate,ByTimeType, pageindex, pagesize, ref recordCount,custid,proname);
        }
