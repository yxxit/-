...
namespace XBase.Business.Office.StorageManager
{
    public class StorageInOtherBus
    {
        ...
        {
            return StorageInOtherDBHelper.GetStorageInOtherTableBycondition(BatchNo,model, StorageID, timeStart, timeEnd, pageIndex, pageCount, ord, ref TotalCount,time1,time2,prodid);
        }
        ...
        {
            return StorageInOtherDBHelper.GetStorageInOtherTableBycondition(BatchNo,model, StorageID, timeStart, timeEnd, orderby,time1,time2,prodid);
        }
        #endregion
        ...
        public static bool InsertStorageInOther(StorageInOtherModel model, List<StorageInOtherDetailModel> modelList, Hashtable htExtAttr, out int IndexIDentity, string[] strCustomdetail)
        {
            ...
            {
                //执行更新
                isSucc = StorageInOtherDBHelper.InsertStorageInOther(model, modelList, htExtAttr, out IndexIDentity, strCustomdetail);
            }
            catch (Exception ex)
            {
                //输出日志
        ...
        public static bool UpdateStorageInOther(StorageInOtherModel model, List<StorageInOtherDetailModel> modelList, Hashtable htExtAttr, string[] strCustomdetail)
        {
            ...
            {
                //执行更新
                isSucc = StorageInOtherDBHelper.UpdateStorageInOther(model, modelList, htExtAttr, strCustomdetail);
            }
            catch (Exception ex)
            {
                //输出日志
        ...
        {
            return StorageInOtherDBHelper.CheckIsUnfirm(model);
        }
        #endregion
        ...
        public static bool Unconfirm(StorageInOtherModel model)
        {
            ...
            {
                //执行更新
                isSucc = StorageInOtherDBHelper.Unconfirm(model);
            }
            catch (Exception ex)
            {
                //输出日志
