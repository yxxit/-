...
namespace XBase.Business.Office.StorageManager
{
    public class StorageLossBus
    {
        ...
        {
            return StorageLossDBHelper.GetStorageLossTableBycondition(model, timeStart, timeEnd, TotalPriceStart, TotalPriceEnd, FlowStatus, EFIndex, EFDesc, pageIndex, pageCount, ord, ref TotalCount, productname);
        }
        ...
        {
            return StorageLossDBHelper.GetStorageLossTableBycondition(model, IndexValue, TxtValue, timeStart, timeEnd, TotalPriceStart, TotalPriceEnd, FlowStatus, BatchNo, orderby, productname);
        }
        #endregion

        public static bool CheckCount(StorageLossModel model,ref string msg)
        {
            return StorageLossDBHelper.CheckCount(model,ref msg);
        }
