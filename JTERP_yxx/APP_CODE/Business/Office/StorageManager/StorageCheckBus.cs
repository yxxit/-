...
namespace XBase.Business.Office.StorageManager
{
    public class StorageCheckBus
    {
        ...
        {
            return XBase.Data.Office.StorageManager.StorageCheckDBHelper.GetStorageCheckList(htPara, EFIndex, EFDesc, PageIndex, PageSize, OrderBy, ref TotalCount, productname);
        }
        ...
        {
            return XBase.Data.Office.StorageManager.StorageCheckDBHelper.GetStorageCheckList(htPara, EFIndex, EFDesc,BatchNo, PageIndex, PageSize, OrderBy, ref TotalCount,productname);
        }
        ...
        {
            return XBase.Data.Office.StorageManager.StorageCheckDBHelper.GetStorageCheckList(htPara, IndexValue, TxtValue, BatchNo,OrderBy,productname);
        }
