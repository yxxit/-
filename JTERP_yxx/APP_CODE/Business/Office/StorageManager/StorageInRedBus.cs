...
namespace XBase.Business.Office.StorageManager
{
    public class StorageInRedBus
    {
        ...
        {
            return StorageInRedDBHelper.GetStorageInRedTableBycondition(BatchNo,model, timeStart, timeEnd, pageIndex, pageCount, ord, ref TotalCount,prodid);
        }
        ...
        {
            return StorageInRedDBHelper.GetStorageInRedTableBycondition(BatchNo,model, timeStart, timeEnd, orderby,prodid);
        }
        #endregion
        ...
        public static bool unconfirm(StorageInRedModel model)
        {
            ...
            {
                //执行更新
                isSucc = StorageInRedDBHelper.unconfirm(model);
            }
            catch (Exception ex)
            {
                //输出日志
