...
namespace XBase.Business.Office.StorageManager
{
    public class StorageInPurchaseBus
    {
        ...
        public static DataTable GetStorageInPurchaseTableBycondition(string BatchNo, StorageInPurchaseModel model, string timeStart, string timeEnd, string FromBillNo, string StorageID, int pageIndex, int pageCount, string ord, ref int TotalCount,string time1,string time2,string prodid)
        {
            try
            {
                return StorageInPurchaseDHHelper.GetStorageInPurchaseTableBycondition(BatchNo, model, timeStart, timeEnd, FromBillNo, StorageID, pageIndex, pageCount, ord, ref TotalCount,time1,time2,prodid);
            }
        ...
        public static DataTable GetStorageInPurchaseTableBycondition(string BatchNo, StorageInPurchaseModel model, string timeStart, string timeEnd, string FromBillNo, string StorageID, string orderby,string time1,string time2,string prodid)
        {
            try
            {
                return StorageInPurchaseDHHelper.GetStorageInPurchaseTableBycondition(BatchNo, model, timeStart, timeEnd, FromBillNo, StorageID, orderby,time1,time2,prodid);
            }
            catch (System.Exception ex)
            {
                throw ex;
        ...
        /// <returns></returns>
        public static bool InsertStorageInPurchase(StorageInPurchaseModel model, List<StorageInPurchaseDetailModel> modelList, Hashtable ht, out int IndexIDentity, string[] strCustomdetail)
        {
            IndexIDentity = 0;
            //获取登陆用户信息
            ...
            {
                //执行更新
                isSucc = StorageInPurchaseDHHelper.InsertStorageInPurchase(model, modelList, ht, out IndexIDentity, strCustomdetail);
        ...
        /// <param name="model"></param>
        /// <returns></returns>
        public static bool UpdateStorageInPurchase(StorageInPurchaseModel model, List<StorageInPurchaseDetailModel> modelList, Hashtable ht, string[] strCustomdetail)
        {
            ...
            {
                //执行更新
                isSucc = StorageInPurchaseDHHelper.UpdateStorageInPurchase(model, modelList, ht, strCustomdetail);
            }
            catch (Exception ex)
            {
                //输出日志
        ...
        {
            return StorageInPurchaseDHHelper.CheckIsUnfirm(model);
        }
        #endregion
        public static bool unconfirm(StorageInPurchaseModel model)
        {
            ...
            {
                //执行更新
                isSucc = StorageInPurchaseDHHelper.unconfirm(model);
            }
            catch (Exception ex)
            {
                //输出日志
