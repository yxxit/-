...
namespace XBase.Business.Office.StorageManager
{
    public class StorageOutRedBus
    {
        ...
        {
            return StorageOutRedDBHelper.GetStorageOutRedTableBycondition(model, timeStart, timeEnd,EFIndex,EFDesc, pageIndex, pageCount, ord, ref TotalCount,prodid);
        }
        ...
        {
            return StorageOutRedDBHelper.GetStorageOutRedTableBycondition(model, IndexValue, TxtValue, timeStart, timeEnd,BatchNo, orderby,prodid);
        }
        #endregion
        ...
        public static bool unconfirm(StorageOutRedModel model)
        {
            ...
            {
                //执行更新
                isSucc = StorageOutRedDBHelper.unconfirm(model);
            }
            catch (Exception ex)
            {
                //输出日志
