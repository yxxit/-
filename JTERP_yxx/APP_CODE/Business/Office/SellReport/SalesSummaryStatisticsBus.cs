...
namespace XBase.Business.Office.SellReport
{
    public class SalesSummaryStatisticsBus
    {
        ...
        {
            return XBase.Data.Office.SellReport.SalesSummaryStatisticsDBHelper.GetSalesSummary(strCompanyCD,startTime, endTime, sumType, pageIndex, pageSize, orderBy, ref totalCount);
        }
