...
<body>
    ...
    <input id="hf_typeflag" type="hidden" runat="server" />
                        ...
                        <td bgcolor="#FFFFFF">
                            <table width="100%" border="0" cellpadding="2" cellspacing="1" bgcolor="#CCCCCC"
                                ...
                                <tr class="table-item">
                                    ...
                                    <td class="tdColInput">
                                       <select id="UsedStatus" runat="server" name="SetPro2"   class="tddropdlist">
                    ...
                    <tr class="menutitle1">
                        ...
                        <td align="right" valign="middle">
                            <img alt="新建" src="../../../Images/Button/Bottom_btn_new.png" 
                                onclick="Show();" runat="server" visible="false" id="btnNew"/>
                            &nbsp;
                            <img alt="" src="../../../Images/Button/Main_btn_delete.png" 
...
<script src="../../../js/jthy/sysmanage/CodePublicType.js" type="text/javascript"></script>
