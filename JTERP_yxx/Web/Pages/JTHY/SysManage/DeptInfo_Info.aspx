              ...
              <td bgcolor="#FFFFFF"><table width="100%"border="0" cellpadding="0" cellspacing="0"   id="mainindex">
                <tr>
                  ...
                  <td align="left" valign="top" bgcolor="#FFFFFF"><table width="99%" border="0" style="margin-right:10%;margin-top:5%;" align="center" cellpadding="0" cellspacing="0" >
                      ...
                      <tr>
                        <td colspan="2"><img src="../../../Images/Button/Bottom_btn_new.png" alt="新建" visible="false" id="btnNew" runat="server" style="cursor:hand"  onclick="DoEditDept('3');"/> </td>
                      </tr>
                      <tr>
                        ...
                        <tr>
                            <td  colspan="2">
                                ...
                                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" id="tblBaseInfo" style="display:block">
                                    <tr>
                                        <td height="20" align="right"  class="td_list_fields" width="8%">机构编号<span class="redbold">*</span></td>
                                        ...
                                        <td height="20" align="right"  class="td_list_fields" width="8%">上级机构</td>
                                        ...
                                        <td height="20" align="right"  class="td_list_fields" width="8%">独立核算</td>
                                        <td height="20" class="tdColInput" width="22%">
                                    ...
                                    <tr>
                                        <td height="20" align="right"  class="td_list_fields" width="8%">机构名称<span class="redbold">*</span></td>
                                        ...
                                        <td height="20" align="right"  class="td_list_fields" width="8%">拼音代码<span class="redbold">*</span></td>
                                        <td height="20" class="tdColInput" width="24%">
                                            <asp:TextBox ID="txtPYShort" runat="server"  CssClass="tdinput"  MaxLength ="50"></asp:TextBox> 
                                        </td>
                                       <td height="20" align="right"  class="td_list_fields">启用状态<span class="redbold">*</span></td>
                                    ...
                                    <tr>
                                        <td height="20" align="right"  class="td_list_fields" >是否分公司</td>
                                        <td height="20" class="tdColInput">
                                        ...
                                        <td height="20" align="right"  class="td_list_fields">是否分店</td>
                                        <td height="20" class="tdColInput">
                                    ...
                                    <tr>
                                     <td height="20" align="right"  class="td_list_fields" >描述信息</td>
                                        <td height="20" class="tdColInput" colspan="5">
                                            <asp:TextBox ID="txtDescription" runat="server" MaxLength="50" Width="100%" CssClass="tdinput"  TextMode="MultiLine"  Height="54px" SpecialWorkCheck="描述信息"></asp:TextBox>
                                            
                                        </td>
                                    </tr>
                                    <tr>
                                         <td height="20" align="right"  class="td_list_fields">机构职责</td>
                                        <td height="20" class="tdColInput" colspan="5">
                                            <asp:TextBox ID="txtDuty" runat="server" Width="100%" MaxLength="50" CssClass="tdinput"  TextMode="MultiLine"  Height="54px" SpecialWorkCheck="机构职责"></asp:TextBox>
                                        </td>
                                    </tr>
                                </table>
                            </td>
