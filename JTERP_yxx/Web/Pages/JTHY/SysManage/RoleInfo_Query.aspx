    ...
    <table width="95%" height="57" border="0" cellpadding="0" cellspacing="0" class="maintable"
        ...
        <tr>
            <td height="35" colspan="2" valign="top">
                ...
                onclick="Show();" id="btnNew" visible="false" runat="server" /><img src="../../../Images/Button/Main_btn_delete.png" style="cursor:hand" onclick="DelRoleInfo();" id="btnDel" visible="false" runat="server"  /><asp:HiddenField ID="hidSearchCondition" runat="server" />
                    ...
                    <tbody>
                      ...
                      <%--      <th align="center" class="td_list_fields" >
                          ...
                          <%--  <th align="center" class="td_list_fields" >
                            ...
                            <th align="center"  class="td_list_fields"  >
                                <div class="orderClick" onclick="OrderBy('RoleRangeName','oC5');return false;">
                                    权限范围<span id="oC5" class="orderTip"></span></div>
                            </th>
                        </tr>
                    </tbody>
                </table>
