                    ...
                    <tr>
                        <td height="28" bgcolor="#FFFFFF">
                            <img src="../../../images/Button/Bottom_btn_save.jpg" alt="保存" id="btnSave" style="cursor: hand; float:left"
                                 border="0" onclick="InsertRoleData();"  runat="server" />
                                             <a onclick="DoBack();">
        ...
        <tr>
            <td colspan="2" valign="top">
                ...
                <table width="99%" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#999999">
                    ...
                    <table width="99%" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#999999"
                        ...
                        <tr>
                            ...
                            <td bgcolor="#FFFFFF" >
                                        <input id="RoleRange0" type="radio" value="0"  name="Rao" checked runat="server"/>本人&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        <input id="RoleRange1" type="radio" value="1"  name="Rao"  runat="server"/>本人及下属部门&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        <input id="RoleRange2" value="2" type="radio"  name="Rao" runat="server"/>本部门&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        <input id="RoleRange3" value="3" type="radio"  name="Rao" runat="server" />全部
                            </td>
                        </tr>
                    </table>
                ...
                <table width="99%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#999999"
                    id="Tb_03" >
                    <tr>
                        <td height="20"  class="td_list_fields" align="right" width="20%">
                            备注
                        </td>
