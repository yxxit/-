                    ...
                    <tr>
                        <td height="28" bgcolor="#FFFFFF">
                            <%--<a href="MasterProductSchedule_Add.aspx">--%>
                                <%--<img id="btnAdd" src="../../../images/Button/Bottom_btn_new.png" alt="添加主生产计划单" style='cursor: hand;'
                            ...
                            <img id="btn_create"  src="../../../images/Button/Bottom_btn_new.png" alt="新建" style="cursor:hand;" onclick="CreateProviderLinkMan()"  runat="server" visible="false" />
                            <img id="btn_del"  src="../../../Images/Button/Main_btn_delete.png" alt="删除" style="cursor:hand;" onclick="DelProviderLinkMan()"  runat="server" visible="false" />
        ...
        <tr>
            <td colspan="2" id="tdResult">
                <table width="99%" border="0" align="center" cellpadding="0" cellspacing="1" id="pageDataList1"
                    ...
                    <tbody>
                        <tr>
                            <th height="20" align="center" class="td_list_fields" >选择<input type="checkbox" visible="false" id="checkall" onclick="SelectAll()" value="checkbox" /></th>
                            <th align="center" class="td_list_fields" ><div class="orderClick" onclick="OrderBy1('LinkManName','oLinkManName');return false;">联系人姓名<span id="oLinkManName" class="orderTip"></span></div></th>
                            <th align="center" class="td_list_fields" ><div class="orderClick" onclick="OrderBy1('CustName','oCustName');return false;">供应商名称<span id="oCustName" class="orderTip"></span></div></th>
                            <th align="center" class="td_list_fields" ><div class="orderClick" onclick="OrderBy1('Appellation','oAppellation');return false;">称谓<span id="oAppellation" class="orderTip"></span></div></th>
                            <th align="center" class="td_list_fields" ><div class="orderClick" onclick="OrderBy1('LinkTypeName','oLinkTypeName');return false;">联系人类型<span id="oLinkTypeName" class="orderTip"></span></div></th>
                            <th align="center" class="td_list_fields" ><div class="orderClick" onclick="OrderBy1('Important','oImportant');return false;">重要程度<span id="oImportant" class="orderTip"></span></div></th>
                            <th align="center" class="td_list_fields" ><div class="orderClick" onclick="OrderBy1('WorkTel','oWorkTel');return false;">电话<span id="oWorkTel" class="orderTip"></span></div></th>
                            <th align="center" class="td_list_fields" ><div class="orderClick" onclick="OrderBy1('Handset','oHandset');return false;">手机<span id="oHandset" class="orderTip"></span></div></th>
                            <th align="center" class="td_list_fields" ><div class="orderClick" onclick="OrderBy1('MailAddress','oMailAddress');return false;">邮件<span id="oMailAddress" class="orderTip"></span></div></th>
                            ...
                            <th align="center" class="td_list_fields" ><div class="orderClick" onclick="OrderBy1('Birthday','oBirthday');return false;">生日<span id="oBirthday" class="orderTip"></span></div></th>
                          </tr>
                    </tbody>
                </table>
                <br />
