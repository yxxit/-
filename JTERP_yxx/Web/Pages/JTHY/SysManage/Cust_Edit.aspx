...
<head runat="server">
    ...
    <script src="../../../js/jthy/CustManager/CustEdit.js" type="text/javascript"></script>
       ...
       <img src="../../../Images/Button/Bottom_btn_back.jpg" alt="返回" id="btn_back" style="cursor:hand;" onclick="Back();" />
        ...
        <tr>
            ...
            <table width="99%" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#999999" id="Tb_01" >
              <tr>
                <td height="22"  class="td_list_fields" align="right" style="width:10%">客户编号<span class="redbold">*</span></td>
                ...
                <td height="22"  class="td_list_fields" align="right" style="width:10%">客户名称<span class="redbold">*</span></td>
                <td height="22" bgcolor="#FFFFFF" style="width:23%">
                ...
                <td height="22"  class="td_list_fields" align="right" style="width:10%">客户简称</td>
              ...
              <tr>
                <td height="22"  class="td_list_fields" align="right" style="width:10%">客户管理分类</td>
                <td height="22" bgcolor="#FFFFFF" style="width:23%">
                ...
                <td height="22"  class="td_list_fields" align="right" style="width:10%">客户营销分类</td>
                <td height="22" bgcolor="#FFFFFF" style="width:23%">
                ...
                <td height="22"  class="td_list_fields" align="right" style="width:10%">拼音缩写</td>
              ...
              <tr>
                <td height="22"  class="td_list_fields" align="right" style="width:10%">客户时间分类</td>
                <td height="22" bgcolor="#FFFFFF" style="width:23%">
              ...
              <tr>
                <td height="22"  class="td_list_fields" align="right">客户简介</td>
            ...
            <tr>
              <td height="11"  class="td_list_title"><table width="100%" border="0" cellspacing="0" cellpadding="3">
               ...
               <tr>
                <td height="22"  class="td_list_fields" align="right" style="width:10%">国家地区</td>
                <td height="22" align="left" bgcolor="#FFFFFF" style="width:23%">
                    <asp:DropDownList ID="ddlCountry" runat="server">
                    </asp:DropDownList>
                            </td>
                <td height="22"  class="td_list_fields" align="right" style="width:10%">区域</td>
                <td height="22" align="left" bgcolor="#FFFFFF" style="width:23%">
                    <asp:DropDownList ID="ddlArea" runat="server"></asp:DropDownList>
                            </td>
                <td height="22"  class="td_list_fields" align="right" style="width:10%">省</td>
              ...
              <tr>
                <td height="22"  class="td_list_fields" align="right">市(县)</td>
                <td height="22" align="left" bgcolor="#FFFFFF">
                    <input name="txtCity" id="txtCity" type="text" class="tdinput"style="width:95%" maxlength="25" /></td>
                <td height="22"  class="td_list_fields" align="right">业务类型</td>
                <td height="22" align="left" bgcolor="#FFFFFF">
                ...
                <td height="22"  class="td_list_fields" align="right">分管业务员<span class="redbold">*</span></td>
                <td height="22" align="left" bgcolor="#FFFFFF">
              ...
              <tr>
                <td height="22"  class="td_list_fields" align="right">邮编</td>
                <td height="22" align="left" bgcolor="#FFFFFF">
                    <input name="txtPost" id="txtPost" type="text" class="tdinput" style="width:95%" 
                        maxlength="10" /></td>
                <td height="22"  class="td_list_fields" align="right">电子邮件</td>
                <td height="22" align="left" bgcolor="#FFFFFF">
                    <input name="txtemail" id="txtemail" type="text" class="tdinput" style="width:95%" maxlength="25" /></td>
                <td height="22"  class="td_list_fields" align="right">首次交易日期</td>
                <td height="22" align="left" bgcolor="#FFFFFF">
              ...
              <tr>
                <td height="22"  class="td_list_fields" align="right">运送方式</td>
                <td height="22" align="left" bgcolor="#FFFFFF">
                    <asp:DropDownList ID="ddlCarryType" runat="server">
                    </asp:DropDownList>
                            </td>
                <td height="22"  class="td_list_fields" align="right">交货方式</td>
                <td height="22" align="left" bgcolor="#FFFFFF">
                    <asp:DropDownList ID="ddlTakeType" runat="server">
                    </asp:DropDownList>
                                                    </td>
                <td height="22"  class="td_list_fields" align="right">联络期限(天)</td>
                <td height="22" align="left" bgcolor="#FFFFFF">
              ...
              <tr>
                <td height="22"  class="td_list_fields" align="right">收货地址</td>
                <td height="22" align="left" bgcolor="#FFFFFF" colspan="3">
                    <input name="txtReceiveAddress" id="txtReceiveAddress" type="text" class="tdinput" style="width:95%" 
                        maxlength="50" /></td>
                <td height="22"  class="td_list_fields" align="right">&nbsp;</td>
                <td height="22" align="left" bgcolor="#FFFFFF">
                    &nbsp;</td>
              </tr>
              <tr>
                <td height="22"  class="td_list_fields" align="right">经营范围</td>
                <td height="22" align="left" bgcolor="#FFFFFF" colspan="5">
          ...
          <table width="99%" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#999999" id="Tb_04" ><!---->
               <tr>
                <td height="22"  class="td_list_fields" align="right" style="width:10%">允许延期付款<span class="redbold">*</span></td>
                <td height="22" align="left" bgcolor="#FFFFFF" style="width:23%">
                    <select  name="seleCreditManage" width="20px" id="seleCreditManage" onchange="DivMaxcShow();">
                                  <option value="1">否</option>
                                  <option value="2">是</option>
                                </select></td>
                <td height="22"  class="td_list_fields" align="right" style="width:10%">信用额度(元)</td>
                <td height="22" align="left" bgcolor="#FFFFFF" style="width:23%">
                    <input name="txtMaxCredit" id="txtMaxCredit" type="text" class="tdinput"
                        onchange="Number_round(this,2)" maxlength="12" /></td>
                <td height="22"  class="td_list_fields" align="right" style="width:10%">帐期天数(天)<span style="display:none;" id="divMaxC" class="redbold">*</span></td>
                <td height="22" align="left" bgcolor="#FFFFFF" style="width:24%">
                    <input name="MaxCreditDate" id="txtMaxCreditDate" type="text" class="tdinput"
                        style="width:95%" maxlength="12" /></td>
              </tr>
               <tr>
                <td height="22"  class="td_list_fields" align="right" style="width:10%">结算方式</td>
                <td height="22" align="left" bgcolor="#FFFFFF" style="width:23%">
                    <asp:DropDownList ID="ddlPayType" runat="server" >
                    </asp:DropDownList>
                            </td>
                <td height="22"  class="td_list_fields" align="right" style="width:10%">结算币种</td>
                <td height="22" align="left" bgcolor="#FFFFFF" style="width:23%">
                    <asp:DropDownList ID="ddlCurrencyType" runat="server">
                    </asp:DropDownList>
                            </td>
                <td height="22"  class="td_list_fields" align="right" style="width:10%">发票类型</td>
                <td height="22" align="left" bgcolor="#FFFFFF" style="width:24%">
               ...
               <tr>
                <td height="22"  class="td_list_fields" align="right" style="width:10%">支付方式</td>
                <td height="22" align="left" bgcolor="#FFFFFF" style="width:23%">
                    <asp:DropDownList ID="ddlMoneyType" runat="server" style="margin-bottom: 0px">
                    </asp:DropDownList></td>
                <td height="22"  class="td_list_fields" align="right" style="width:10%">开户行</td>
                <td height="22" align="left" bgcolor="#FFFFFF" style="width:23%">
                    <input name="txtOpenBank" id="txtOpenBank" type="text" class="tdinput" style="width:95%" 
                        maxlength="50" /></td>
                <td height="22"  class="td_list_fields" align="right" style="width:10%">户名</td>
                <td height="22" align="left" bgcolor="#FFFFFF" style="width:24%">
                    <input name="txtAccountMan" id="txtAccountMan" type="text" class="tdinput" style="width:95%" 
                        maxlength="50" /></td>
              </tr>
               <tr>
                <td height="22"  class="td_list_fields" align="right" style="width:10%">账号</td>
                <td height="22" align="left" bgcolor="#FFFFFF" colspan="3">
            ...
            <tr>
              ...
              <tr>
                ...
                <td height="22"  class="td_list_fields" align="right" style="width:10%;color: #FF0000;">资产规模(万元)</td>
                <td height="22" bgcolor="#FFFFFF" style="width:23%">                                
                    <input name="txtCapitalScale" id="txtCapitalScale" type="text" class="tdinput"
                        onchange="Number_round(this,2)" maxlength="12" /></td>
                <td height="22"  class="td_list_fields" align="right" style="width:10%;color: #FF0000;">成立时间</td>
                <td height="22" align="left" bgcolor="#FFFFFF" style="width:24%">
              ...
              <tr>
                ...
                <td height="22"  class="td_list_fields" align="right">阶段</td>
                <td height="22" bgcolor="#FFFFFF">                                
                    <input name="txtPhase" id="txtPhase" type="text" class="tdinput"style="width:95%" maxlength="25" /></td>
                <td height="22"  class="td_list_fields" align="right">热点客户</td>
                <td height="22" align="left" bgcolor="#FFFFFF">
              ...
              <tr>
                <td height="22"  class="td_list_fields" align="right" style="width:10%">热度</td>
                <td height="22" bgcolor="#FFFFFF" style="width:23%">
                ...
                <td height="22"  class="td_list_fields" align="right" style="width:10%">关系等级</td>
                <td height="22" bgcolor="#FFFFFF" style="width:23%">                                
                ...
                <td height="22"  class="td_list_fields" align="right" style="width:10%">启用状态<span class="redbold">*</span></td>
                <td height="22" align="left" bgcolor="#FFFFFF" style="width:24%">
          ...
          <table width="99%" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#999999" id="Tb_06" ><!---->
               <tr>
                <td height="22"  class="td_list_fields" align="right" style="width:10%">可查看该客户档案的人员</td>
                <td height="22" align="left" bgcolor="#FFFFFF">
