    ...
    <table width="99%" border="0" align="center" cellpadding="2" cellspacing="1" >
        <tr>
          ...
          <table border="0" cellpadding="3" height="300" width="95%">
            <tr>
                <td valign="top" width="200" style="padding-left:20px;" id="treeContainer"> </td>
                <td valign="top">
                    <table cellpadding="2">
               ...
               <a href="#" id="img_new">
                <img border="0" onclick="treeview_cancel()" style="cursor:pointer;" 
                                src="../../../images/Button/Bottom_btn_new.png" runat="server" visible="false" id="btnNew"/></a><img id="btnSave" runat="server" visible="false" alt="" src="../../../Images/Button/Bottom_btn_save.jpg" 
                               onclick="treeview_save();" /><a href="#" id="img_delete" ><img 
                                border="0" onclick="treeview_delete()" style="cursor:pointer;" 
                                src="../../../images/Button/Main_btn_delete.png" id="btnDel" runat="server" visible="false" /></a></td></tr>
                    </table>
                       ...
                       <td  height="20" align="right" class="td_list_fields">
                        ...
                        <td height="20" bgcolor="#FFFFFF" >
                          ...
                          <option value="6">服务产品</option>
                           ...
                           <option value="9">纸号</option>
                           <option value="10">耐磨纸</option>
                           <option value="11">平衡纸</option>
                           <option value="12">基材</option>
                                </select></font></td>
                       <td  height="20" align="right" class="td_list_fields">
                            描述
                        </td>
