    ...
    <table width="95%" height="57" border="0" cellpadding="0" cellspacing="0" class="maintable"
        ...
        <tr>
            <td height="35" colspan="2" valign="top">
                ...
                <img  alt="新建" src="../../../Images/Button/Bottom_btn_new.png"
               onclick="Show();" runat="server" visible="false" id="btnNew"/><img alt="" src="../../../Images/Button/Main_btn_delete.png" 
                        ...
                        <tr>
                            ...
                            <th align="center" class="td_list_fields" >
                                <div class="orderClick" onclick="OrderBy('UserName','oGroup');return false;">
                                    帐号<span id="oGroup" class="orderTip"></span></div>
                            </th>
                            
                             <th align="center" class="td_list_fields" >
                                <div class="orderClick" onclick="OrderBy('EmployeeName','oEmployeeName');return false;">
                                    员工姓名<span id="oEmployeeName" class="orderTip"></span></div>
                            </th>
                             <th align="center" class="td_list_fields" >
                                <div class="orderClick" onclick="OrderBy('DeptName','oDeptName');return false;">
                                    所属组织<span id="oDeptName" class="orderTip"></span></div>
                            </th>
                             <th align="center" class="td_list_fields" >
                                <div class="orderClick" onclick="OrderBy('RoleName','oRoleName');return false;">
                                    角色|权限范围<span id="oRoleName" class="orderTip"></span></div>
                            </th>
                         <%--   <th align="center" class="td_list_fields" >
                                <div class="orderClick" onclick="OrderBy('UserName','oGroup');return false;">
                            ...
                            <th align="center" class="td_list_fields" >
                             ...
                             <th align="center" class="td_list_fields"  id="thHardTitle">
