<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EmployeeReserve_Info.aspx.cs" Inherits="Pages_Office_HumanManager_EmployeeReserve_Info" %>
...
<head id="Head1" runat="server">
    ...
    <script src="../../../js/jthy/sysmanage/EmployeeReserve_Query.js" type="text/javascript"></script>
                        ...
                        <td bgcolor="#FFFFFF">
                            <table width="100%" border="0"  cellpadding="2" cellspacing="1" bgcolor="#CCCCCC" class="table">
                                <tr>
                                    ...
                                    <td height="20" width="10%"  class="td_list_fields" align="right" >姓名</td>
                                ...
                                <tr>
                                    <td  class="td_list_fields" align="right" >性别</td>
                                    <td class="tdColInput">
                                    ...
                                    <td  class="td_list_fields" align="right" >文化程度</td>
                                    <td class="tdColInput">
                            ...
                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#999999">
                                <tr>
                                    <td height="28" bgcolor="#FFFFFF">
                                        ...
                                        <img src="../../../images/Button/Main_btn_delete.png" alt="删除" visible="false" id="btnDelete" runat="server" onclick="DeleteEmployeeInfo()" style='cursor:pointer;' />
                                        <asp:ImageButton ID="btnImport" style="display:none;" runat="server" ImageUrl="~/Images/Button/Main_btn_out.jpg" onclick="btnImport_Click" />
                                    </td>
                                </tr>
                            </table>
                        </td>
