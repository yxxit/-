...
<%@ Register Src="../../../UserControl/Message.ascx" TagName="Message" TagPrefix="uc1" %>
 <%@ Register Src="~/UserControl/UserSearch.ascx" TagName="UserSearch" TagPrefix="uc3" %>
...
<body>
    <form id="frmMain" runat="server">
     ...
     <uc3:UserSearch  ID="UserSearch" runat="server" />
                ...
                <td colspan="2" valign="top">
                    ...
                    <div>
                        <table width="99%" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#999999"
                            ...
                            <tr>
                                <td  class="td_list_fields" align="right" style="width: auto">
                              ...
                              <%--      <asp:DropDownList ID="Drp_UserInfo" runat="server" onchange="GetUserName();">
                                 ...
                                 <input type="text" id="Drp_UserInfo" name="Drp_UserInfo" class="tdinput" onclick="UserInfo()"
                                style="width: 80%; border: 0px" />
                            <img src="../../../Images/default/search1.gif" alt="搜索" style="cursor: hand" onclick="UserInfo()" />
                            ...
                            <tr id="CloseDate">
                                <td height="20"  class="td_list_fields" align="right" style="width: 6%">
                                    角色信息：
                                </td>
