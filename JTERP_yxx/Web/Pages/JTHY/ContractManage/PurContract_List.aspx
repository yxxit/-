<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PurContract_List.aspx.cs" Inherits="Pages_JTHY_ContractManage_PurContract_List" %>
...
<%@ Register Src="../../../UserControl/ProviderInfo.ascx" TagName="ProviderInfo"
    TagPrefix="uc11" %>
<%--    <%@ Register Src="~/UserControl/CustNameSelList.ascx" TagName="CustNameSelList" TagPrefix="uc9" %>--%>
                                ...
                                <tr class="table-item">
                                 ...
                                 <tr class="table-item">
                                    ...
                                    <td class="td_list_edit">
                                        ...
                                        <asp:TextBox ID="txtProName"  runat="server" ReadOnly="true"  class="tdinput" style="width: 100%; "   onclick="popProviderObj.ShowProviderList('txtProviderID','txtProName',null,null,null,'0');"  ></asp:TextBox>
                                    
                                    </td>
                                    <%--<td class="tdColInput">
                                        <input id="txtProName" class="tdinput" type="text" runat="server" style="width: 90%" />
                                    </td>--%>
                                </tr>
                                ...
                                <tr >
                                    <td colspan="6" align="center" bgcolor="#FFFFFF">
                                        ...
                                        <img runat="server" alt="检索" src="../../../images/Button/Bottom_btn_search.jpg" style='cursor: pointer;'
                                            id="btn_Search" onclick='SearchPurContract(1)' />
                    ...
                    <tr class="menutitle1">
                        ...
                        <td  align="right">
                            ...
                            <img id="btn_create" src="../../../images/Button/Bottom_btn_new.png" 
                                runat="server" alt="新建" style='cursor: hand;' onclick="CreatePurContract();" />&nbsp;
                            <img alt="删除合同" src="../../../Images/Button/Main_btn_delete.png" id="btn_delete"
                                runat="server" onclick="DelPurContractInfo();"   />&nbsp;
                          ...
                          <th width="3%" class="td_main_detail" >
                            ...
                            <th class="td_main_detail" width="5%">
                                <div id="oCustName_dsp" class="orderClick" onclick="OrderBy('CustName','oCustName');return false;">
                                    供应商名称<span id="oCustName" class="orderTip"></span></div>
                            </th>
                            <th class="td_main_detail" width="5%">
                            ...
                            <%--<th class="td_main_detail" width="5%">
                                <div class="orderClick" onclick="OrderBy('SelfOrder','oSelfOrder');return false;">
                                    审核人</div>
                            </th>
                            <th class="td_main_detail" width="5%">
                                <div class="orderClick" onclick="OrderBy('BillStatusText','oBillStatusText');return false;">
                                    审核日期</div>
                            </th> --%>                        
                            <th class="td_main_detail" width="5%">
