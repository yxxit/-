...
public partial class Pages_Office_FinanceManager_IncomeBill_Add : BasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            Confirmname.Value = ((UserInfoUtil)SessionUtil.Session["UserInfo"]).UserName.ToString();//看看名称
        }
    }
    ...
    private void InitControlinfo()
    {
        ...
        //jiandangrenId.Value = ((UserInfoUtil)SessionUtil.Session["UserInfo"]).EmployeeID;
