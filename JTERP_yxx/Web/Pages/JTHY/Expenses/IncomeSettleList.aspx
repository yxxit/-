<%@ Page Language="C#" AutoEventWireup="true" CodeFile="IncomeSettleList.aspx.cs" Inherits="Pages_JTHY_Expenses_IncomeSettleList" %>
...
<head id="Head1" runat="server">
    ...
    <script src="../../../js/jthy/Expenses/IncomeSettleList.js"  type="text/javascript"></script>
...
<body>
  <uc11:ProviderInfo ID="ProviderInfo" runat="server" /> 
    <span id="Span14" class="Spantype"></span>
                    ...
                    <tr>
                        <td bgcolor="#FFFFFF">
                            <table width="100%" border="0" cellpadding="2" cellspacing="1" bgcolor="#CCCCCC"
                                class="table">
                                <tr class="table-item">
                                    <td class="td_list_fields"> 单据编号</td>
                                    <td class="style3">
                                   ...
                                   <td class="tdColInput"> 
                                    ...
                                    <td class="td_list_edit">
                                        ...
                                        <asp:TextBox ID="txtProviderName"  runat="server" ReadOnly="true"  class="tdinput" style="width: 100%; "   onclick="popProviderObj.ShowProviderList('txtProviderID','txtProviderName',null,null,null,'0');"  ></asp:TextBox>
                    ...
                    <tr class="menutitle1">
                        ...
                        <td align="right" valign="middle" >
                            ...
                            <img alt="删除" id="btnDel" runat="server" src="../../../Images/Button/Main_btn_delete.png"
                                onclick="Fun_DeleteIncomeSettle();" /> 
                            &nbsp;
                        </td>
                    </tr>
                </table>
                         ...
                         <tr class="table-item">
                            ...
                            <th width="8%"   class="td_main_detail">
                                <div class="orderClick" onclick="OrderBy('ProductName','Span7');return false;">
                                    供应商<span id="Span7" class="orderTip"></span></div>
                            </th>
