<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PayBill_List.aspx.cs" Inherits="Pages_JTHY_Expenses_PayBill_List" %>
...
<head runat="server">
    ...
    <script src="../../../js/jthy/Expenses/PayBill_List.js" type="text/javascript"></script>
       ...
       <%-- <tr>
                            ...
                            <table width="100%" border="0"  cellpadding="2" cellspacing="1" bgcolor="#CCCCCC" class="table">
                                <tr class="table-item">
                                    ...
                                    <td class="tdColInput" width="23%">
                                        <asp:TextBox ID="txtIncomeNo" runat="server" class="tdinput" onchange="if(!CheckSpecialWord(this.value)){popMsgObj.ShowMsg('付款单号不能包含特殊字符，请重新输入');this.value='';}" ></asp:TextBox>
                                        &nbsp;</td>
        ...
        <tr>
            <td colspan="2">
                ...
                <table  width="98%" height="57" border="0" cellpadding="0" cellspacing="0" id="tblDetailList" >
                   <%-- <tr>
                        <td valign="top">
                            <img src="../../../images/Main/Line.jpg" width="122" height="7" />
                        </td>
                    ...
                    <tr>
                        <td height="30" colspan="2" align="center" valign="top" class="Title">付款单列表</td>
                    </tr>--%>
                    <tr>
                        <td height="35" colspan="2" valign="top">
                            <table width="99%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#999999">
                                <tr class="menutitle1">
                                    <td   align="left" valign="middle">&nbsp;&nbsp;付款单列表</td>
                                    <td>
                    ...
                    <tr>
                        <td colspan="2">
                            ...
                            <table width="99%" border="0" align="center" cellpadding="0" cellspacing="1" id="tblDetailInfo" bgcolor="#999999">
                                    ...
                                    <tr class="table-item">
                                        ...
                                        <th align="center" class="td_main_detail" >
                                            <div class="orderClick" onclick="OrderBy('AcceDate','oC0');return false;">
                                                付款日期<span id="oC0" class="orderTip"></span>
                                            </div>
                                        </th>
                                        ...
                                        <th align="center" class="td_main_detail" >
                                            <div class="orderClick" onclick="OrderBy('TotalPrice','oC3');return false;">
                                                付款金额<span id="oC3" class="orderTip"></span>
                                            </div>
                                        </th>
                                        <th align="center" class="td_main_detail" >
                                ...
                                <%--<tr class="newrow" id="txtTable"></tr>--%>
                            </table>
                            <!-- </div> -->
                            <br/>
