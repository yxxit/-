<%@ Page Language="C#" AutoEventWireup="true" CodeFile="IncomeBill_Add.aspx.cs" Inherits="Pages_Office_FinanceManager_IncomeBill_Add" %>
...
<head id="Head1" runat="server">
    ...
    <script src="../../../js/JTHY/Expenses/IncomeBillAdd.js" type="text/javascript"></script>
...
<body onload="AcceWay();">
    ...
    <table width="98%" height="57" border="0" cellpadding="0" cellspacing="0" class="maintable"
                            ...
                            <table width="100%">
                                <tr>
                                    <td height="30" align="left" class="Title">
                                        <div id="divTitle" runat="server">                                新建收款单</div>
                                    </td>
                                    <td align=right>
                                    ...
                                    <input type="hidden" id="billingid" runat="server" />
                                        <img id="btnIncomeBill_Save" src="../../../images/Button/Bottom_btn_save.jpg" onclick="InsertIBI();"
                                            runat="server" visible="true" style="cursor: pointer" title="保存收款单" />
                                    ...
                                    <td align="right">
                                        <img id="btnPrint" src="../../../images/Button/Main_btn_print.jpg" visible="false" style="cursor: pointer;display:none;"
            ...
            <td colspan="2" valign="top">
                ...
                <table width="99%" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#999999"
                    ...
                    <tr class="table-item">
                        ...
                        <td   class="td_list_edit">
                            <input id="txtCustName" type="text" style="width:75%" class="tdinput" onclick="popSellCustObj.ShowList('protion','CustID','txtCustName','FromTBName','FileName','','1');" runat="server" />
                            <img src="../../../Images/default/search1.gif" alt="搜索" style="cursor:hand" onclick="popSellCustObj.ShowList('protion','CustID','txtCustName','FromTBName','FileName','','1');" />
                        </td>
                    </tr>
                    <tr class="table-item">
        ...
        <tr class="table-item">
            ...
            <td   class="td_list_edit">
                ...
                <%--<asp:TextBox ID="UsertxtExcutor" runat="server" class="tdinput" style="width: 80%;"   onclick="alertdiv('UsertxtExcutor')"></asp:TextBox>  
                            <img src="../../../Images/default/search1.gif" alt="搜索" style="cursor: hand" onclick="alertdiv('UsertxtExcutor')" />--%>
            </td>
    ...
    <p>
        ...
        <input id="txtAction" type="hidden" value="1" runat="server" /><!--判断是添加还是修改-->
