...
public partial class Pages_JTHY_Expenses_PayBill_List : BasePage
{
    ...
    protected void btnImport_Click(object sender, System.Web.UI.ImageClickEventArgs e)
    {
        ...
        ////导出标题
        string headerTitle = "付款单号|所属项目|付款日期|往来客户|业务单号|确认状态|确认人|确认时间|登记人";
        ...
        //XBase.Common.OutputToExecl.ExportToTable(this.Page, dt, header, field, "付款单列表");
    }
}
