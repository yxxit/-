...
<body>
    ...
    <table width="98%" border="0" cellpadding="0" cellspacing="0" class="checktable"
        id="Table1" style=" margin-top:10px;">
        <tr>
                    ...
                    <td bgcolor="#FFFFFF">
                        <table width="100%" border="0" cellpadding="2" cellspacing="1" bgcolor="#CCCCCC"
                            ...
                            <tr class="table-item">
                                ...
                                <td bgcolor="#FFFFFF" align="left" class="style4">
                                    &nbsp;
                                </td>
                            ...
                            <tr class="table-item">
                                <td width="10%" height="20" align="right" class="td_list_fields">
                                    发送人
                                </td>
                                <td bgcolor="#FFFFFF" class="style1">
                                    <input name="txtSender" id="txtSender" onclick="showSelPanel()" readonly="readonly"
                                        type="text" class="tdinput" style="width: 180px;" />
