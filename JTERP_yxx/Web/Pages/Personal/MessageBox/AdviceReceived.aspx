       ...
       */
       ...
       .selTab{cursor:pointer;display:inline;color:Black;background-color:White;margin-left:5px;border:solid 1px #0000ff;padding:2px;}
        ...
        function dispData(data)
        {
           ...
           document.getElementById("spDisplayName").innerHTML = (data.DisplayName == "0"?"否":"是");
      ...
      <tr>
        ...
        <table width="100%" border="0"  cellpadding="2" cellspacing="1" bgcolor="#CCCCCC" class="table">
          <tr class="table-item">
            ...
            <td   align="right" class="td_list_fields" >建议人</td>
...
<table width="95%"  height="57" border="0" cellpadding="0" cellspacing="0" class="maintable" id="mainindex" >
  ...
  <tr>
    <td height="30" colspan="2" align="center" valign="top" class="Title">我收到的建议</td>
  </tr>
  ...
  <tr>
    ...
    <table width="99%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#999999">
        <tr>
          ...
          &nbsp;&nbsp;&nbsp;
          <img src="../../../images/Button/Main_btn_delete.jpg" title="删除" id="btn_del" visible="false" runat="server" onclick="DelMessage()" style='cursor:pointer;'  />
          </td>
        </tr>
      </table>
    </td>
