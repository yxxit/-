    ...
    <table width="99%" border="0" align="center" cellpadding="0" id="searchtable"  cellspacing="0" bgcolor="#CCCCCC">
      <tr>
        ...
        <table width="100%" border="0"  cellpadding="2" cellspacing="1" bgcolor="#CCCCCC" class="table">
          <tr class="table-item">
            <td class="td_list_fields" align="right" width="10%">接收时间   </td>
            ...
            <td   align="right" class="td_list_fields" >主题</td>
          ...
          <tr class="table-item">
            <td width="10%" height="20"  align="right" class="td_list_fields" >发送人</td>
          ...
          <td colspan="6" align="left" bgcolor="#FFFFFF">
              <img title="检索" src="../../../images/Button/Bottom_btn_search.jpg" style='cursor:pointer;' onclick='SearchEquipData()'  /></td>
           </tr>  
        </table></td>
      </tr>
    </table>
...
<table width="95%"  height="57" border="0" cellpadding="0" cellspacing="0" class="maintable" id="mainindex" >
  ...
  <tr>
    <td height="30" colspan="2" align="center" valign="top" class="Title">未读短信</td>
  </tr>
