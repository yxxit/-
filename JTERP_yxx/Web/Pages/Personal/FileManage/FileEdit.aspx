<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FileEdit.aspx.cs" Inherits="Pages_Personal_FileManage_FileEdit" %>
...
<input type="hidden" id="hidDocsID" runat="server" value="" />
<table width="95%" align="center" border="0" cellpadding="0" cellspacing="0" class="maintable" id="mainindex">
  ...
  <tr>
    <td height="30" colspan="2" valign="top" class="Title">
        ...
        <tr>
          <td height="30" align="center" class="Title">附件修改</td>
        </tr>
        </table>
                  ...
                  <tr>
                    ...
                    <Table width="99%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#999999" id="tblBaseInfo" style="display: block">
                      ...
                      <tr style="display:none">
                        <td height="25" align="right" class="td_list_fields">当前文件</td>
                        <td colspan="5" class="tdColInput">
                            <input type="hidden" id="hidDocsFile" runat="server" value="" />
                            <asp:HyperLink ID="CurrentFile" runat="server" Target="_blank"></asp:HyperLink>
