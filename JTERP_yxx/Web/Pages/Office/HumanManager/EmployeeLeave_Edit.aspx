    ...
    <tr>
        <td  colspan="2">
            ...
            <table width="99%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#999999" id="tblBaseInfo" style="display:block">
                <tr>
                    <td height="20"  class="td_list_fields"  align="right">离职单编号<span class="redbold">*</span></td>
                    ...
                    <td height="20"  class="td_list_fields"  align="right">离职单主题<span class="redbold">*</span></td>
                    <td height="20" class="tdColInput">
                ...
                <tr>
                    <td height="20"  class="td_list_fields" align="right">所属部门</td>
                    <td height="20" class="tdColInput">
                    ...
                    <td height="20"  class="td_list_fields" align="right">岗位职等</td>
                    <td height="20" class="tdColInput">
                        <asp:TextBox ID="txtAdminLevelName" CssClass="tdinput" runat="server" Enabled="false"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td height="20"  class="td_list_fields" align="right">离职日期<span class="redbold">*</span></td>
                    <td height="20" class="tdColInput">
                ...
                <tr>
                    <td height="20"  class="td_list_fields" align="right">离职事由<span class="redbold">*</span></td>
                ...
                <tr>
                    <td height="20"  class="td_list_fields" align="right">工作交接</td>
                    <td height="20" class="tdColInput" colspan="5">
