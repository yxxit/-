                    ...
                    <tr>
                        <td colspan="2">
                            ...
                            <table width="99%" border="0" align="center" cellpadding="0"  cellspacing="1" id="tbFlowDetail"  bgcolor="#999999">
                                <tbody>
                                    <tr>
                                        <th height="20" align="center" class="td_list_fields" >选择<input type="checkbox" id="chkCheckAll" name="chkCheckAll" onclick="AllSelect('chkCheckAll', 'chkSelect1')"/></th>
...
<table   width="99%"border="0" cellpadding="0" cellspacing="0" class="checktable" id="mainindex">
    ...
    <%--    <input id="Button1" type="button" value="增加模板"  onclick =" EditTemplate()" />--%>
      ...
      <thead >
      <tr >
<%--      <td align="center"  class="td_list_fields">模板名称</td>--%>
      <td align="center"  class="td_list_fields">考评人</td>
      <td align="center"  class="td_list_fields">顺序</td>
      <td align="center"  class="td_list_fields">步骤名称</td>
      <td align="center"  class="td_list_fields">权重(%)</td>
      <td align="center"  class="td_list_fields">备注</td>
