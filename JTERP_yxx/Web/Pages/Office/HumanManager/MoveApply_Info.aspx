<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MoveApply_Info.aspx.cs" Inherits="Pages_Office_HumanManager_MoveApply_Info" %>
...
<head runat="server">
    ...
    <script src="../../../js/office/HumanManager/MoveApply_Query.js" type="text/javascript"></script>
                    ...
                    <tr>
                        <td bgcolor="#FFFFFF">
                            <table width="100%" border="0"  cellpadding="2" cellspacing="1" bgcolor="#CCCCCC">
                                <tr>
                                    <td height="20"  class="td_list_fields" width="10%" align="right">申请编号</td>
                                    <td class="tdColInput" width="23%">
                                        <asp:TextBox ID="txtMoveApplyNo" runat="server" specialworkcheck="申请编号" MaxLength="50" Width="95%" CssClass="tdinput"></asp:TextBox>
                                    </td>
                                    <td height="20"  class="td_list_fields" width="10%" align="right">申请人</td>
                                    <td class="tdColInput" width="23%">
                                     ...
                                     <td  class="td_list_fields" width="10%" align="right">申请日期</td>
                                ...
                                <tr>
                                    <td  class="td_list_fields" align="right">审批状态</td>
                                    <td class="tdColInput">
        ...
        <tr>
            <td colspan="2">
                <table width="99%" align="center" border="0" cellpadding="0" cellspacing="0" id="tblDetailList" >
                    ...
                    <tr>
                        <td height="30" colspan="2" align="center" valign="top" class="Title">离职申请列表</td>
                    </tr>
                    <tr>
                                ...
                                <tbody>
                                    <tr>
                                         ...
                                         <th align="center" class="td_list_fields">
                                            <div class="orderClick" onclick="OrderBy('MoveApplyNo','oC0');return false;">
                                         ...
                                         <th align="center" class="td_list_fields">
                                            <div class="orderClick" onclick="OrderBy('DeptName','oC3');return false;">
                                                部门<span id="oC3" class="orderTip"></span>
                                            </div>
                                        </th>
                                         <th align="center" class="td_list_fields">
                                            <div class="orderClick" onclick="OrderBy('QuarterName','oC4');return false;">
                                                岗位<span id="oC4" class="orderTip"></span>
                                            </div>
                                        </th>
                                         <th align="center" class="td_list_fields">
                                            <div class="orderClick" onclick="OrderBy('HopeDate','oC5');return false;">
                                                到职日期<span id="oC5" class="orderTip"></span>
                                            </div>
                                        </th>
                                         <th align="center" class="td_list_fields">
                                            <div class="orderClick" onclick="OrderBy('FlowStatusName','oC6');return false;">
                                                审批状态<span id="oC6" class="orderTip"></span>
                                            </div>
                                        </th>
                                    </tr>
                                </tbody>
