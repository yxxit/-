    ...
    <tr>
        <td  colspan="2">
            ...
            <table width="99%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#999999" id="tblBaseInfo" style="display:block">
                <tr>
                     <td  class="td_list_fields" width="10%" align="right">考试编号<span class="redbold">*</span></td>
                    <td class="tdColInput" width="23%">
                     ...
                     <td  class="td_list_fields" width="10%" align="right">主题<span class="redbold">*</span></td>
                    <td class="tdColInput" width="23%">
                        <asp:TextBox ID="txtTitle" runat="server" SpecialWorkCheck="主题" Width="90%" MaxLength="50" CssClass="tdinput"></asp:TextBox>
                    </td>
                     <td  class="td_list_fields" width="10%" align="right">考试负责人<span class="redbold">*</span></td>
                ...
                <tr>
                    <td  class="td_list_fields" align="right">开始时间<span class="redbold">*</span></td>
                    <td class="tdColInput" >
                    ...
                    <td  class="td_list_fields"  align="right">结束时间<span class="redbold">*</span></td>
                    <td class="tdColInput">
                    ...
                    <td  class="td_list_fields" align="right">考试地点<span class="redbold">*</span></td>
                    <td class="tdColInput">
                        <asp:TextBox ID="txtAddress" runat="server" SpecialWorkCheck="考试地点"  Width="90%" MaxLength="50" CssClass="tdinput"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td height="25"  class="td_list_fields" align="right">考试状态<span class="redbold">*</span></td>
                    <td class="tdColInput">
                    ...
                    <td  class="td_list_fields" align="right">附件</td>
                    <td class="tdColInput">
                        <table>
                            <tr>
                                <td>
                    ...
                    <td  class="td_list_fields" align="right">缺考人数</td>
                    <td class="tdColInput">
                        <asp:TextBox ID="txtAbsenceCount" runat="server"  Width="90%" MaxLength="3" CssClass="tdinput"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td  class="td_list_fields"  align="right">参与人员<span class="redbold">*</span></td>
