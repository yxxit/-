    ...
    <tr>
        <td  colspan="2">
            ...
            <table width="99%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#999999" id="tblBaseInfo" style="display:block">
                <tr>
                    <td height="20"  class="td_list_fields" align="right">调职申请编号<span class="redbold">*</span></td>
                    ...
                    <td height="20"  class="td_list_fields" align="right">主题<span class="redbold">*</span></td>
                    <td height="20" class="tdColInput" >
                        <asp:TextBox ID="txtTitle" MaxLength="50" runat="server" CssClass="tdinput"></asp:TextBox>
                    </td>
                    <td height="20"  class="td_list_fields"  align="right">申请人<span class="redbold">*</span></td>
                    <td height="20" class="tdColInput" >
                ...
                <tr>
                    <td height="20"  class="td_list_fields" align="right">申请日期<span class="redbold">*</span></td>
                    <td height="20" class="tdColInput">
                    ...
                    <td height="20"  class="td_list_fields" align="right">希望日期</td>
                    <td height="20" class="tdColInput">
                    ...
                    <td height="20"  class="td_list_fields" align="right">入职时间<span class="redbold">*</span></td>
                    <td height="20" class="tdColInput">
                ...
                <tr>
                    <td height="20"  class="td_list_fields" align="right">目前部门<span class="redbold">*</span></td>
                    <td height="20" class="tdColInput">
                    ...
                    <td height="20"  class="td_list_fields" align="right">目前岗位<span class="redbold">*</span></td>
                    <td height="20" class="tdColInput">
                        <asp:DropDownList ID="ddlNowQuarter" runat="server" CssClass="tdinput"></asp:DropDownList>
                    </td>
                    <td height="20"  class="td_list_fields" align="right">目前岗位职等<span class="redbold">*</span></td>
                    <td height="20" class="tdColInput">
                        <uc1:CodeType ID="ctNowQuaterAdmin" runat="server" />
                    </td>
                </tr>
                <tr>
                    <td height="20"  class="td_list_fields" align="right">调至部门<span class="redbold">*</span></td>
                    <td height="20" class="tdColInput">
                    ...
                    <td height="20"  class="td_list_fields" align="right">调至岗位<span class="redbold">*</span></td>
                    <td height="20" class="tdColInput">
                        <asp:DropDownList ID="ddlNewQuarter" runat="server" CssClass="tdinput"></asp:DropDownList>
                    </td>
                    <td height="20"  class="td_list_fields" align="right">调至岗位职等<span class="redbold">*</span></td>
                    <td height="20" class="tdColInput">
                        <uc1:CodeType ID="ctNewQuaterAdmin" runat="server" />
                    </td>
                </tr>
                <tr>
                    <td height="20"  class="td_list_fields" align="right">目前工资</td>
                    <td height="20" class="tdColInput">
                        <asp:TextBox ID="txtNowWage" runat="server" MaxLength="10" Width="80%"  CssClass="tdinput"></asp:TextBox>元/月
                    </td>
                    <td height="20"  class="td_list_fields" align="right">调至工资</td>
                    <td height="20" class="tdColInput">
                        <asp:TextBox ID="txtNewWage" runat="server" MaxLength="10" Width="80%"  CssClass="tdinput"></asp:TextBox>元/月
                    </td>
                    <td height="20"  class="td_list_fields" align="right">申报类别</td>
                    <td height="20" class="tdColInput">
