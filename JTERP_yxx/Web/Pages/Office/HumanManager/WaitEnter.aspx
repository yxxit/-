                        ...
                        <td bgcolor="#FFFFFF">
                            <table width="100%" border="0"  cellpadding="2" cellspacing="1" bgcolor="#CCCCCC">
                                <tr>
                                    ...
                                    <td width="10%"  class="td_list_fields" align="right" align="right">姓名</td>
                                    <td width="23%" class="tdColInput">
                                        <asp:TextBox ID="txtEmployeeName" Width="95%"  SpecialWorkCheck="姓名" CssClass="tdinput" runat="server"></asp:TextBox>
                                    </td>
                                    <td width="10%"  class="td_list_fields" align="right">性别</td>
                                    <td width="24%" class="tdColInput">
                                        <asp:DropDownList ID="ddlSex" runat="server" CssClass="tddropdlist" >
                                ...
                                <tr>
                                    <td  class="td_list_fields" align="right">学历</td>
                                    <td class="tdColInput" >
                                        <uc1:CodeType ID="ddlCulture" runat="server" />
                                    </td>
                                    <td  class="td_list_fields" align="right">毕业院校</td>
                                    <td class="tdColInput">
                                        <asp:TextBox ID="txtSchoolName" runat="server" SpecialWorkCheck="毕业院校" MaxLength="50" CssClass="tdinput" Width="95%"></asp:TextBox>
                                    </td>
                                    <td  class="td_list_fields" align="right">应聘职位</td>
                                    <td class="tdColInput">
                                        <asp:DropDownList ID="ddlQuarter" runat="server" CssClass="tddropdlist"></asp:DropDownList>
                                    </td>
                                </tr>
                                <tr>
                                    <td width="10%"  class="td_list_fields" align="right">人员类型</td>
                                    <td width="24%" class="tdColInput">
                                        <asp:DropDownList ID="DDLFlag" runat="server" CssClass="tddropdlist">
                                            <asp:ListItem Value="">--请选择--</asp:ListItem>
                        ...
                        <tr>
                            <td  colspan="2">
                                ...
                                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#999999" id="tblBaseInfo" style="display:block">
                                    <tr>
                                        <td height="20" align="right"  class="td_list_fields" width="10%">人员编号<span class="redbold">*</span></td>
                                        ...
                                        <td height="20" align="right"  class="td_list_fields" width="10%">证件号码</td>
                                        <td height="20" class="tdColInput" width="24%">
                                            <asp:TextBox ID="txtEnterEmployeeCardID" runat="server" CssClass="tdinput" Enabled="false" Width="95%"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td height="20" align="right"  class="td_list_fields">岗位<span class="redbold">*</span></td>
                                        <td height="20" class="tdColInput">
                                            <asp:DropDownList ID="ddlEnterQuarter" runat="server"></asp:DropDownList>
                                        </td>
                                        <td height="20" align="right"  class="td_list_fields">部门<span class="redbold">*</span></td>
                                        <td height="20" class="tdColInput">
                                        ...
                                        <td height="20" align="right"  class="td_list_fields" >岗位职等<span class="redbold">*</span></td>
                                        <td height="20" class="tdColInput">
                                            <uc1:CodeType ID="ddlEnterQuarterLevel" runat="server" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td height="20" align="right"  class="td_list_fields">职称</td>
                                        <td height="20" class="tdColInput">
                                            <uc1:CodeType ID="ddlEnterPosition" runat="server" />
                                        </td>
                                        <td height="20" align="right"  class="td_list_fields">职务</td>
                                        <td height="20" class="tdColInput">
                                            <asp:TextBox ID="txtPositionTitle" CssClass="tdinput" runat="server" Width="95%" MaxLength="50"></asp:TextBox>
                                        </td>
                                        <td height="20" align="right"  class="td_list_fields">入职时间<span class="redbold">*</span></td>
                                        <td height="20" class="tdColInput">
