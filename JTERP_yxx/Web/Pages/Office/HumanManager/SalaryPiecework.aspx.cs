...
public partial class Pages_Office_HumanManager_SalaryPiecework : BasePage
{
    ...
    private string CreateSalaryListTable()
    {
        ...
        table.AppendLine("		</td>                                                             ");
        table.AppendLine("		<td  class='td_list_fields' style='width:30%'><span style=\"color:Red\">*</span>项目编号</td>             ");
        table.AppendLine("		<td  class='td_list_fields' style='width:30%'><span style=\"color:Red\">*</span>项目名称</td>             ");
        table.AppendLine("		<td  class='td_list_fields' style='width:20%'><span style=\"color:Red\">*</span>单价</td>                 ");
        table.AppendLine("		<td  class='td_list_fields' style='width:15%'><span style=\"color:Red\">*</span>启用状态</td>             ");
        table.AppendLine("	</tr>                                                                 ");
        //返回表格语句
