...
public partial class Pages_Office_HumanManager_SalaryInsuSocial : BasePage
{
    ...
    private string CreateSalaryListTable()
    {
        ...
        table.AppendLine("		</td>                                                             ");
        table.AppendLine("		<td  class='td_list_fields' style='width:30%'><span style=\"color:Red\">*</span>保险名称</td>             ");
        table.AppendLine("		<td  class='td_list_fields' style='width:20%'><span style=\"color:Red\">*</span>单位比例(%)</td>             ");
        table.AppendLine("		<td  class='td_list_fields' style='width:20%'><span style=\"color:Red\">*</span>个人比例(%)</td>             ");
        table.AppendLine("		<td  class='td_list_fields' style='width:13%'><span style=\"color:Red\">*</span>投保方式</td>             ");
        table.AppendLine("		<td  class='td_list_fields' style='width:13%'><span style=\"color:Red\">*</span>启用状态</td>             ");
        table.AppendLine("	</tr>                                                                 ");
        //返回表格语句
