                    ...
                    <tr>
                        <td bgcolor="#FFFFFF">
                            <table width="100%" border="0"  cellpadding="2" cellspacing="1" bgcolor="#CCCCCC">
                                <tr>
                                    <td height="20"  class="td_list_fields" width="10%">面试记录编号</td>
                                    ...
                                    <td height="20"  class="td_list_fields" width="10%">对应招聘计划</td>
                                    <td class="tdColInput" width="23%">
                                  <asp:DropDownList ID="ddlRectPlan" runat="server" style="margin-left:2px;"></asp:DropDownList>
                                    </td>
                                   <td  class="td_list_fields" width="10%">招聘方式</td>
                        ...
                        <asp:ListItem Value ="1" Text="公开招聘"></asp:ListItem>
                         <asp:ListItem Value ="2" Text="推荐"></asp:ListItem>
                          <asp:ListItem Value ="3" Text="内部竞聘"></asp:ListItem>
                                ...
                                <tr>
                                    <td  class="td_list_fields">初试结果</td>
                                    <td class="tdColInput">
                            ...
                            <asp:ListItem Value="2">不予考虑</asp:ListItem>
                                    ...
                                    <td  class="td_list_fields">复试日期</td>
                                    <td class="tdColInput">
                                    ...
                                    <td  class="td_list_fields">复试结果</td>
                                    <td class="tdColInput">
