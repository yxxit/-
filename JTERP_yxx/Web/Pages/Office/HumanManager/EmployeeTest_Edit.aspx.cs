...
public partial class Pages_Office_HumanManager_EmployeeTest_Edit : BasePage
{
    ...
    private string CreateTestResultTable()
    {
        ...
        table.AppendLine("<tr>");
        table.AppendLine("<td  class='td_list_fields' width='10%'>姓名</td>");
        table.AppendLine("<td  class='td_list_fields' width='23%'>考试得分</td>");
        table.AppendLine("<td  class='td_list_fields' width='10%'>姓名</td>");
        table.AppendLine("<td  class='td_list_fields' width='23%'>考试得分</td>");
        table.AppendLine("<td  class='td_list_fields' width='10%'>姓名</td>");
        table.AppendLine("<td  class='td_list_fields' width='24%'>考试得分</td>");
        table.AppendLine("</tr>");
