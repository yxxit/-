<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PerformanceDetailsByLA.aspx.cs" Inherits="Pages_Office_HumanManager_PerformanceDetailsByLA"  EnableEventValidation="false"%>
                            ...
                            <table width="100%" border="0"  cellpadding="2" cellspacing="1" bgcolor="#CCCCCC">
                                <tr>
                                 <td  class="td_list_fields" width="10%">
                                  ...
                                  <%--   onchange="getChangeAll()" --%>
                                          <asp:DropDownList ID="ddlTaskFlag" runat="server"   AutoPostBack="true" 
                                            onselectedindexchanged="ddlTaskFlag_SelectedIndexChanged1"        >
                                ...
                                <tr>
                                 ...
                                 <div  id="dvSearchTaslNum" style="float:left">
                                    ...
                                    <td height="20"  class="td_list_fields" width="10%">考核建议</td>
                                    <td class="tdColInput" width="23%">
                     ...
                     <td height="30" align="right" valign="top" style="width: 20%; ">      <table border="0" cellpadding="0" cellspacing="0"  style=" margin-right:10px;">
                                <tr>
                                    <td>
                                               ...
                                               <asp:RadioButton ID="chkType1" runat="server" Text="柱状图"  
                                            AutoPostBack="true" oncheckedchanged="chkType1_CheckedChanged" GroupName ="123" Checked="true" />
                                    </td>
                                </tr>
                                <tr>
                                    <td>
