...
public partial class Pages_Office_HumanManager_SalaryItem : BasePage
{
    ...
    private string CreateSalaryListTable()
    {
        ...
        table.AppendLine("		<td  class='td_list_fields' style='width:10%'>固定工资项编号</td>              ");
        table.AppendLine("		<td  class='td_list_fields' style='width:10%'>排列顺序</td>              ");
        table.AppendLine("		<td  class='td_list_fields' style='width:15%'><span style=\"color:Red\">*</span>名称</td>                 ");
        table.AppendLine("		<td  class='td_list_fields' style='width:10%'  >计算公式</td>             ");
        table.AppendLine("		<td  class='td_list_fields' style='width:15%'>备注</td>                 ");
        table.AppendLine("		<td  class='td_list_fields' style='width:10%'><span style=\"color:Red\">*</span>是否扣款</td>             ");
        table.AppendLine("		<td  class='td_list_fields' style='width:10%'><span style=\"color:Red\">*</span>是否固定</td>             ");
