                    ...
                    <tr>
                        <td bgcolor="#FFFFFF">
                            <table width="100%" border="0"  cellpadding="2" cellspacing="1" bgcolor="#CCCCCC">
                                <tr>
                                    <td height="20"  class="td_list_fields" width="10%" align="right" >要素名称</td>
                                    <td class="tdColInput" width="23%">
                                     ...
                                     <td  class="td_list_fields" width="10%" align="right" >启用状态</td>
                                    <td class="tdColInput" width="23%">
                        ...
                        <tr>
                            <td  colspan="2">
                                ...
                                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#999999" id="tblBaseInfo" style="display:block">
                                    <tr>
                                        <td height="20" align="right"  class="td_list_fields" width="15%">要素名称<span class="redbold">*</span></td>
                                        <td height="20" class="tdColInput" width="35%">
                                            <input type="text" id="txtEditElemName" maxlength="50" class="tdinput" />
                                        </td>
                                        <td height="20" align="right"  class="td_list_fields" width="15%">启用状态<span class="redbold">*</span></td>
                                        <td height="20" class="tdColInput" width="35%">
                                    ...
                                    <tr>
                                        <td height="20" align="right"  class="td_list_fields">评分标准<span class="redbold">*</span></td>
