    ...
    <tr>
        <td  colspan="2">
            ...
            <table width="99%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#999999" id="tblBaseInfo" style="display:block">
                <tr>
                    <td height="20"  class="td_list_fields" width="10%" align="right">工资报表编号<span class="redbold">*</span></td>
                    ...
                    <td height="20"  class="td_list_fields" width="10%" align="right">工资报表主题<span class="redbold">*</span></td>
                    ...
                    <td height="20"  class="td_list_fields" width="10%" align="right">报表状态</td>
                ...
                <tr>
                    <td height="20"  class="td_list_fields" align="right">所属月份<span class="redbold">*</span></td>
                    ...
                    <td height="20"  class="td_list_fields" align="right">开始时间<span class="redbold">*</span></td>
                    ...
                    <td height="20"  class="td_list_fields" align="right">结束时间<span class="redbold">*</span></td>
                    <td height="20" class="tdColInput" align="center">
                ...
                <tr>
                    <td height="20"  class="td_list_fields" align="right">编制人<span class="redbold">*</span></td>
                    <td height="20" class="tdColInput" align="center">
                    ...
                    <td height="20"  class="td_list_fields" align="right">编制日期<span class="redbold">*</span></td>
                    <td height="20" class="tdColInput" align="center">
