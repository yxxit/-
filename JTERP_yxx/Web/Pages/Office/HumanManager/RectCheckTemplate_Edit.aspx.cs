...
public partial class Pages_Office_HumanManager_RectCheckTemplate_Edit : BasePage
{
    ...
    private string CreateElemTable()
    {
        ...
        table.AppendLine("<tr>");
        table.AppendLine("<td  class='td_list_fields' style='width:20%'>");
        table.AppendLine("选择<input type='checkbox' name='chkAll' id='chkAll' onclick='SelectAll();'/>");
        table.AppendLine("</td>");
        table.AppendLine("<td  class='td_list_fields' style='width:20%'>要素名称</td>");
        table.AppendLine("<td  class='td_list_fields' style='width:20%'>满分</td>");
        table.AppendLine("<td  class='td_list_fields' style='width:20%'>权重(%)</td>");
        table.AppendLine("<td  class='td_list_fields' style='width:20%'>备注</td>");
        table.AppendLine("</tr>");
