                            ...
                            <table width="100%" border="0"  cellpadding="2" cellspacing="1" bgcolor="#CCCCCC">
                                ...
                                <tr>
                                 ...
                                 <div  id="dvSearchTaslNum">
                                      ...
                                      <td height="20"  class="td_list_fields" width="10%" align="right">考核等级</td>
                                    <td class="tdColInput" width="23%">
                               <select id="SelLevelType" runat="server" name="SelLevelType" style="display:block">
                                     ...
                                     <td  class="td_list_fields" width="10%" align="right">考核建议</td>
                                    <td class="tdColInput" width="23%">
                                       ...
                                       <tr>
                                    <td height="20"  class="td_list_fields" width="10%" align="right">被考核人</td>
                                    <td class="tdColInput" width="23%" >
