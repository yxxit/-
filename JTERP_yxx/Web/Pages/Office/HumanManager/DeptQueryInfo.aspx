...
<body>
  ...
  <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#F0F0F0"  id="tblDetailList" >
      ...
      <tr>
        <td height="30" valign="top"><span class="Blue"><img src="../../../images/Main/Arrow.jpg" width="21" height="18" align="absmiddle" />岗位说明书</span></td>
      </tr>
      <tr>
                        ...
                        <tr>
                            <td  colspan="2">
                                ...
                                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#999999" id="tblBaseInfo" style="display:block">
                                    <tr>
                                        <td height="20" align="right"  class="td_list_fields" width="5%">岗位编号<span class="redbold">*</span></td>
                                        ...
                                        <td height="20" align="right"  class="td_list_fields" width="5%">所属机构<span class="redbold">*</span></td>
                                        ...
                                        <td height="20" align="right"  class="td_list_fields" width="6%">上级岗位</td>
                                        <td height="20" class="tdColInput" width="10%">
                                    ...
                                    <tr>
                                        <td height="20" align="right"  class="td_list_fields">岗位名称<span class="redbold">*</span></td>
                                        ...
                                        <td height="20" align="right"  class="td_list_fields">拼音代码</td>
                                        <td height="20" class="tdColInput">
                                            <asp:TextBox ID="txtPYShort" runat="server" CssClass="tdinput" Width="96%" Enabled="false"></asp:TextBox> 
                                        </td>
                                        <td height="20" align="right"  class="td_list_fields">是否关键岗位</td>
                                        <td height="20" class="tdColInput">
                                    ...
                                    <tr>
                                        <td height="20" align="right"  class="td_list_fields">岗位分类</td>
                                        <td height="20" class="tdColInput">
                                        ...
                                        <td height="20" align="right"  class="td_list_fields" >岗位级别</td>
                                        <td height="20" class="tdColInput">
                                    ...
                                    <tr>
                                        ...
                                        <td height="20" class="tdColInput">
                                            ...
                                            <tr>
                                        <td height="20" align="right"  class="td_list_fields" width="8%">开启关联模块  </td>
                                        
                                        <td height="20"    class="td_list_fields"   colspan="5"  style =" text-align:center">是否开启所属类型</td>
                                   ...
                                   <tr>
                                    ...
                                    <tr>
                                        <td height="20" align="right"  class="td_list_fields" width="10%"><asp:CheckBox  ID="chGgongzuo" runat="server" Text="工作日志模块" Enabled="false" />    </td>
                                       ...
                                       <tr>
                                        <td height="20" align="right"  class="td_list_fields" width="10%"><asp:CheckBox  ID="chCricheng" runat="server" Text="日程管理模块" Enabled="false" />    </td>
                                        <td height="30" class="tdColInput" width="15%"   align="center">&nbsp;   </td>
                                        <td height="20"  class="tdColInput" width="15%"  align="center"> &nbsp;    </td>
                                        <td height="20" class="tdColInput" width="15%"  align="center">   &nbsp;  </td>
                                        <td height="20"  class="tdColInput" width="15%"  align="center">&nbsp;     </td>
                                    ...
                                    <td colspan="6">
                                       ...
                                       <tr>
                                        <td height="20" align="right"  class="td_list_fields">岗位职责</td>
                                    ...
                                    <tr>
                                        <td height="20" align="right"  class="td_list_fields">任职资格</td>
                                        <td height="20" colspan="5" class="tdColInput">
