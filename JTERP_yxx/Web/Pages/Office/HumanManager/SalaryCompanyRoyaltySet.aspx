<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SalaryCompanyRoyaltySet.aspx.cs"
    Inherits="Pages_Office_HumanManager_SalaryCompanyRoyaltySet" %>
...
<head id="Head1" runat="server">
    ...
    <script src="../../../js/office/HumanManager/SalaryCompanyRoyaltySet.js" type="text/javascript"></script>
                    ...
                    <tr>
                        ...
                        <td width="15%" bgcolor="#FFFFFF">
                            <input name="txtSubCom" id="txtSubCom" type="text" class="tdinput" size="19" readonly="readonly"
                                onclick="alertdiv('txtSubCom,hidtxtSubCom');" runat="server" style="width: 95%" />
                            <input type="hidden" id="hidtxtSubCom" runat="server" />
                        </td>
                        <td>
                            <%--<asp:DropDownList ID="dplSubCompany" runat="server">
                            </asp:DropDownList>--%>
