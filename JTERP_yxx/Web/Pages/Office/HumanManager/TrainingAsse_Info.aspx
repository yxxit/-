                    ...
                    <tr>
                        <td bgcolor="#FFFFFF">
                            <table width="100%" border="0"  cellpadding="2" cellspacing="1" bgcolor="#CCCCCC" class="table">
                                <tr>
                                    <td height="20"  class="td_list_fields" width="10%" align="right">考核编号</td>
                                    <td class="tdColInput" width="23%">
                                     ...
                                     <td  class="td_list_fields" width="10%" align="right">培训编号</td>
                                    <td class="tdColInput" width="23%">
                                    ...
                                    <td height="20"  class="td_list_fields" width="10%" align="right">培训名称</td>
                                ...
                                <tr>
                                    <td  class="td_list_fields" align="right">培训方式</td>
                                    <td class="tdColInput">
                                        <uc1:CodeType ID="ddlTrainingWay" runat="server" />
                                    </td>
                                    <td  class="td_list_fields" align="right">考评人</td>
                                    <td class="tdColInput">
                                    ...
                                    <td  class="td_list_fields" align="right">考评时间</td>
                                    <td class="tdColInput">
