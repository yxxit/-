...
<%--<%@ Register src="../../../UserControl/UFPersonSel.ascx" tagname="UFPersonSel" tagprefix="uc6" %>
<%@ Register src="../../../UserControl/UFEmployeeSel.ascx" tagname="UFEmployeeSel" tagprefix="uc7" %>
<%@ Register Src="../../../UserControl/UFCustSel.ascx" TagName="UFCustSel"  TagPrefix="uc12" %>--%>
...
<script src="../../../js/office/MedicineManager/CustNew_1.js" type="text/javascript"></script>
 <script src="../../../js/office/MedicineManager/CustNewInfo.js" type="text/javascript"></script>
    <style type="text/css">
        .style1
        {
            color: #044d77;
    ...
    //选择T6用户档案 2013-10-28 bsd
    function fnSelectPerson() {
            popSellUFPersonObj.ShowList('protion');
    }
    //选择T6职员档案 2014-02-19
    function fnSelectEmployee() {
            popSellUFEmployeeObj.ShowList('protion');
    }
    </script>
    </head>
<body> 
<form id="frmMain" runat="server">
<%-- <uc6:UFPersonSel ID="UFPersonSel" runat="server" />
 <uc7:UFEmployeeSel ID="UFEmployeeSel" runat="server" />
  <uc12:UFCustSel ID="UFCustSel" runat="server" /> --%>   
    ...
    <tr>
        <td  colspan="2">
            ...
            <table width="99%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#999999" id="tblBaseInfo" style="display:block">
                <tr>
                  <td height="20" align="right"  class="td_list_fields">编号<span class="redbold">*</span></td>
                  <td class="tdColInput">
                ...
                <tr>
                  <td height="20" align="right"  class="td_list_fields">姓名<span class="redbold">*</span></td>
                  <td class="tdColInput">
                ...
                <tr>
                  <td align="right"  class="td_list_fields">曾用名</td>
                  <td class="tdColInput" >
                    <asp:TextBox ID="txtUsedName" runat="server" Width="95%" MaxLength="25" CssClass="tdinput"></asp:TextBox>
                  </td>
                  <td align="right"  class="td_list_fields" >角色分类<span class="redbold">*</span></td>
                  <td class="tdColInput" >
                   <select id="ddlRoleType" runat="server" style="margin-top:2px;margin-left:2px;">
                        <option value="1" selected="selected">公司职员</option>
                        <option value="2">客户职员</option>                      
                    </select>
                  </td>
                </tr>
                <tr>
                  ...
                  <td align="right"  class="td_list_fields">证件类型</td>
                  <td class="tdColInput" >
                ...
                <tr runat="server">
                  ...
                  <td align="right"  class="td_list_fields" >社保卡号</td>
                  <td class="tdColInput" >                      
                ...
                <tr runat="server">
                  ...
                  <td align="right"  class="td_list_fields" >岗位</td>
                ...
                <tr id="tr1" >
                  ...
                  <td align="right"  class="td_list_fields" >岗位职等</td>
                  <td class="tdColInput" >
                ...
                <tr>
                  ...
                  <td class="tdColInput" >
                    <asp:TextBox ID="txtBirth" runat="server" ReadOnly="true" MaxLength="10" CssClass="tdinput" onclick="WdatePicker({dateFmt:'yyyy-MM-dd',el:$dp.$('txtBirth')})"></asp:TextBox>
                          ...
                          <tr>
                  <td align="right"  class="style1"  >T6用户</td>
                  <td class="style2" >
                    <input id="txtUserId" type="hidden" runat="server"   />
                    <asp:TextBox ID="txtPersonCode" runat="server" ReadOnly MaxLength="25" CssClass="tdinput"  ToolTip="角色分类为公司职员，请选择对应T6用户"  Width="40%"></asp:TextBox>
                     <asp:TextBox ID="txtPersonName" runat="server" ReadOnly MaxLength="25" CssClass="tdinput"  ToolTip="角色分类为公司职员，请选择对应T6用户"  Width="40%"></asp:TextBox>
                     
                    <img src="../../../Images/default/search1.gif" alt="搜索" style="cursor: hand" onclick="fnSelectPerson()" />
                  </td>
                 
                  <td align="right"  class="style1" >T6职员</td>
                  <td class="style2" >
                    <input id="txtEmployeeId" type="hidden" runat="server"  />
                     <asp:TextBox ID="txtT_EmployeeCode" runat="server" ReadOnly MaxLength="25" CssClass="tdinput" ToolTip="角色分类为公司职员，请选择对应T6职员"  Width="40%"></asp:TextBox>
                     <asp:TextBox ID="txtT_EmployeeName" runat="server" ReadOnly MaxLength="25" CssClass="tdinput" ToolTip="角色分类为公司职员，请选择对应T6职员"  Width="40%"></asp:TextBox>
                        <img src="../../../Images/default/search1.gif" alt="搜索" style="cursor: hand" onclick="fnSelectEmployee()" />
                  </td>
                   <td align="right"  class="style1" >客户单位</td>
                  <td class="style2" >
                   <input id="txtCustomerId" class="tdinput" type="text" readonly runat="server" style="width: 40%;display:none" />
                   <input id="txtCustomerName" class="tdinput" type="text" readonly runat="server" title="角色分类为客户职员，请选择该职员所属的单位" style="width:80%" />
                    <img src="../../../Images/default/search1.gif" alt="搜索" style="cursor: hand" onclick="fnSelectUFCust()" />
                  </td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td align="right"  class="td_list_fields" >家庭住址</td>
                  <td class="tdColInput" >
                ...
                <tr>
                  <td height="25" align="right"  class="td_list_fields">外语语种1</td>
                  <td class="tdColInput" >
                    <uc1:CodeType ID="ddlLanguage1" runat="server" />
                  </td>
                  <td align="right"  class="td_list_fields" >外语语种2</td>
                  <td class="tdColInput" >
                    <uc1:CodeType ID="ddlLanguage2" runat="server" />
                  </td>
                  <td align="right"  class="td_list_fields" >外语语种3</td>
                  <td class="tdColInput">
                    <uc1:CodeType ID="ddlLanguage3" runat="server" />
                  </td>
                </tr>
                <tr>
                  <td height="25" align="right"  class="td_list_fields">外语水平1</td>
                  <td class="tdColInput" >
                  ...
                  <td align="right"  class="td_list_fields" >外语水平2</td>
                  <td class="tdColInput" >
                  ...
                  <td align="right"  class="td_list_fields" >外语水平3</td>
                  <td class="tdColInput" >
                ...
                <tr style="display:none">
                  <td align="right"  class="style1"  >T6用户</td>
                  <td class="style2" >
                    <input id="txtUserId1" type="hidden" runat="server"   />
                    <asp:TextBox ID="txtPersonCode1" runat="server" ReadOnly MaxLength="25" CssClass="tdinput"  ToolTip="角色分类为公司职员，请选择对应T6用户"  Width="40%"></asp:TextBox>
                     <asp:TextBox ID="txtPersonName1" runat="server" ReadOnly MaxLength="25" CssClass="tdinput"  ToolTip="角色分类为公司职员，请选择对应T6用户"  Width="40%"></asp:TextBox>
                  ...
                  <td align="right"  class="style1" >T6职员</td>
                  <td class="style2" >
                    <input id="txtEmployeeId1" type="hidden" runat="server"  />
                     <asp:TextBox ID="txtT_EmployeeCode1" runat="server" ReadOnly MaxLength="25" CssClass="tdinput" ToolTip="角色分类为公司职员，请选择对应T6职员"  Width="40%"></asp:TextBox>
                     <asp:TextBox ID="txtT_EmployeeName1" runat="server" ReadOnly MaxLength="25" CssClass="tdinput" ToolTip="角色分类为公司职员，请选择对应T6职员"  Width="40%"></asp:TextBox>
                        <img src="../../../Images/default/search1.gif" alt="搜索" style="cursor: hand" onclick="fnSelectEmployee()" />
                  </td>
                   <td align="right"  class="style1" >客户单位</td>
                  <td class="style2" >
                   <input id="txtCustomerId1" class="tdinput" type="text" readonly runat="server" style="width: 40%;display:none" />
                   <input id="txtCustomerName1" class="tdinput" type="text" readonly runat="server" title="角色分类为客户职员，请选择该职员所属的单位" style="width:80%" />
                    <img src="../../../Images/default/search1.gif" alt="搜索" style="cursor: hand" onclick="fnSelectUFCust()" />
                  </td>
                </tr>
                <tr>
                  <td align="right"  class="td_list_fields">简历</td>
                  <td class="tdColInput">
                    <table>
                        <tr>
                            <td>
                  ...
                  <td align="right"  class="td_list_fields">专业描述</td>
                  <td class="tdColInput" > <asp:TextBox ID="txtProfessionalDes" runat="server" MaxLength="50" CssClass="tdinput" Width="95%"></asp:TextBox>
                    
                  </td>
                  <td align="right"  class="td_list_fields">英文名<span class="redbold">*</span></td>
                  <td class="tdColInput" > 
                            ...
                            <tr>
                                <td>
                                    <table  width='100%' border='0' id='tblEmployeeContract'  align='center' cellpadding='0' cellspacing='1' bgcolor='#999999'>
                                        <tr>
                                            <td  class='td_list_fields'>合同号</td>
                                            <td  class='td_list_fields'>合同名称</td>
                                            <td  class='td_list_fields'>合同类型</td>
                                            <td  class='td_list_fields'>合同属性</td>
                                            <td  class='td_list_fields'>签约时间</td>
                                            <td  class='td_list_fields'>生效时间</td>
                                            <td  class='td_list_fields'>状态</td>
                                        </tr>
