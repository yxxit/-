                    ...
                    <tr>
                        <td bgcolor="#FFFFFF">
                            <table width="100%" border="0"  cellpadding="2" cellspacing="1" bgcolor="#CCCCCC">
                                <tr>
                                    <td height="20"  class="style1" width="10%"  align"right"> 考核任务编号<span style="color:Red">*</span></td>
                                    <td class="tdColInput" width="23%">
                                     ...
                                     <td  class="style1" width="10%" align"right">考核任务主题<span 
                                             style="color:Red; text-align: right;">*</span></td>
                                    <td class="tdColInput" width="23%">
                                        <input id="inptTitle" type="text" maxlength="50" size="50"  class="tdinput"  SpecialWorkCheck="考核任务主题"
/></td>
                                </tr>     
                                   <tr>
                                    <td height="20"  class="style1" width="10%" align"right">考核期间类型<span style="color:Red">*</span></td>
                                    <td class="tdColInput" width="23%">
                                    <select id="selTaskFlag" runat="server"  onclick="getChange(this);" name="D1">
                                     ...
                                     <td  class="td_list_fields" width="10%" align"right">   <div id="getNull" 
                                             class="style2"> 考核周期<span style="color:Red; text-align: right;">*</span></div></td>
                                   ...
                                   <tr>
                                    <td height="20"  class="style1" width="10%" align"right">考核开始日期<span style="color:Red">*</span></td>
                                    <td class="tdColInput" width="23%">
                           <asp:TextBox ID="txtStartDate" runat="server" MaxLength="10" CssClass="tdinput" onclick="J.calendar.get();"  style="width:100%"  ReadOnly="true"></asp:TextBox>
                                     ...
                                     <td  class="style1" width="10%" align"right">考核结束日期<span style="color:Red">*</span></td>
                                    <td class="tdColInput" width="23%">
                                   ...
                                   <tr>
                                    <td height="20"  class="style1" width="10%" align"right">备注</td>
