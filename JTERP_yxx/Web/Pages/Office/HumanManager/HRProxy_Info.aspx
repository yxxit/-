                    ...
                    <tr>
                        <td bgcolor="#FFFFFF">
                            <table width="100%" border="0"  cellpadding="2" cellspacing="1" bgcolor="#CCCCCC" class="table">
                                <tr>
                                    <td height="20"  class="td_list_fields" width="10%" align="right" >编号</td>
                                    <td class="tdColInput" width="23%">
                                     ...
                                     <td  class="td_list_fields" width="10%" align="right" >企业名称</td>
                                    <td class="tdColInput" width="23%">
                                    ...
                                    <td height="20"  class="td_list_fields" width="10%" align="right" >重要程度</td>
                                ...
                                <tr>
                                    <td  class="td_list_fields" align="right" >合作关系</td>
                                    <td class="tdColInput">
                                    ...
                                    <td  class="td_list_fields" align="right" >启用状态</td>
                                    <td class="tdColInput">
