                            ...
                            <table width="99%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#999999"
                                ...
                                <tr>
                                    ...
                                    <td height="20" class="tdColInput">
                                        <asp:TextBox ID="txtTitle" runat="server" CssClass="tdinput" Width="95%" MaxLength="50"></asp:TextBox>
                                    </td>
                                ...
                                <tr>
                                    <%--<td height="20"  class="td_list_fields">工种</td>
                        ...
                        <asp:DropDownList ID="ddlContractKind" runat="server" CssClass="tdinput">
                            ...
                            <asp:ListItem Value="3">兼职</asp:ListItem>
                                ...
                                <tr>
                                    ...
                                    <td height="20"  class="td_list_fields">
                                        &nbsp;</td>
                                    <td height="20" class="tdColInput">
                                        &nbsp;</td>
                                </tr>
                                <tr>
                                    <%--<td height="20"  class="td_list_fields">转正标识</td>
                    <td height="20" class="tdColInput">
                        <asp:DropDownList ID="ddlFlag" runat="server" CssClass="tdinput">
                            <asp:ListItem Value="">--请选择--</asp:ListItem>
                            <asp:ListItem Value="0">否</asp:ListItem>
