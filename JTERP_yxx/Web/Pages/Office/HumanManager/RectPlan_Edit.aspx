    ...
    <tr>
        <td  colspan="2">
            ...
            <table width="99%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#999999" id="tblCompanyInfo" style="display:block">
                <tr>
                    <td height="20" align="right"  class="td_list_fields" width="10%">招聘计划编号<span class="redbold">*</span></td>
                    ...
                    <td height="20" class="tdColInput" width="23%">
                      ...
                      <td height="20" align="right"  class="td_list_fields" width="10%">负责人<span class="redbold"  >*</span></td>
                ...
                <tr>
                  <td height="20" align="right"  class="td_list_fields" width="10%">开始时间<span class="redbold">*</span></td>
                    ...
                    <td height="20" align="right"  class="td_list_fields">结束时间<span class="redbold">*</span></td>
                    <td height="20" class="tdColInput">
                    ...
                    <td height="20" align="right"  class="td_list_fields"> 计划状态<span class="redbold">*</span></td>
                    <td height="20" class="tdColInput">
    ...
    <tr>
        <td height="25" valign="top" colspan="2">
            <table width="99%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#999999" id="Table1" style="display:block">
                <tr>
                    <td height="20" align="right"  class="td_list_fields" width="10%">预算金额 </td>
                    <td height="20" class="tdColInput" width="23%">
                    ...
                    <td height="20" align="right"  class="td_list_fields" width="10%"> 预算说明</td>
                    <td height="20" class="tdColInput" width="23%">
    ...
    <tr>
        <td height="25" valign="top" colspan="2">
            <table width="99%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#999999" id="Table2" style="display:block">
                <tr>
                    <td height="20" align="right"  class="td_list_fields" width="10%">招聘人数 </td>
                    <td height="20" class="tdColInput" width="23%">
    ...
    <tr>
        <td height="25" valign="top" colspan="2">
            <table width="99%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#999999" id="Table3" style="display:block">
                <tr>
                    <td height="20" align="right"  class="td_list_fields" width="10%">招聘小组成员 </td>
               ...
               <input type="hidden" id="txtJoinMan" runat="server" />
                        ...
                        <tr>
                    <td height="20" align="right"  class="td_list_fields" width="10%">成员分工说明 </td>
                    <td height="20" class="tdColInput"    colspan="5">
