                    ...
                    <tr>
                        <td bgcolor="#FFFFFF">
                            <table width="100%" border="0"  cellpadding="2" cellspacing="1" bgcolor="#CCCCCC" class="table">
                                <tr>
                                    <td height="20"  class="td_list_fields" width="10%">人员编号</td>
                                ...
                                <tr>
                                    <td height="20"  class="td_list_fields">岗位</td>
                                    <td class="tdColInput">
                                        <asp:DropDownList ID="ddlQuarter" runat="server"></asp:DropDownList>
                                    </td>
                                    <td height="20"  class="td_list_fields">岗位职等</td>
                                    <td class="tdColInput">
