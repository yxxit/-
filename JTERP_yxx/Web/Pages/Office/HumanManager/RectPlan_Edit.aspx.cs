...
public static string GetWorkAge(string i)
{
    ...
    private string CreateGoalTable()
    {
        ...
        table.AppendLine("</td>");
        table.AppendLine("<td  class='td_list_fields'>招聘部门</td>");
        table.AppendLine("<td  class='td_list_fields'>岗位名称</td>");
        table.AppendLine("<td  class='td_list_fields'>人员数量</td>");
        table.AppendLine("<td  class='td_list_fields'>性别</td>");
        table.AppendLine("<td  class='td_list_fields'>年龄</td>");
        table.AppendLine("<td  class='td_list_fields'>工作年限</td>");
        table.AppendLine("<td  class='td_list_fields'>学历</td>");
        table.AppendLine("<td  class='td_list_fields'>专业</td>");
        table.AppendLine("<td  class='td_list_fields'>工作要求</td>");
        table.AppendLine("<td  class='td_list_fields'>计划完成时间</td>");
        table.AppendLine("</tr>");
        //返回表格语句
    ...
    private string CreatePublishTable()
    {
        ...
        table.AppendLine("</td>");
        table.AppendLine("<td  class='td_list_fields'>发布媒体和渠道</td>");
        table.AppendLine("<td  class='td_list_fields'>发布时间</td>");
        table.AppendLine("<td  class='td_list_fields'>有效时间(天)</td>");
        table.AppendLine("<td  class='td_list_fields'>截止时间</td>");
        table.AppendLine("<td  class='td_list_fields'>费用</td>");
        table.AppendLine("<td  class='td_list_fields'>效果</td>");
        table.AppendLine("<td  class='td_list_fields'>发布状态</td>");
        table.AppendLine("</tr>");
