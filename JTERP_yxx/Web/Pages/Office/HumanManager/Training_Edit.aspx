    ...
    <tr>
        <td  colspan="2">
            ...
            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#999999" id="tblTrainingInfo" style="display:block">
                <tr>
                    <td height="20" align="right"  class="td_list_fields" width="10%">培训编号<span class="redbold">*</span></td>
                    ...
                    <td height="20" align="right"  class="td_list_fields" width="10%">培训名称<span class="redbold">*</span></td>
                    <td height="20" class="tdColInput" width="23%">
                        <asp:TextBox ID="txtTrainingName" runat="server" MaxLength="50" CssClass="tdinput" Width="95%"></asp:TextBox>
                    </td>
                    <td height="20" align="right"  class="td_list_fields" width="10%">发起时间<span class="redbold">*</span></td>
                ...
                <tr>
                    <td height="20" align="right"  class="td_list_fields" >发起人<span class="redbold">*</span></td>
                ...
                <tr>
                    ...
                    <td height="20" align="right"  class="td_list_fields" >结束时间</td>
                    <td height="20" class="tdColInput">
                    ...
                    <td height="20" align="right"  class="td_list_fields">考核人</td>
                    <td height="20" class="tdColInput" >
                ...
                <tr>
                    ...
                    <td height="20" align="right"  class="td_list_fields" >目的</td>
                ...
                <tr>
                    <td height="20" align="right"  class="td_list_fields" >参与人员<span class="redbold">*</span></td>
                ...
                <tr>
                    <td height="20" align="right"  class="td_list_fields" >培训备注</td>
                    <td height="20" class="tdColInput" colspan="5">
