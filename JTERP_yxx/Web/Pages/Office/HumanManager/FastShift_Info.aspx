<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FastShift_Info.aspx.cs" Inherits="Pages_Office_HumanManager_FastShift_Info" %>
                        ...
                        <td bgcolor="#FFFFFF">
                            <table width="100%" border="0"  cellpadding="2" cellspacing="1" bgcolor="#CCCCCC" class="table">
                                <tr>
                                    ...
                                    <td width="23%" class="tdColInput">
                                        <asp:TextBox ID="txtEmployeeNum" Width="95%" specialworkcheck="工号" CssClass="tdinput" runat="server"></asp:TextBox>
                                    </td>
                                    <td width="10%"  class="td_list_fields" align="right">姓名</td>
                                ...
                                <tr>
                                    ...
                                    <td  class="td_list_fields" align="right">入职时间</td>
                                    <td class="tdColInput">
                                    ...
                                    <td height="20"  class="td_list_fields" align="right">岗位</td>
                                    <td class="tdColInput">
        ...
        <tr>
            <td colspan="2">
                ...
                <table width="100%" align="center" border="0" cellpadding="0" cellspacing="0" id="tblDetailList" >
                    ...
                    <tr>
                        <td height="30" colspan="2" align="center" valign="top" class="Title">快速调职通道</td>
                    </tr>
                    <tr>
                            ...
                            <table width="99%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#999999">
                                <tr>
                                    <td height="28" bgcolor="#FFFFFF">
                                        <img src="../../../images/Button/Button_kstz.jpg" alt="快速调职" visible="false" id="btnFastShift" runat="server" onclick="DoFastShift()" style='cursor:pointer;'/>
