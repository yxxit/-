                        ...
                        <td bgcolor="#FFFFFF">
                            <table width="100%" border="0"  cellpadding="2" cellspacing="1" bgcolor="#CCCCCC">
                                ...
                                <tr>
                                    ...
                                    <td  class="td_list_fields" width="10%" style="height:23px" align="right">
                    ...
                    <tr>
                        <td colspan="2">
                            ...
                            <table  width="99%" border="0" align="center" cellpadding="0" cellspacing="1" id="tblDetailInfo" bgcolor="#999999">
                                <tbody>
                                    <tr>
                                        <th height="20" align="center" class="td_list_fields" >选择<input type="checkbox" id="chkCheckAll" name="chkCheckAll" onclick="AllSelect('chkCheckAll', 'chkSelect')"/></th>
                ...
                <table width="99%" border="0" align="center" cellpadding="0" id="Table2"  cellspacing="0" bgcolor="#CCCCCC">
                    <tr>
                        <td bgcolor="#FFFFFF">
                            <table width="100%" border="0"  cellpadding="2" cellspacing="1" bgcolor="#CCCCCC">
                                <tr>
                                    <td height="20"  class="td_list_fields" width="10%">自我鉴定编号<span style="color:Red ">*</span></td>
                                    <td class="tdColInput" width="23%">
                                     ...
                                     <td  class="td_list_fields" width="10%">主题<span style="color:Red ">*</span></td>
                                    <td class="tdColInput" width="23%">
                                        <input id="inptTitle" type="text" maxlength="25" size="25" /></td>
                                </tr>     
                                   <tr>
                                    <td height="20"  class="td_list_fields" width="10%">  期间类型<span style="color:Red ">*</span></td>
                                    <td class="tdColInput" width="23%">
                                    <select id="selTaskFlag" runat="server"  onclick="getChange(this);" name="D1">
                                     ...
                                     <td  class="td_list_fields" width="10%"><div id="getNull">考核周期<span style="color:Red ">*</span></div>  </td>
                                    <td class="tdColInput" width="23%">
                                   ...
                                   <tr>
                                    <td height="20"  class="td_list_fields" width="10%">开始日期<span style="color:Red ">*</span></td>
                                    <td class="tdColInput" width="23%">
                           <asp:TextBox ID="txtStartDate" runat="server" MaxLength="10" CssClass="tdinput"  onclick="J.calendar.get();"></asp:TextBox>
                       
                                         
                                    </td>
                                     <td  class="td_list_fields" width="10%">结束日期<span style="color:Red ">*</span></td>
                                    <td class="tdColInput" width="23%">
                                 ...
                                 <tr>
                                    <td   class="td_list_fields" width="10%">工作内容</td>
                                    <td class="tdColInput" width="23%" colspan="3">
                                        ...
                                        <textarea id="txtWorkContent" rows="3" class="tdinput" style="width: 100%; height:50px" onkeyup="textcontrol(this.id,500)"  runat="server"  cols="3"  ></textarea>
                                    </td>
                                </tr> 
                                 <tr>
                                    <td   class="td_list_fields" width="10%">完成情况</td>
                                    <td class="tdColInput" width="23%" colspan="3">
                                      
                                         <%-- <input    id="" maxlength ="250" onkeyup="textcontrol(this.id,500)"   style="width:100%;  " class="tdinput" />--%>
                                           <textarea id="txtComplete" rows="3" class="tdinput" style="width: 100%; height:50px" onkeyup="textcontrol(this.id,500)"  runat="server"  cols="3"  ></textarea>
                                    </td>
                                </tr> 
                                 <tr>
                                    <td height="20"  class="td_list_fields" width="10%">后续工作</td>
                                    <td class="tdColInput" width="23%" colspan="3">
                                    
                                                             <%--   <input    id="" maxlength ="250" onkeyup="textcontrol(this.id,500)"   style="width:100%;  " class="tdinput" />--%>
                                                                <textarea id="txtAfterWork" rows="3" class="tdinput" style="width: 100%; height:50px" onkeyup="textcontrol(this.id,500)"  runat="server"  cols="3"  ></textarea>
                                    </td>
                                </tr> 
                                 <tr>
                                    <td height="20"  class="td_list_fields" width="10%">存在不足 </td>
                                    <td class="tdColInput" width="23%" colspan="3">
                                
                                         <%--  <input    id="" maxlength ="250" onkeyup="textcontrol(this.id,500)"   style="width:100%;  " class="tdinput" />--%>
                                            <textarea id="txtDefects" rows="3" class="tdinput" style="width: 100%; height:50px" onkeyup="textcontrol(this.id,500)"  runat="server"  cols="3"  ></textarea>
                                    </td>
                                </tr> 
                                 <tr>
                                    <td height="20"  class="td_list_fields" width="10%">存在困难</td>
                                    <td class="tdColInput" width="23%" colspan="3">
                                  
                                         <%--    <input    id="txtProblems" maxlength ="250" onkeyup="textcontrol(this.id,500)"   style="width:100%;  " class="tdinput" />--%>
                                          <textarea id="txtProblems" rows="3" class="tdinput" style="width: 100%; height:50px" onkeyup="textcontrol(this.id,500)"  runat="server"  cols="3"  ></textarea>
                                    </td>
                                </tr> 
                                 <tr>
                                    <td height="20"  class="td_list_fields" width="10%">个人建议</td>
                                    <td class="tdColInput" width="23%" colspan="3">
                                      <textarea id="txtAdvices" rows="3" class="tdinput" style="width: 100%; height:50px" onkeyup="textcontrol(this.id,500)"  runat="server"  cols="3"  ></textarea>
                                        <%--   <input    id="" maxlength ="250" onkeyup="textcontrol(this.id,500)"   style="width:100%;  " class="tdinput" />--%>
                                    </td>
                                </tr> 
                                 <tr>
                                    <td height="20"  class="td_list_fields" width="10%">备注说明</td>
                                    <td class="tdColInput" width="23%" colspan="3">
                                   <textarea id="txtRemark" rows="3" class="tdinput" style="width: 100%; height:50px" onkeyup="textcontrol(this.id,500)"  runat="server"  cols="3"  ></textarea>
