    ...
    <tr>
        <td  colspan="2">
            ...
            <table width="99%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#999999" id="tblBaseInfo" style="display:block">
                <tr>
                    <td height="20" align="right"  class="td_list_fields" width="10%">离职申请编号<span class="redbold">*</span></td>
                    ...
                    <td height="20" align="right"  class="td_list_fields" width="10%">主题<span class="redbold">*</span></td>
                    <td height="20" class="tdColInput" width="23%">
                        <asp:TextBox ID="txtTitle" runat="server" CssClass="tdinput"  MaxLength="50"></asp:TextBox>
                    </td>
                    <td height="20" align="right"  class="td_list_fields" width="10%">申请人<span class="redbold">*</span></td>
                ...
                <tr>
                    ...
                    <td height="20" align="right"  class="td_list_fields">申请日期<span class="redbold">*</span></td>
                    <td height="20" class="tdColInput">
                    ...
                    <td height="20" align="right"  class="td_list_fields">到职日期</td>
                    <td height="20" class="tdColInput">
                ...
                <tr>
                    ...
                    <td height="20" align="right"  class="td_list_fields">合同有效期<span class="redbold">*</span></td>
                    <td height="20" class="tdColInput">
                ...
                <tr>
                    <td height="20" align="right"  class="td_list_fields">离职类型</td>
                    <td height="20" class="tdColInput">
                    ...
                    <td height="20" align="right"  class="td_list_fields">通知离职日期</td>
                    <td height="20" class="tdColInput">
                    ...
                    <td height="20" align="right"  class="td_list_fields">事由<span class="redbold">*</span></td>
                    <td height="20" class="tdColInput">
                        <asp:TextBox ID="txtReason" runat="server" CssClass="tdinput" MaxLength="100" Width="95%"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td height="20"  class="td_list_fields" align="right">访谈记录</td>
