     ...
     <div id="divEditCheckItem" runat="server" style="background: #fff; padding: 10px; width: 800px; z-index:900; position: absolute;top: 20%; left: 15%;   display:none    ">    
        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="maintable" id="tblDepttemInfo">
                        ...
                        <tr>
                            <td  colspan="2">
                                ...
                                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#999999" id="tblBaseInfo" style="display:block">
                                    <tr>
                                    <td height="20"    class="td_list_fields"  style="width:6%">指标编号<span class="redbold">*</span></td>
                                        ...
                                        <td height="20"   class="td_list_fields" style="width:7%">指标名称<span class="redbold">*</span></td>
                                        ...
                                        <td height="20"   class="td_list_fields" style="width:6%">启用状态<span class="redbold">*</span></td>
                                        <td height="20" class="tdColInput"   style="width:15%">
                                    ...
                                    <tr> 
                                    <td height="20" align="right"  class="td_list_fields" width="1%">标准分<span class="redbold">*</span></td>
                                        <td height="20" class="tdColInput" >
                                            <input type="text" id="txtStandardScore" maxlength="6" class="tdinput"  onchange='Number_round(this,"0");'/>
                                        </td>
                                        <td height="20" align="right"  class="td_list_fields" width="6%">评分最小值<span class="redbold">*</span></td>
                                        <td height="20" class="tdColInput" >
                                            <input type="text" id="txtMinScore" maxlength="6" class="tdinput"  onchange='Number_round(this,"0");'/>
                                        </td>
                                      <td height="20" align="right"  class="td_list_fields" width="7%">评分最大值<span class="redbold">*</span></td>
                                        <td height="20" class="tdColInput" >
                                   ...
                                   <tr>
                                   <td height="20" align="right"  class="td_list_fields" width="1%">评分标准</td>
         ...
         <input id="txtAsseStandard" maxlength ="1024"   style="width:100%;  " class="tdinput"  SpecialWorkCheck="评分标准"/>
                                    ...
                                    <tr>
                                   <td height="20" align="right"  class="td_list_fields" width="1%">评分来源</td>
                                        <td height="20" class="tdColInput" width="35%" colspan="5">
                                    ...
                                    <tr>
                                   <td height="20" align="right"  class="td_list_fields" width="1%">评分细则</td>
                                        <td height="20" class="tdColInput" width="35%" colspan="5">
                                   ...
                                   <tr>
                                   <td height="20" align="right"  class="td_list_fields" width="1%">备注</td>
                                        <td height="20" class="tdColInput" width="35%" colspan="5">
