            ...
            <tr>
                <td  colspan="2">
                    ...
                    <table width="99%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#999999" id="tblBaseInfo" style="display:block">
                        <tr>
                            <td height="20" align="right"  class="td_list_fields" width="10%">申请编号 <span class="redbold">*</span></td>
                            ...
                            <td height="20" align="right"  class="td_list_fields" width="10%"  >申请部门<span class="redbold">*</span></td>
                            <td height="20" class="tdColInput" width="23%">
                            ...
                            <td height="20" align="right"  class="td_list_fields" width="10%">现有人数</td>
                            <td height="20" class="tdColInput" width="24%">
                                <input id="txtNowNum" type="text"   style=" width:99%"   maxlength ="9" class="tdinput"    runat="server"   SpecialWorkCheck="现有人数"  />
                            </td>
                        </tr>
                        <tr>
                            <td height="20" align="right"  class="td_list_fields" width="10%">编制定额</td>
                        ...
                        <tr>
                            ...
                            <td height="20" align="right"  class="td_list_fields" >招聘原因</td>
            ...
            <tr>
                <td colspan="2">
                    <table width="99%" border="0" id="tblUserInfo" style="BEHAVIOR:url(../../../draggrid.htc)"  align="center" cellpadding="0" cellspacing="1" bgcolor="#999999">
                        <tr>
                            <td height="20" align="right"  class="td_list_fields" width="10%"> 需求人数(人) </td>
                            <td height="20" class="tdColInput"  width="23%">
                              <input id="txtRequireNum" type="text"   style=" width:99%"   maxlength ="5" class="tdinput"  runat ="server" size="10"  readonly ="readonly"/>
                            </td>
                          <td height="20" align="right"  class="td_list_fields" width="10%">  </td>
                            <td height="20" class="tdColInput"  width="23%">
                ...
                <td colspan="2">
                    <table width="99%" border="0" id="tblRemarkInfo" style="BEHAVIOR:url(../../../draggrid.htc)"  align="center" cellpadding="0" cellspacing="1" bgcolor="#999999">
                         <tr>
                            ...
                            <td height="20" align="right"  class="td_list_fields"  width="10%">确认日期   </td>
                            <td height="20" class="tdColInput"  width="23%">
                            <asp:TextBox ID="txtConfirmDate" runat="server"  CssClass="tdinput" ReadOnly="true"></asp:TextBox>
                            </td>
                            <td height="20" align="right"  class="td_list_fields"  width="10%">结单人</td>
                            <td height="20" class="tdColInput"  width="24%">
                           ...
                           <tr>
                            <td height="20" align="right"  class="td_list_fields" width="10%">结单日期 </td>
                            <td height="20" class="tdColInput"  width="23%">
                                <asp:TextBox ID="txtCloseDate" runat="server"  CssClass="tdinput" ReadOnly="true"></asp:TextBox>
                            </td>
                            <td height="20" align="right"  class="td_list_fields"  width="10%">    经手人</td>
                            <td height="20" class="tdColInput"  width="23%">
                        ...
                        <tr>
                            <td height="20" align="right"  class="td_list_fields" width="10%">备注</td>
