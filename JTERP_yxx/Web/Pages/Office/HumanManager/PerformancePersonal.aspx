                    ...
                    <tr>
                        <td bgcolor="#FFFFFF">
                            <table width="100%" border="0"  cellpadding="2" cellspacing="1" bgcolor="#CCCCCC">
                                <tr>
                                    <td height="20"  class="td_list_fields" width="10%">编号<span style="color:Red ">*</span></td>
                                   ...
                                   <tr>
                                    <td height="20"  class="td_list_fields" width="10%">  鉴定周期分类<span style="color:Red ">*</span></td>
                                    <td class="tdColInput" width="23%">
                                ...
                                <select id="selTaskYear" runat="server" name="D3" style="display:block; float:left">
                                   ...
                                   <tr>
                                    ...
                                    <td class="tdColInput" width="23%">
                           <asp:TextBox ID="txtStartDate" runat="server" MaxLength="10" CssClass="tdinput"  onclick="J.calendar.get();" Width="398px"></asp:TextBox>
                       
                                         
                                    </td>
                                     <td  class="td_list_fields" width="10%">结束日期<span style="color:Red ">*</span></td>
                                    <td class="tdColInput" width="23%">
                                    <asp:TextBox ID="txtEndDate" runat="server" MaxLength="10" CssClass="tdinput"       onclick="J.calendar.get();"    Width="400px"></asp:TextBox>
