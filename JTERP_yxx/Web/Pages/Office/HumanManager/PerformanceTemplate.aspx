            ...
            <tr>
                <td  colspan="2">
                    ...
                    <table width="99%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#999999" id="tblBaseInfo" style="display:block">
                        <tr>
                            <td height="20" align="right"  class="td_list_fields" width="10%">模板编号<span class="redbold">*</span></td>
                            <td height="20" class="tdColInput" width="23%">
                            <div id="txtPerformTmNo"> 
                               <uc2:CodingRule ID="AimNum" runat="server" class="tdinput" /></div>
                                <input id="txtEditPerformTemp" type="text" maxlength="20" readonly="readonly"  disabled   class="tdinput" /></td>
                        ...
                        <tr>
                          <td height="20" align="right"  class="td_list_fields" width="10%">考核类型<span class="redbold">*</span></td>
                            <td height="20" class="tdColInput" width="24%">
                              ...
                              <td  class="td_list_fields" width="10%">启用状态<span class="redbold">*</span></td>
                                    <td class="tdColInput" width="23%">
              ...
              <input id="txtRemark" maxlength ="500" onkeyup="textcontrol(this.id,250)"   style="width:100%; " class="tdinput" SpecialWorkCheck="备注"   />
                        ...
                        <tr>
                            ...
                            <td height="20" align="right"  class="td_list_fields" >创建日期</td>
                            <td height="20" class="tdColInput" colspan="5">
