<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PerformanceStatistics.aspx.cs" Inherits="Pages_Office_HumanManager_PerformanceStatistics" %>
...
<head id="Head1" runat="server">
  ...
  <script src="../../../js/office/HumanManager/PerformanceStatistics.js" type="text/javascript"></script>
...
<div id="PerformanceTypeCheck"   >
  ...
  <tr>
    <td align="right" colspan="2" style="height:20px"><a href="PerformanceQuery.aspx?ModuleID=2011809" style="text-decoration:none; "><span  >  考核查询</span></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="PerformanceStatistics.aspx?ModuleID=2011809" style="text-decoration:none; "><span  >考核统计</span></a></td>
    </tr>
        <tr>
            <td valign="top">
        ...
        <tr>
            <td colspan="2"  >
                        ...
                        <td bgcolor="#FFFFFF">
                            ...
                            <input type="hidden" id="txtDeptID" runat="server" />
                                    ...
                                    <td height="20"  class="td_list_fields" width="10%">
                                        考核任务</td>
                                    <td class="tdColInput" width="23%">
                                        <input name="txtTestNo" id="txtTaskTitle" runat="server"   maxlength="50" type="text"  style="width:100%"  onclick="popTaskObj.ShowList('txtTaskTitle')" readonly="readonly" title ="" class="tdinput"/>
                                    </td>
                                      <td height="20"  class="td_list_fields" width="10%">
                                                                                考核期间类型</td>
                                    <td class="tdColInput" width="23%">
                                ...
                                <tr>
                                 ...
                                 <div  id="dvSearchTaslNum">
                                    ...
                                    <td height="20"  class="td_list_fields" width="10%">考核等级</td>
                                    <td class="tdColInput" width="23%">
                               <select id="SelLevelType" runat="server" name="SelLevelType" style="display:block">
                                     ...
                                     <td  class="td_list_fields" width="10%">考核建议</td>
                                    <td class="tdColInput" width="23%">
             ...
             <tr>
                    ...
                    <tr>
                        <td height="20" colspan="2" align="center" valign="top" class="Title">考核统计</td>
                    </tr>
            <tr>
                ...
                <table width="99%" border="0" align="center" cellpadding="0" cellspacing="1" id="tblDetailInfo" bgcolor="#999999">
                                <tbody>
                                    <tr>
                                        ...
                                        <th align="center" class="td_list_fields" >
                                            <div class="orderClick" onclick="OrderBy('LevelType','oC4');return false;">
                                                考核等级<span id="oC4" class="orderTip"></span>
                                            </div>
                                        </th>
                                         <th align="center" class="td_list_fields" >
                                            <div class="orderClick" onclick="OrderBy('AdviceType','oC5');return false;">
                                                考核建议<span id="oC5" class="orderTip"></span>
                                            </div>
                                        </th>
                                        <th align="center" class="td_list_fields" >
                                            <div class="orderClick" onclick="OrderBy('CountPerson','oC6');return false;">
                                                人数<span id="oC6" class="orderTip"></span>
                                            </div>
                                        </th>
                                    </tr>
                                </tbody>
