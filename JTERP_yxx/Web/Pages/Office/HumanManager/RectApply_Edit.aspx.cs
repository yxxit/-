...
public partial class Pages_Office_HumanManager_RectApply_Edit : BasePage
{
    ...
    private string CreateGoalTable()
    {
        ...
        table.AppendLine("<tr>");
        table.AppendLine("<td  class='td_list_fields'  >");
        ...
        table.AppendLine("</td>");
        table.AppendLine("<td  class='td_list_fields'>岗位</td>");
        table.AppendLine("<td  class='td_list_fields'>职务说明</td>");
        table.AppendLine("<td  class='td_list_fields'>需求人数</td>");
        table.AppendLine("<td  class='td_list_fields'>最迟上岗时间</td>");
        table.AppendLine("<td  class='td_list_fields'>工作地点</td>");
        table.AppendLine("<td  class='td_list_fields'>工作性质</td>");
        table.AppendLine("<td  class='td_list_fields'>性别</td>");
        table.AppendLine("<td  class='td_list_fields'>起始年龄</td>");
        table.AppendLine("<td  class='td_list_fields'>截止年龄</td>");
        ...
        table.AppendLine("<td  class='td_list_fields'>其他要求</td>");
        table.AppendLine("<td  class='td_list_fields'>可提供的待遇</td>");
        table.AppendLine("</tr>");
        //返回表格语句
