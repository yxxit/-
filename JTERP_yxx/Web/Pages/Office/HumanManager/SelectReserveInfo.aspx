                    ...
                    <tr>
                        <td bgcolor="#FFFFFF">
                            <table width="100%" border="0"  cellpadding="2" cellspacing="1" bgcolor="#CCCCCC" class="table">
                                <tr>
                                    <td height="20"  class="td_list_fields" width="15%">人员编号</td>
                                ...
                                <tr>
                                    <td height="20"  class="td_list_fields">学历</td>
                                    <td class="tdColInput">
                                        <uc1:CodeType ID="ddlCulture" runat="server" />
                                    </td>
                                    <td height="20"  class="td_list_fields">专业</td>
                                    <td class="tdColInput">
