                ...
                <tr>
                    <td bgcolor="#FFFFFF">
                        <table width="100%" border="0"  cellpadding="2" cellspacing="1" bgcolor="#CCCCCC" class="table">
                            <tr>
                                <td width="10%" height="20"  class="td_list_fields" align="right">员工编号</td>
                                ...
                                <td width="10%"  class="td_list_fields" align="right">员工号</td>
                                <td width="23%" class="tdColInput">
                            ...
                            <tr>
                                <td  class="td_list_fields" height="25" align="right">所在岗位</td>
                                <td class="tdColInput">
                                    <asp:DropDownList ID="ddlQuarter" runat="server"></asp:DropDownList>
                                </td>
                                <td  class="td_list_fields" align="right">岗位职等</td>
                                <td class="tdColInput">
