                           ...
                           <asp:TextBox ID="txtStartDate" runat="server" MaxLength="10" CssClass="tdinput" onclick="WdatePicker({dateFmt:'yyyy-MM-dd',el:$dp.$('txtStartDate')})" style="width:100%"></asp:TextBox>
                                ...
                                <%--<tr>
                                 ...
                                 <tr>
                                   ...
                                   <tr>
                                    <td height="20"  class="td_list_fields" width="10%">被考核人数</td>
                                    <td class="tdColInput" width="23%" colspan="3">
                                ...
                                <tr>
                                    <td height="20"  class="td_list_fields" width="10%">已评分的考评人人数</td>
                                    <td class="tdColInput" width="23%" colspan="3">
                                  ...
                                  <tr>
                                    <td height="20"  class="td_list_fields" width="10%">未评分的考评人人数</td>
                                    <td class="tdColInput" width="23%" colspan="3">
                                ...
                                <tr>
                                    <td height="20"  class="td_list_fields" width="10%">是否可汇总</td>
                                    <td class="tdColInput" width="23%" colspan="3">
