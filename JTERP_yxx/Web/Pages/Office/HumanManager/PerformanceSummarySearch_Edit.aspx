<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PerformanceSummarySearch_Edit.aspx.cs" Inherits="Pages_Office_HumanManager_PerformanceSummarySearch_Edit" %>
...
<head id="Head1" runat="server">
  ...
  <script src="../../../js/office/HumanManager/PerformanceSummarySearch_Edit.js" type="text/javascript"></script>
  ...
  <div id="divEditCheckItem" runat="server"  >    
    ...
    <table  width="98%"border="0" cellpadding="0" cellspacing="0" class="checktable" id="mainindex">
        ...
        <tr>
         ...
         <tr>
                        <td height="30" colspan="2" align="center" valign="top" class="Title">考核总评</td>
                    </tr>
        <tr>
            <td  valign="top" class="Title" colspan="2">
                <img src="../../../images/Main/Arrow.jpg" width="21" height="18" align="absmiddle"  style="float:left "/>
      <img src="../../../Images/Button/Bottom_btn_confirm.jpg" runat="server" visible="false" alt="任务总评" id="btnGather" style="cursor:hand;float:left"   onclick="DoSave();"  />
                        ...
                        <td bgcolor="#FFFFFF">
                            <table width="100%" border="0"  cellpadding="2" cellspacing="1" bgcolor="#CCCCCC">
                                <tr>
                                    ...
                                    <td class="tdColInput" width="23%">
                                        <input id="inptTitle" type="text" maxlength="25" size="25" class="tdinput"  style="width:100%"/></td>
                                </tr>     
                                   <tr>
                           ...
                           <asp:TextBox ID="txtStartDate" runat="server" MaxLength="10" CssClass="tdinput" onclick="WdatePicker({dateFmt:'yyyy-MM-dd',el:$dp.$('txtStartDate')})"></asp:TextBox>
                                   ...
                                   <tr>
                                    ...
                                    <td class="tdColInput" width="23%" >
                                      ...
                                      <td  class="td_list_fields" width="10%">任务状态</td>
                                    <td class="tdColInput" width="23%">
                                    <div id="inpTaskStaus" style="color:Red ;"></div>
                                    </td>
                                </tr> 
                                  <tr>
                                    <td height="20"  class="td_list_fields" width="10%">创建人</td>
                                    <td class="tdColInput" width="23%" >
                                       <div id="inpCreater"></div>
                                         
                                    </td>
                                      <td  class="td_list_fields" width="10%">创建时间</td>
                                    <td class="tdColInput" width="23%">
                                    <div id="inpCreateDate"></div>
                                    </td>
                                </tr> 
                                  <tr>
                                    <td height="20"  class="td_list_fields" width="10%">汇总人</td>
                                    <td class="tdColInput" width="23%" >
                                       <div id="inpSummaryer"></div>
                                         
                                    </td>
                                      <td  class="td_list_fields" width="10%">汇总日期</td>
                                    <td class="tdColInput" width="23%">
                                    <div id="inpSummaryDate"></div>
                                    </td>
                                </tr> 
                                <tr>
                                    <td height="20"  class="td_list_fields" width="10%">评语</td>
                                 ...
                                 <tr>
                                    <td height="20"  class="td_list_fields" width="10%">说明事项</td>
                                    <td class="tdColInput" width="23%" colspan="3">
        ...
        <tr>
            <td  valign="top" class="Title">
                <img src="../../../images/Main/Arrow.jpg" width="21" height="18" align="absmiddle" /> 
               <span class="Blue"> 考核得分信息 </span>   <%-- <img src="../../../Images/Button/Bottom_btn_save.jpg" runat="server" visible="true" alt="保存" id="btnSave" style="cursor:hand" height="25" onclick="DoSave('0');"/>--%>&nbsp;
                ...
                <table width="99%" border="0" align="center" cellpadding="0" id="Table1"  cellspacing="0" bgcolor="#CCCCCC">
                    <tr>
                        <td bgcolor="#FFFFFF">
                            <table width="100%" border="0"  cellpadding="2" cellspacing="1" bgcolor="#CCCCCC">
                                <tr>
                                    <td height="20"  class="td_list_fields" width="10%">考核总得分</td>
                                    <td class="tdColInput" width="23%">
                                      <div id="inpTotalScore"></div>
                                        
                                    </td>
                                     <td  class="td_list_fields" width="10%"></td>
                                    <td class="tdColInput" width="23%">
                                        </td>
                                </tr>     
                ...
                <table width="99%" border="0" align="center" cellpadding="0" id="Table3"  cellspacing="0" bgcolor="#CCCCCC">
                    <tr>
                        <td bgcolor="#FFFFFF">
                            <table width="100%" border="0"  cellpadding="2" cellspacing="1" bgcolor="#CCCCCC">
                                <tr>
                                    <td height="20"  class="td_list_fields" width="10%">累计扣分<span style="color:Red ">*</span></td>
                                    <td class="tdColInput" width="23%">
                                         <input id="inpKillScore" type="text"  size="25" maxlength ="5" class="tdinput" onkeydown="Numeric_OnKeyDown();"  onchange="Number_round(this,0); " style="width:100%" onpropertychange ="getTrueScore();"/>
                                        
                                    </td>
                                     <td  class="td_list_fields" width="10%">累计加分<span style="color:Red ">*</span></td>
                                    <td class="tdColInput" width="23%">
                                        <input id="inpAddScore" type="text"  size="25" maxlength ="5" class="tdinput" onkeydown="Numeric_OnKeyDown();"  onchange="Number_round(this,0); "  style="width:100%" onpropertychange ="getTrueScore();" />
                                        </td>
                                </tr>     
                                   <tr>
                                     <td  class="td_list_fields" width="10%">实际得分</td>
                                    <td class="tdColInput" width="23%">
                                     <input id="inpSrs" type="text"  size="25" maxlength ="50" class="tdinput"  disabled="disabled" style="width:100%"/>
                                   
                                    </td>
                                    <td height="20"  class="td_list_fields" width="10%">建议事项<span style="color:Red ">*</span></td>
                                    <td class="tdColInput" width="23%">
                                   ...
                                   <tr>
                                    <td height="20"  class="td_list_fields" width="10%">总评</td>
                                    <td class="tdColInput" width="23%">
                                      <input id="inpSummaryNote" type="text"  size="25" maxlength ="50" class="tdinput" style="width:100%"/>
                       
                                         
                                    </td>
                                      <td  class="td_list_fields" width="10%">考核等级<span style="color:Red ">*</span></td>
                                    <td class="tdColInput" width="23%">
                                   ...
                                   <tr>
                                    <td height="20"  class="td_list_fields" width="10%">建议说明</td>
                                    <td class="tdColInput" width="23%" >
                                      <input id="inpsan" type="text"  size="100" maxlength ="100" class="tdinput" style="width:100%"/>
                                         
                                    </td>
                                     <td height="20"  class="td_list_fields" width="10%">奖惩说明</td>
                                    <td class="tdColInput" width="23%" >
                                      <input id="inpRewardNote" type="text"  size="100" maxlength ="100" class="tdinput" style="width:100%"/>
                        ...
                        <tr>
                            ...
                            <td  class="td_list_fields" width="10%">备注</td>
                                    <td class="tdColInput" width="23%">
                                    <input id="inpSumarryRemark" type="text"  size="100" maxlength ="100" class="tdinput" style="width:100%"/>
                                    </td>
                                        <td  class="td_list_fields" width="10%"></td>
                                    <td class="tdColInput" width="23%">
