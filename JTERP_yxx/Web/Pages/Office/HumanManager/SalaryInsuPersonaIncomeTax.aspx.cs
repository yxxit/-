...
public partial class Pages_Office_HumanManager_SalaryInsuPersonaIncomeTax : BasePage 
{
    ...
    private string CreateSalaryListTable()
    {
        ...
        table.AppendLine("		</td>                                                             ");
        table.AppendLine("		<td  class='td_list_fields' style='width:30%'><span style=\"color:Red\">*</span>应交税上限</td>             ");
        table.AppendLine("		<td  class='td_list_fields' style='width:20%'><span style=\"color:Red\">*</span>应交税下限</td>             ");
        table.AppendLine("		<td  class='td_list_fields' style='width:20%'><span style=\"color:Red\">*</span>税率(%)</td>             ");
        table.AppendLine("		<td  class='td_list_fields' style='width:13%'>速算扣除数</td>             ");
        table.AppendLine("	</tr>                                                                 ");
        //返回表格语句
