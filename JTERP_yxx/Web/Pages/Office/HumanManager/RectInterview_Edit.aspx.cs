...
public partial class Pages_Office_HumanManager_RectInterview_Edit : BasePage
{
    ...
    private string CreateElemScoreTable()
    {
        ...
        table.AppendLine("<tr>");
        table.AppendLine("<td  class='td_list_fields'>要素名称</td>");
        table.AppendLine("<td  class='td_list_fields'>满分</td>");
        table.AppendLine("<td  class='td_list_fields'>权重(%)</td>");
        table.AppendLine("<td  class='td_list_fields'>面试得分</td>");
        table.AppendLine("<td  class='td_list_fields'>备注</td>");
        table.AppendLine("</tr>");
