    ...
    <tr>
        <td  colspan="2">
            ...
            <table width="99%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#999999" id="tblBaseInfo" style="display:block">
                <tr>
                    <td height="20" align="right"  class="td_list_fields" width="10%">面试记录编号<span class="redbold">*</span></td>
                    ...
                    <td height="20" align="right"  class="td_list_fields" width="10%">对应招聘计划</td>
                    <td height="20" class="tdColInput" width="23%">
                        <asp:DropDownList ID="ddlRectPlan" runat="server"  Width="120px" ></asp:DropDownList>
                    </td>
                    <td height="20" align="right"  class="td_list_fields" width="10%">姓名&nbsp;<a href="#" onclick="AddEmployee();">添加简历</a><span class="redbold">*</span></td>
                ...
                <tr>
                    <td height="25" align="right"  class="td_list_fields">招聘方式</td>
                    ...
                    <td height="20" align="right"  class="td_list_fields">应聘岗位<span class="redbold">*</span></td>
                    <td height="20" class="tdColInput">
                           <div id="divQuarter">
                        <asp:DropDownList ID="ddlQuarter" runat="server" style="margin-left:2px;" Width="120px"></asp:DropDownList>
                        </div>
                    </td>
                    <td height="20" align="right"  class="td_list_fields">面试模板<span class="redbold">*</span></td>
                    <td height="20" class="tdColInput">
                        <div id="divTemplate">
                ...
                <tr>
                    <td height="20" align="right"  class="td_list_fields">附件 </td>
                    <td height="20" class="tdColInput">
                               <table>
                            <tr>
                                <td>
                    ...
                    <td height="20" align="right"  class="td_list_fields"> </td>
                    <td height="20" class="tdColInput">
    ...
    <tr>
        <td colspan="2">
            <table width="99%" border="0" id="Table1" style="BEHAVIOR:url(../../../draggrid.htc)"  align="center" cellpadding="0" cellspacing="1" bgcolor="#999999">
                <tr>
                    <td height="25" align="right"  class="td_list_fields" width="10%">日期<span class="redbold">*</span></td>
                    ...
                    <td height="25" align="right"  class="td_list_fields" width="10%">面试方式</td>
                    <td height="25" class="tdColInput" width="23%">
                        <uc1:CodeType ID="ddlInterviewType" runat="server" />
                    </td>
                    <td height="25" align="right"  class="td_list_fields" width="10%">面试地点</td>
                ...
                <tr>
                    <td height="25" align="right"  class="td_list_fields">初试综合评价</td>
                    ...
                    <td height="25" align="right"  class="td_list_fields">初试结果</td>
    ...
    <tr>
        <td colspan="2">
            <table width="99%" border="0" id="tblInterviewResultInfo" style="BEHAVIOR:url(../../../draggrid.htc)"  align="center" cellpadding="0" cellspacing="1" bgcolor="#999999">
                <tr>
                    <td height="25" align="right"  class="td_list_fields" width="10%">日期</td>
                    <td height="25" class="tdColInput" width="23%">
                 ...
                 <td height="25" align="right"  class="td_list_fields">可提供的待遇</td>
                    ...
                    <td height="25" class="tdColInput">
                     <asp:TextBox runat="server" CssClass="tdinput" MaxLength="300" Width="95%" ID="txtFinalSalary"  onkeydown='Numeric_OnKeyDown();'  onchange="Number_round(this,2)"></asp:TextBox>
                          ...
                          <td height="25" align="right"  class="td_list_fields"> 其他方面</td>
                    <td height="25" class="tdColInput">
              <asp:TextBox runat="server" CssClass="tdinput" MaxLength="300" Width="95%" ID="txtOtherNote" ></asp:TextBox>
                    </td>
                </tr>
                 <tr>
                      <td height="25" align="right"  class="td_list_fields">复试结果</td>
                    <td height="25" class="tdColInput">
                    ...
                    <td height="25" align="right"  class="td_list_fields">  </td>
                    <td height="25" class="tdColInput">
