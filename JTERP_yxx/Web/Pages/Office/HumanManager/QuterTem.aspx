            ...
            <tr>
                <td>
                    ...
                    <table width="100%" border="0" cellpadding="0" cellspacing="0" id="tblmain">
                          ...
                          <tr>
                                        <td height="20" align="right"  class="td_list_fields" width="8%">   岗位说明书名称</td>
                                        
                                        <td height="20"    class="td_list_fields"   colspan="5"  style =" text-align:left; vertical-align:top">    <asp:TextBox ID="txtName" runat="server"></asp:TextBox>
                                        
                                        </td>
                                       
                                    </tr>
                         <tr>
                                        <td height="20" align="right"  class="td_list_fields" width="8%">   已保存的模板</td>
                                        
                                        <td height="20"    class="td_list_fields"   colspan="5"  style =" text-align:left; vertical-align:top"> (选择可用于修改，不选择模板，则用于新建)     <asp:DropDownList ID="QuterModelSelect"  runat="server" AutoPostBack="True" 
