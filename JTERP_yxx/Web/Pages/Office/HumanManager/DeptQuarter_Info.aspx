                            ...
                            <td  colspan="2">
                                ...
                                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#999999" id="tblBaseInfo" style="display:block">
                                    ...
                                    <tr>
                                        ...
                                        <td height="20" align="right"  class="td_list_fields">拼音代码<span class="redbold">*</span></td>
                                        <td height="20" class="tdColInput">
                                    ...
                                    <tr>
                                        ...
                                        <td height="20" align="right"  class="td_list_fields">岗位说明书模块</td>
                                        <td height="20" class="tdColInput">
                                   ...
                                   <tr>
                                    ...
                                    <tr>
                                        <td height="20" align="right"  class="td_list_fields" width="10%"><asp:CheckBox  ID="chGgongzuo" runat="server" Text="工作日志模块" />    </td>
                                       ...
                                       <tr>
                                        <td height="20" align="right"  class="td_list_fields" width="10%"><asp:CheckBox  ID="chCricheng" runat="server" Text="日程管理模块"/>    </td>
                                        <td height="30" class="tdColInput" width="15%"   align="center">&nbsp;   </td>
                                        <td height="20"  class="tdColInput" width="15%"  align="center"> &nbsp;    </td>
                                        <td height="20" class="tdColInput" width="15%"  align="center">   &nbsp;  </td>
                                        <td height="20"  class="tdColInput" width="15%"  align="center">&nbsp;     </td>
