...
public partial class Pages_Office_HumanManager_EmployeeInfo_Add : BasePage
{
    ...
    private void InitEmployeeBaseInfo(EmployeeInfoModel employModel)
    {
        ...
        //关联用友用户
        txtUserId.Value = employModel.UfpersonId;
        txtPersonCode.Text = employModel.UfpersonId;
        txtPersonName.Text = employModel.Ufpersonname;
        txtT_EmployeeCode.Text = employModel.UfEmployeeId;
        txtT_EmployeeName.Text = employModel.UfEmployeename;
        ddlRoleType.Value = employModel.Roletype;

        //管理客户单位
        txtCustomerId.Value = employModel.Custid;
        txtCustomerName.Value = employModel.Custname;
    ...
    private string CreateWorkTable()
    {
        ...
        table.AppendLine("	<tr>                                                                                                                ");
        table.AppendLine("		<td  class='td_list_fields' width='50'>                                                  ");
        ...
        table.AppendLine("		</td>                                                                                                           ");
        table.AppendLine("		<td  class='td_list_fields'>开始时间</td>                                                ");
        table.AppendLine("		<td  class='td_list_fields'>结束时间</td>                                                ");
        table.AppendLine("		<td  class='td_list_fields'>工作单位</td>                                                ");
        table.AppendLine("		<td  class='td_list_fields'>所在部门</td>                                                ");
        table.AppendLine("		<td  class='td_list_fields'>工作内容</td>                                                ");
        table.AppendLine("		<td  class='td_list_fields'>离职原因</td>                                                ");
        table.AppendLine("	</tr>                                                                                                ");
        //返回表格语句
    ...
    private string CreateStudyTable()
    {
        ...
        table.AppendLine("	<tr>                                                                                                                 ");
        table.AppendLine("		<td  class='td_list_field'  width='50'>                                                  ");
        ...
        table.AppendLine("		<td  class='td_list_fields'>开始时间</td>                                                 ");
        table.AppendLine("		<td  class='td_list_fields'>结束时间</td>                                                 ");
        table.AppendLine("		<td  class='td_list_fields'>学校名称</td>                                                 ");
        table.AppendLine("		<td  class='td_list_fields'>专业</td>                                                     ");
        table.AppendLine("		<td  class='td_list_fields'>学历</td>                                                     ");
        table.AppendLine("	</tr>                                                                                                                ");
    ...
    private string CreateSkillTable()
    {
        ...
        table.AppendLine("		</td>                                                                                                     ");
        table.AppendLine("		<td  class='td_list_fields'>技能名称</td>                                          ");
        table.AppendLine("		<td  class='td_list_fields'>证件名称</td>                                          ");
        table.AppendLine("		<td  class='td_list_fields'>证件编号</td>                                          ");
        table.AppendLine("		<td  class='td_list_fields'>证件等级</td>                                          ");
        table.AppendLine("		<td  class='td_list_fields'>发证单位</td>                                          ");
        table.AppendLine("		<td  class='td_list_fields'>发证时间</td>                                          ");
        table.AppendLine("		<td  class='td_list_fields'>有效期</td>                                            ");
        table.AppendLine("	</tr>                                                                                         ");
