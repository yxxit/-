                    ...
                    <tr>
                        <td bgcolor="#FFFFFF">
                            <table width="100%" border="0"  cellpadding="2" cellspacing="1" bgcolor="#CCCCCC">
                                <tr>
                                    <td height="20"  class="td_list_fields" width="10%">改进计划编号<span style="color:Red ">*</span></td>
                                    <td class="tdColInput" width="23%">
                                     ...
                                     <td  class="td_list_fields" width="10%">改进计划主题<span style="color:Red ">*</span></td>
                                    <td class="tdColInput" width="23%">
                                   ...
                                   <tr>
                                    ...
                                    <td class="tdColInput" width="23%">
                                     ...
                                     <td  class="td_list_fields" width="10%">创建日期</td>
                                    <td class="tdColInput" width="23%">
