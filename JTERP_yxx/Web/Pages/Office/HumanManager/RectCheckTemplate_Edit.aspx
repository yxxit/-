                ...
                <td  colspan="2">
                    ...
                    <table width="99%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#999999" id="tblBaseInfo" style="display:block">
                        <tr>
                            ...
                            <td height="20" align="right"  class="td_list_fields" width="10%">岗位<span class="redbold">*</span></td>
                            <td height="20" class="tdColInput" width="24%">
                                <asp:DropDownList ID="ddlQuarter" runat="server"></asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
                            <td height="20" align="right"  class="td_list_fields" width="10%">启用状态<span class="redbold">*</span></td>
                            <td height="20" class="tdColInput" width="23%">
