    ...
    <tr>
        <td  colspan="2">
            ...
            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#999999" id="tblBaseInfo" style="display:block">
                <tr>
                    <td height="20" align="right"  class="td_list_fields" width="10%">考核编号<span class="redbold">*</span></td>
                    ...
                    <td height="20" align="right"  class="td_list_fields" width="10%">考核人<span class="redbold">*</span></td>
                ...
                <tr>
                    <td height="20" align="right"  class="td_list_fields">考核方式<span class="redbold">*</span></td>
                    ...
                    <td height="20" align="right"  class="td_list_fields" >考核时间<span class="redbold">*</span></td>
                    <td height="20" class="tdColInput">
                    ...
                    <td height="20" align="right"  class="td_list_fields">填写人</td>
                    <td height="20" class="tdColInput">
                ...
                <tr>
                    <td height="20" align="right"  class="td_list_fields" >培训规划</td>
                ...
                <tr>
                    <td height="20" align="right"  class="td_list_fields" >领导意见</td>
                    <td height="20" class="tdColInput" colspan="5">
                ...
                <tr>
                    <td height="20" align="right"  class="td_list_fields" >说明</td>
                    <td height="20" class="tdColInput" colspan="5">
    ...
    <tr>
        <td colspan="2">
            <table width="100%" border="0" id="tblContactRemark" style="BEHAVIOR:url(../../../draggrid.htc)"  align="center" cellpadding="0" cellspacing="1" bgcolor="#999999">
                <tr>
                    <td height="20" align="right"  class="td_list_fields" width="10%">考核总评</td>
                    <td height="20" class="tdColInput">
    ...
    <tr>
        <td colspan="2">
            <table width="100%" border="0" id="tblRemark" style="BEHAVIOR:url(../../../draggrid.htc)"  align="center" cellpadding="0" cellspacing="1" bgcolor="#999999">
                <tr>
                    <td height="20" align="right"  class="td_list_fields" width="10%">考核备注</td>
                    <td height="20" class="tdColInput">
