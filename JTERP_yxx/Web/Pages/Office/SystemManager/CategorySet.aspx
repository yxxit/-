<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CategorySet.aspx.cs" Inherits="Pages_Office_SystemManager_CategorySet" %>
          ...
          <table border="0" cellpadding="3" height="300" width="95%">
            <tr>
                <td valign="top" width="200" style="padding-left:20px;" id="treeContainer">
                    ...
                    <input id="hf_flag" name="hf_flag" type="hidden" />
                    <script src="../../../js/office/SystemManager/CategorySet.js" type="text/javascript"></script>
                    
                </td>
                <td valign="top">
                    <table cellpadding="2">
                        <tr><td></td><td class="Title"><span id="curAction" style="color:Black;font-weight:bold;">设备分类设置</span></td></tr>
                        <tr><td></td><td><br />
             <a href="#" id="img_new">
