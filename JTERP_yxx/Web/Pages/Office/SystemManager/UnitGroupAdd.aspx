...
<body>
    ...
    <div id="divAdd" style="border: solid 10px #898989; background: #fff; padding: 10px;
        ...
        <table width="99%" border="0" id="dg_Log" align="center" cellpadding="0" cellspacing="1"
            ...
            <tbody>
                <tr>
                    <td align="center"  class="td_list_fields" valign="middle" style="width: 5%">
                        选择<input type="checkbox" name="checkall" id="checkall" onclick="SelectAll()" value="checkbox" />
                    </td>
                    <td align="center"  class="td_list_fields" valign="middle" style="width: 10%">
                        序号
                    </td>
                    <td align="center"  class="td_list_fields" valign="middle" style="width: 20%">
                        计量单位名称<span class="redbold">*</span>
                    </td>
                    <td align="center"  class="td_list_fields" valign="middle" style="width: 20%">
                        换算比率<span class="redbold">*</span>
                    </td>
                    <td align="center"  class="td_list_fields" valign="middle" style="width: 45%">
                        备注
                    </td>
                </tr>
            </tbody>
        ...
        <tr>
            <td colspan="2">
                <table width="99%" border="0" align="center" cellpadding="0" cellspacing="1" id="pageDataList1"
                    ...
                    <tbody>
                        <tr>
                            <th height="20" width="80px" align="center" class="td_list_fields">
