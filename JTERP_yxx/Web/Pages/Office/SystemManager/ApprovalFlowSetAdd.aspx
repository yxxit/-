...
<body>
    ...
    <div>
        ...
        <table width="99%" border="0" cellpadding="2" cellspacing="1" bgcolor="#999999" id="Tb_01"
            ...
            <tr>
                <td  class="td_list_fields" align="right" width="13%">
                ...
                <td bgcolor="#FFFFFF" width="22%">
                    <input id="txt_FlowName" class="tdinput" name="txt_flowname" size="15" specialworkcheck="流程名称" style="width:120px"
                        type="text" />
                </td>
                <td  class="td_list_fields" align="right" width="13%">
                    部门名称
               ...
               <td align="right" class="style1">
                ...
                <td bgcolor="#FFFFFF" class="style3">
                    ...
                    <input id="txt_BillTypeName" class="tdinput" name="txt_BillTypeName" size="15" type="text"
                        runat="server" disabled="disabled" style="width:120px"  /><input id="txt_typeflag" type="hidden" />
                </td>
               <td align="right" class="style1">
                    启用状态
                </td>
            ...
            <tr>
               <td  height="20" align="right" class="td_list_fields">是否手机短信提醒
                </td>
