                        ...
                        <td bgcolor="#FFFFFF">
                            <table width="100%" border="0" cellpadding="2" cellspacing="1" bgcolor="#CCCCCC">
                                ...
                                <tr class="table-item">
                                    ...
                                    <td width="25%" bgcolor="#FFFFFF">
                                        <asp:DropDownList ID="ddlSourceType" CssClass="tddropdlist" runat="server">
                                            ...
                                            <asp:ListItem Value="23">拆装入库单</asp:ListItem>
                                            <asp:ListItem Value="24">拆装出库单</asp:ListItem>
                                        </asp:DropDownList>
                                    </td>
                                    <td class="td_list_fields" align="right" width="10%">
                                        单据编号
                                ...
                                <div style="display:none;">
                                    ...
                                    <td width="20%" bgcolor="#FFFFFF">
                                        <input id="txt_Specification" disabled="disabled" runat="server" class="tdinput" specialworkcheck="规格型号" 
                                            type="text" />
                                    </td>
                                    <td class="td_list_fields" align="right" width="10%">
                                        颜色
                                ...
                                <tr class="table-item">
                                    ...
                                    <td width="20%" bgcolor="#FFFFFF">
                                        <asp:TextBox ID="txt_Manufacturer"  disabled="disabled" specialworkcheck="厂家" runat="server" CssClass="tdinput"
                                    ...
                                    <td width="25%" bgcolor="#FFFFFF">
                                        <input type="text" id="txt_Size"  disabled="disabled" specialworkcheck="尺寸" name="txt_Size" class="tdinput"
                                    ...
                                    <td width="25%" bgcolor="#FFFFFF">
                                        <asp:TextBox ID="txt_FromAddr"   disabled="disabled" specialworkcheck="产地" runat="server" CssClass="tdinput"
                                ...
                                <tr class="table-item">
                                    ...
                                    <td width="20%" bgcolor="#FFFFFF">
                                        <input id="txt_BarCode"  disabled="disabled" specialworkcheck="条码" cols="20" maxlength="50" name="S1"
