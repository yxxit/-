<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StorageCheckSave.aspx.cs"
    Inherits="Pages_Office_StorageManager_StorageCheckSave" %>
                ...
                <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#999999">
                    <tr style="height:15px;" bgcolor="#FFFFFF">
                        ...
                        <td align="right">
                            ...
                            <span visible="false" runat="server" id="span_btn_save" style="float: left"></span> 
                    ...
                    <tr>
                        <td colspan="2">
                            ...
                            <table width="99%" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#999999"
                                ...
                                <tr class="table-item">
                                    <td height="20" align="right"  class="td_main_detail" width="10%">
                                ...
                                <tr class="table-item">
                                    <td height="20" align="right"  class="td_main_detail">
                                    ...
                                    <td height="20" class="tdColInput">
                                        <asp:DropDownList ID="ddlStorageID" runat="server"  CssClass="tddropdlist" Width="120px" onchange="clearDetail();">
                                        </asp:DropDownList>
                                    </td>
                                    <td height="20" align="right"  class="td_main_detail">
                                        盘点类型
                                    ...
                                    <td height="20" class="tdColInput">
                                        <asp:DropDownList ID="ddlCheckType" CssClass="tddropdlist" Width="120px" runat="server">
                                        </asp:DropDownList>
                                ...
                                <tr class="table-item">
                                    ...
                                    <td height="20" class="tdColInput" colspan="5">
                                        <asp:TextBox ID="tboxSummary" runat="server" MaxLength="250" TextMode="MultiLine"
                                            style="width:99%; height:40px" class="tdinput"></asp:TextBox>
                                    </td>
                                </tr>
                            </table>
                                    ...
                                    <tr class="table-item">
                                        <td height="28" bgcolor="#FFFFFF">
                                            <img src="../../../images/Button/Show_add.jpg" style="cursor: hand" onclick="getProdcutListCheck();"
                                                alt="添加" runat="server" id="btnAddDetailRow" visible="true" />
                                            <img src="../../../images/Button/Show_del.jpg" style="cursor: hand" id="imgDelReturnDetail"
                                                onclick="RemoveRow();" alt="删除" runat="server" visible="true" /><img src="../../../images/Button/btn_kckz.jpg"
                                                    style="cursor: hand;display:none;" onclick="ShowSnapshot();" alt="库存快照" />
                                            <img alt="条码扫描" src="../../../Images/Button/btn_tmsm.jpg" id="btnGetGoods" style="display:none;cursor: pointer"
                                                onclick="Showtmsm()" runat="server" visible="false" />
                                        </td>
                                    </tr>
                                </table>
                                   <div id="divDetail" style="width: 100%; background-color: #FFFFFF; overflow: scroll;">
                                  <div style="border:none; width:150%">
                                <table width="70%" border="0" id="tblCheck" 
                                    align="left" cellpadding="0" cellspacing="1" bgcolor="#999999">
                                    <tbody>
                                        <tr class="table-item">
                                            <td align="center"  class="td_main_detail" >
                                                选择<input type="checkbox" visible="false" name="checkall" id="chkDetail" onclick="selall();"
                                                    value="checkbox" />
                                            </td>
                                            <td height="20" align="center"  class="td_main_detail">
                                                序号
                                            </td>
                                            <td align="center"  class="td_main_detail" >
                                            ...
                                            <td  align="center"  class="td_main_detail" valign="middle">
                                                批次
                                            </td>
                                            <td align="center"  class="td_main_detail" >
                                                规格
                                            </td>
                                            <td align="center"  class="td_main_detail" valign="middle" style="display:none" id="baseuint">
                                                基本单位
                                            </td>
                                            <td align="center"  class="td_main_detail" valign="middle" style="display:none" id="basecount">
                                                基本数量
                                            </td>
                                            <td align="center"  class="td_main_detail" >
                                                单位
                                            ...
                                            <td align="center"  class="td_main_detail" ><%--差异量--%>
                                                差异量
                                            </td>
                                            <td align="center"  class="td_main_detail" >
                                                备注
                            ...
                            <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#999999">
                                <tr class="menutitle1" >
                                     <td height="20" class="td_list_title">
                                        <table width="100%" border="0" cellspacing="0" cellpadding="3">
                                            <tr  class="menutitle1"  onclick="oprItem('tblRemark','divRemark')" title="展开收起栏目" style="cursor: pointer">
                                                <td  align="left" valign="middle">
                                                    备注信息
                                                </td>
                                                <td align="right">
                            ...
                            <table width="99%" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#999999"
                                ...
                                <tr class="table-item">
                                    ...
                                    <td height="20" class="tdColInput" width="24%">
                                        <asp:DropDownList ID="ddlBillStatus" runat="server" CssClass="tddropdlist" Enabled="false">
