    ...
    <table width="95%" height="57" border="0" cellpadding="0" cellspacing="0" class="checktable" id="mainindex">
        ...
        <tr>
            <td colspan="2">
                ...
                <!--导入前格式等判断-->
                <table width="99%" border="0" align="center" cellpadding="0" id="Table1" style="display:none" cellspacing="0" bgcolor="#CCCCCC">
                    ...
                    <tr>
                        <td bgcolor="#FFFFFF" >
                            <table width="100%" border="0" cellpadding="2" cellspacing="1" style="display:none" bgcolor="#CCCCCC" class="table">
