<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddTableCells.aspx.cs" Inherits="Pages_Office_SupplyChain_AddTableCells" %>
...
<head id="Head1" runat="server">
   ...
   <%-- <link href="../../../js/JQuery/jquery.alerts-1.1/jquery.alerts.css" rel="stylesheet"  type="text/css" />--%>
    ...
    <script type="text/javascript" src="../../../js/office/SupplyChain/AddTableCells.js"></script>
</head>
<body>
                        ...
                        <td bgcolor="#ffffff" align="center" valign="bottom">
                            ...
                            <table width="99%" border="0" align="center" cellpadding="2" id="Tb_01">
                                ...
                                <td align="right" style="width:10%;">
                                    ...
                                    <td bgcolor="#FFFFFF" align="left" style="width:23%;">
                                ...
                                <td align="right" style="width:8%;">
                                    ...
                                    <td align="right" style="width:8%;">
                                     ...
                                     <td bgcolor="#FFFFFF" width="12%">
                                        <select id="PCustom1" runat="server" style="width: 99%">
                                        </select>
                                    </td>
                                    <td align="right" style="width:8%;">
                                        自定义项2
                                    ...
                                    <td bgcolor="#FFFFFF" width="14%">
                                     ...
                                     <td bgcolor="#FFFFFF" width="12%">
                                         <select id="PCustom2" runat="server" style="width: 99%">
                                        </select>
                                    </td>                                    
                                </tr>
                                <tr>
                                <td align="right">
                                    ...
                                    <td align="right">
                                     ...
                                     <td bgcolor="#FFFFFF">
                                         <select id="PCustom3" runat="server" style="width: 99%">
                                        </select>
                                    </td>
                                <td align="right">
                                        自定义项4
                                    ...
                                    <td bgcolor="#FFFFFF">
                                     ...
                                     <td bgcolor="#FFFFFF">
                                         <select id="PCustom4" runat="server" style="width: 99%">
                                        </select>
                                    </td>
                                    </tr>
                                <tr>
                                    ...
                                    <td bgcolor="#FFFFFF">
                                     ...
                                     <td bgcolor="#FFFFFF">
                                        <select id="PCustom5" runat="server" style="width: 99%">
                                        </select>
                                    </td>
                                    <td align="right">
                                        自定义项6
                                    ...
                                    <td align="right">
                                     ...
                                     <td bgcolor="#FFFFFF">
                                       <select id="PCustom6" runat="server" style="width: 99%">
                                        </select>
                                    </td>
                                </tr>
                                <tr>
                                <td align="right">
                                    ...
                                    <td bgcolor="#FFFFFF">
                                     ...
                                     <td bgcolor="#FFFFFF">
                                        <select id="PCustom7" runat="server" style="width: 99%">
                                        </select>
                                    </td>
                                    <td align="right">
                                        自定义项8 
                                    ...
                                    <td bgcolor="#FFFFFF">
                                     ...
                                     <td bgcolor="#FFFFFF">
                                        <select id="PCustom8" runat="server" style="width: 99%">
                                        </select>
                                    </td>
                                    </tr>   
                                <tr>
                                  <td align="right">
                                    ...
                                    <td bgcolor="#FFFFFF">
                                     ...
                                     <td bgcolor="#FFFFFF">
                                        <select id="PCustom9" runat="server" style="width: 99%">
                                        </select>
                                    </td>
                                 <td align="right">
                                        自定义项10
                                    ...
                                    <td bgcolor="#FFFFFF">
                                     ...
                                     <td bgcolor="#FFFFFF">
                                        <select id="PCustom10" runat="server" style="width: 99%">
                                        </select>
                                    </td>
                                    </tr>
