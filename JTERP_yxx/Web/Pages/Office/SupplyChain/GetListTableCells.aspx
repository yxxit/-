<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GetListTableCells.aspx.cs" Inherits="Pages_Office_SupplyChain_GetListTableCells" %>
                            ...
                            <table width="100%" border="0" cellpadding="2" cellspacing="1" bgcolor="#CCCCCC"
                                ...
                                <tr class="table-item">
                                 <td class="td_list_fields" align="right" width="10%">
                                    ...
                                    <td align="right" class="td_list_fields" width="10%" >
                                        单据类型
                                    </td>
        ...
        <tr>
            <td colspan="2">
                <table width="99%" border="0" align="center" cellpadding="0" cellspacing="1" id="pageDataList1"
                    ...
                    <tbody>
                        <tr>
                            <th height="20" align="center" class="td_list_fields" width="10%">
...
<script type="text/javascript" src="../../../js/office/SupplyChain/GetListTableCells.js"></script>
