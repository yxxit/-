        ...
        <tr>
            <td colspan="2" valign="top">
                ...
                <table width="99%" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#999999"
                    ...
                    <tr>
                        <td  class="td_list_fields" width="100" align="left">
                           单位简介  
                        </td>
                        <td class="tdColInput"  colspan="5" >
                            <textarea id="txt_CustNote" specialworkcheck="单位简介" class="tdinput" cols="20" name="S1" rows="3"  runat="server" style="width:90%;height:50px;"></textarea>
                        </td>
                    </tr>
                </table>
                <table width="99%" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#999999">
                ...
                <table width="99%" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#999999"
                    ...
                    <tr>
                        ...
                        <td height="20" class="tdColInput" width="23%" colspan="5">
                            <textarea id="txt_SellArea" specialworkcheck="经营范围" class="tdinput" cols="20" name="S2" rows="3" style="width:90%;height:50px;"
                ...
                <table width="99%" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#999999"
                    ...
                    <tr>
                        ...
                        <td class="tdColInput">
                            <asp:TextBox ID="txt_Remark" runat="server" Class="tdinput" Width="95%" MaxLength="200"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
