                                ...
                                <tr class="table-item">
                                    ...
                                    <td width="20%" bgcolor="#FFFFFF">
                                        <select id="CheckStatus" runat="server" name="SetPro3" width="139px">
                                            ...
                                            <option value="1" selected>已审</option>
                                        </select>
                                    </td>
                                    <td width="10%" height="20" class="td_list_fields" align="right">
                                        颜色
                         ...
                         <td height="20" class="td_list_title">
                            <table width="100%" border="0" cellspacing="0" cellpadding="3">
                                <tr>
                                    ...
                                    <td align="right">
                                        <div id='div1'>
                                            <img alt="" src="../../../images/Main/Close.jpg" style="cursor: pointer" 
onclick="oprItem('Tb_yy','div1')" /></div>
                                    </td>
                                </tr>
                            </table>
                        </td>
                     ...
                     <table width="99%" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#999999"  id="Tb_yy" style="display: block">
                         <%if (((XBase.Common.UserInfoUtil)XBase.Common.SessionUtil.Session["UserInfo"]).Version == "medicine")
                                      { %>
                            <tr>
                        <td height="20" align="right"  class="td_list_fields" width="10%">
                        ...
                        <td height="20" class="tdColInput" width="23%">
                                                                     ...
                                                                     <asp:TextBox ID="txt_FileNo" specialworkcheck="批准文号" MaxLength="50" runat="server" CssClass="tdinput" Width="51%"></asp:TextBox>
                        ...
                        <td height="20" class="tdColInput" width="23%">
                            <asp:TextBox ID="ValidityBegin" runat="server" onclick="WdatePicker({dateFmt:'yyyy-MM-dd',el:$dp.$('ValidityBegin')})" ReadOnly="true"  CssClass="tdinput" Width="35%"></asp:TextBox>至
                            <asp:TextBox ID="ValidityEnd" runat="server" onclick="WdatePicker({dateFmt:'yyyy-MM-dd',el:$dp.$('ValidityEnd')})" ReadOnly="true"  CssClass="tdinput" Width="35%"></asp:TextBox>
                            </td>
                        <td height="20" align="right"  class="td_list_fields" width="10%">
                            质量标准</td>
                        <td height="20" class="tdColInput" width="24%">
                            <asp:TextBox ID="Qualitystandard" runat="server" CssClass="tdinput" Width="120px"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td height="20" align="right"  class="td_list_fields" width="10%">
                        ...
                        <td height="20" class="tdColInput" width="23%">
                            ...
                            <asp:TextBox ID="MedFileDateBegin" runat="server" onclick="WdatePicker({dateFmt:'yyyy-MM-dd',el:$dp.$('MedFileDateBegin')})" ReadOnly="true"  CssClass="tdinput" Width="35%"></asp:TextBox>至
                            <asp:TextBox ID="MedFileDateEnd" runat="server" onclick="WdatePicker({dateFmt:'yyyy-MM-dd',el:$dp.$('MedFileDateEnd')})" ReadOnly="true"  CssClass="tdinput" Width="35%"></asp:TextBox>
                        </td>
                        <td height="20" align="right"  class="td_list_fields" width="10%">
                            药品检验报告编号
                        </td>
                        <td height="20" class="tdColInput" width="23%" >
                            <asp:TextBox ID="MedCheckNo" runat="server"   CssClass="tdinput" Width="77%"></asp:TextBox>
                        </td>
                         <td height="20" align="right"  class="td_list_fields" width="10%">
                            药品检验报告日期</td>
                        <td height="20" class="tdColInput" width="24%">                          
                            <asp:TextBox ID="MedCheckDateBegin" runat="server" onclick="WdatePicker({dateFmt:'yyyy-MM-dd',el:$dp.$('MedCheckDateBegin')})" ReadOnly="true"  CssClass="tdinput" Width="35%"></asp:TextBox>至
                            <asp:TextBox ID="MedCheckDateEnd" runat="server" onclick="WdatePicker({dateFmt:'yyyy-MM-dd',el:$dp.$('MedCheckDateEnd')})" ReadOnly="true"  CssClass="tdinput" Width="35%"></asp:TextBox>
                                    </td>
                    </tr>     
                              <%
                                        } %>
                      <tr>
                                    <td colspan="6" align="center" bgcolor="#FFFFFF">
                                        ...
                                        <img alt="检索" src="../../../images/Button/Bottom_btn_search.jpg" style='cursor: 
hand;'
                ...
                <table width="99%" border="0" align="center" cellpadding="0" cellspacing="1" id="pageDataList1"
                    ...
                    <tbody>
                        <tr>
                            ...
                            <th align="center" class="td_list_fields" id="ThShow" style="display: none">
