<%@ WebHandler Language="C#" Class="ReportSendInfo" %>
...
public class ReportSendInfo : BaseHandler
{
    ...
    private void SendBatSm(string idlist, string content)
    {
        ...
        //    return;
        //}
        //XBase.Common.SMSender.SendBatch(phoneList, content);
        //OutputResult(true, "发送成功");
    }
    ...
    {
        DataTable users = new  GetUserDepList().GetUserInfo(UserInfo.CompanyCD);
        StringBuilder sb = new StringBuilder();
        sb.Append("[");
        foreach (DataRow row in users.Rows)
        {
            ...
            sb.Append(",value:\"" + row["UserID"].ToString() + "\"");
            sb.Append(",SubNodes:[]}");
        }
        sb.Append("]");
