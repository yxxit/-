...
public class TalkInfo : IHttpHandler, System.Web.SessionState.IRequiresSessionState
{
    ...
    public void ProcessRequest (HttpContext context) {
                ...
                string orderBy = (!string.IsNullOrEmpty(orderString)) ? orderString.Substring(0, orderString.Length - 2) : "ModifiedDate";//"CreatedDate";//要排序的字段，如果为空，默认为"linkmanname"
                ...
                CustTalkM.Linker = context.Request.Form["UserExecutor"].ToString().Trim();//执行人
                CustTalkM.Creator = Convert.ToInt32(context.Request.Form["UserCreateor"].ToString().Trim());//创建人
                string IsOverTime = context.Request.Form["IsOverTime"].ToString().Trim();//判断是否超时
                ...
                DataTable dt = TalkBus.GetTalkInfoBycondition(Manager,CustName, CustTalkM, TalkBegin, TalkEnd, pageIndex, pageCount, ord, IsOverTime, ref totalCount);
