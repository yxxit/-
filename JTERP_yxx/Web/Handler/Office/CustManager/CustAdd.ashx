...
public class CustAdd : IHttpHandler, System.Web.SessionState.IRequiresSessionState
{
    ...
    public void ProcessRequest (HttpContext context) {
        ...
        //新添加 zhuang
        //string Corptype = context.Request.Params["Corptype"].ToString().Trim();//企业类型
        //string Usedata = context.Request.Params["Usedata"].ToString().Trim();
        //string Certidata = context.Request.Params["Certidata"].ToString().Trim();
        //string Wardata = context.Request.Params["Wardata"].ToString().Trim();
        //string Powerdata = context.Request.Params["Powerdata"].ToString().Trim();
        //string Gmspdata = context.Request.Params["Gmspdata"].ToString().Trim();
        string Pagestatus = context.Request.Params["Pagestatus"].ToString().Trim();//页面状态
        //string Category = context.Request.Params["Category"].ToString().Trim();//所属分类
        ...
        string BillUnit = context.Request.Params["BillUnit"].ToString().Trim(); //20140324新增开票单位(结算单位)
        ...
        //string strStopDate = context.Request.Params["StopDate"].ToString().Trim();
        ...
        {
            CustInfoM.AnnFileName = strAnnFileName;/*附件名称*/
            CustInfoM.AnnAddr = strAnnAddr;         /*附件地址*/
        }
        if (!string.IsNullOrEmpty(strUpDateTime))
        {
            CustInfoM.AnnRemark = strAnnRemark;/*附件说明*/
            CustInfoM.UpDateTime = strUpDateTime;         /*上传时间*/
        }
        ...
        CustInfoM.BillUnit = BillUnit; //开票单位(结算单位)
        ...
        //}
        //if (strStopDate != "" || strStopDate != string.Empty)
        //{
        //    CustInfoM.StopDate = Convert.ToDateTime(strStopDate);
        //}
        ...
        //2012年7月 zhung 修改
        //CustInfoM.Corptype = Convert.ToInt32(Corptype);  //企业类型
        //CustInfoM.Corptype = Corptype;  //企业类型
        //if (Usedata != "" || Usedata != string.Empty)//有效期
        //{
        //    CustInfoM.Usedata = Convert.ToDateTime(Usedata);
        //}
        //if (Certidata != "" || Certidata != string.Empty)
        //{
        //    CustInfoM.Certidata = Convert.ToDateTime(Certidata);

        //}
        //if (Wardata != "" || Wardata != string.Empty)
        //{
        //    CustInfoM.Wardata = Convert.ToDateTime(Wardata);
        //}
        //if (Powerdata != "" || Powerdata != string.Empty)
        //    {
        //        CustInfoM.Powerdata = Convert.ToDateTime(Powerdata);
        //    }
        CustInfoM.Pagestatus = Pagestatus;  //页面状态
        //if (Gmspdata != "" || Gmspdata != string.Empty)
        //{
        //    CustInfoM.Gmspdata = Convert.ToDateTime(Gmspdata);
        //}
        //CustInfoM.Category = Category;//所属分类
