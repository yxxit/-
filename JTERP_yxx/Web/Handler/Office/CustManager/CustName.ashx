...
public class CustName : IHttpHandler, System.Web.SessionState.IRequiresSessionState
{
    ...
    public void ProcessRequest (HttpContext context)
    {
         if (context.Request.RequestType == "POST")
        {
           //设置行为参数
            ...
            DataTable CustDt = CustInfoBus.GetCustName(CustInfoM, CanUserID, CompanyCD);          
            ...
            var dsLinq =
                ...
                (from x in dsXML.Descendants("Data")
                 ...
                 select new DataSourceModel()
                 {
                     ...
                     ReceiveAddress = x.Element("ReceiveAddress").Value,                     
                     Gmspdata = x.Element("Gmspdata").Value,
                     LinkMan = x.Element("cCusPerson").Value,
                     Phone = x.Element("cCusHand").Value,
                     AreaID = x.Element("AreaID").Value,
                     BillUnit = x.Element("billunit").Value
                   // 
                 }):
                (from x in dsXML.Descendants("Data")
    ...
    public class DataSourceModel
    {
        ...
        //---20121226 添加 Gmspdata字段-----//
        public string Gmspdata { get; set; }
