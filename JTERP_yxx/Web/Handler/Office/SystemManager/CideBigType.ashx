...
public class CideBigType : BaseHandler, System.Web.SessionState.IRequiresSessionState
{
    ...
    private void AddItem()
    {
        ...
        try
        {
           isAlready = PrimekeyVerifyBus.CheckCodeUniq(sArray[1]
                                  , "CodeName", CodeName, "TypeFlag='" + TypeFlag + "' and SupperID='" + model.SupperID + "'");
        }
        catch (Exception ex)
        {
             isAlready = PrimekeyVerifyBus.CheckCodeUniq(sArray[1]
                                  , "CodeName", CodeName, "BigType='" + TypeFlag + "' and SupperID='" + model.SupperID + "'");
        }
        //存在的场合
        if (!isAlready)
        {
            
            OutputResult(false, "分类已经存在！");
            return;
        }
    ...
    private void EditItem()
    {
        ...
        {
            isAlready = PrimekeyVerifyBus.CheckCodeUniq(sArray[1]
                                   , "CodeName", model.CodeName, "TypeFlag='" + model.BigType + "' and SupperID='" + model.SupperID + "' and ID<>'" + model.ID + "'");
        }
        catch (Exception ex)
        {
            isAlready = PrimekeyVerifyBus.CheckCodeUniq(sArray[1]
                                 , "CodeName", model.CodeName, "BigType='" + model.BigType + "' and SupperID='" + model.SupperID + "' and ID<>'" + model.ID + "'");
        }
        //存在的场合
        if (!isAlready)
        {
