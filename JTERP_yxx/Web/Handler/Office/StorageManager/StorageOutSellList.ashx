    ...
    public void ProcessRequest(HttpContext context)
    {
        if (context.Request.RequestType == "POST")
        {
            ...
            else
            {
                ...
                //物品扩展属性条件
                string EFIndexP = context.Request.QueryString["EFIndexP"].ToString();
                string EFDescP = context.Request.QueryString["EFDescP"].ToString();
                ...
                string time1 = context.Request.QueryString["time1"].ToString();
                string time2 = context.Request.QueryString["time2"].ToString();
                string prodid = context.Request.QueryString["prodid"].ToString();
                string ord = orderBy + " " + order;
                int TotalCount = 0;
                DataTable dt = StorageOutSellBus.GetStorageOutSellTableBycondition(model, OutDateStart, OutDateEnd, SendNo,EFIndex,EFDesc, pageIndex, pageCount, ord, ref TotalCount,time1,time2,prodid,EFIndexP,EFDescP);
