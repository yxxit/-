        ...
        else
        {
            ...
            else
            {
                if (ID > 0)
                {
                    ...
                    string Pnumber1 = "";
                    string Pnumberid1 = "";
                    string AbrasionResist1 = "";
                    string AbrasionResistid1 = "";
                    string BalancePaper1 = "";
                    string BalancePaperid1 = "";
                    string BaseMaterial1 = "";
                    string BaseMaterialid1 = "";
                    string SurfaceTreatment1 ="";
                    if (((UserInfoUtil)SessionUtil.Session["UserInfo"]).Version == "floor")
                    {
                        Pnumber1 = context.Request.Params["Pnumber"].ToString().Trim();
                        Pnumberid1 = context.Request.Params["Pnumberid"].ToString().Trim();
                        AbrasionResist1 = context.Request.Params["AbrasionResist"].ToString().Trim();
                        AbrasionResistid1 = context.Request.Params["AbrasionResistid"].ToString().Trim();
                        BalancePaper1 = context.Request.Params["BalancePaper"].ToString().Trim();
                        BalancePaperid1 = context.Request.Params["BalancePaperid"].ToString().Trim();
                        BaseMaterial1 = context.Request.Params["BaseMaterial"].ToString().Trim();
                        BaseMaterialid1 = context.Request.Params["BaseMaterialid"].ToString().Trim();
                        SurfaceTreatment1 = context.Request.Params["SurfaceTreatment"].ToString().Trim();
                    }
                    StorageInOtherModel model = new StorageInOtherModel();
                    model.CompanyCD = companyCD;
                    model.ID = ID.ToString();
                    ...
                    string[] Pnumber =Pnumber1.Split(',');
                    string[] Pnumberid =Pnumberid1.Split(',');
                    string[] AbrasionResistid =AbrasionResistid1.Split(',');
                    string[] AbrasionResist =AbrasionResist1.Split(',');
                    string[] BalancePaperid =BalancePaperid1.Split(',');
                    string[] BalancePaper =BalancePaper1.Split(',');
                    string[] BaseMaterialid =BaseMaterialid1.Split(',');
                    string[] BaseMaterial =BaseMaterial1.Split(',');
                    string[] SurfaceTreatment =SurfaceTreatment1.Split(',');
                    ...
                    if (productID.Length >= 1)
                    {
                        ...
                        for (int i = 0; i < productID.Length; i++)
                        {
                            ...
                            if (((UserInfoUtil)SessionUtil.Session["UserInfo"]).Version == "floor")
                            {
                                model1.Pnumber = Pnumber[i];
                                model1.Pnumberid = Pnumberid[i];
                                model1.AbrasionResist = AbrasionResist[i];
                                model1.AbrasionResistid = AbrasionResistid[i];
                                model1.BalancePaper = BalancePaper[i];
                                model1.BalancePaperid = BalancePaperid[i];
                                model1.BaseMaterial = BaseMaterial[i];
                                model1.BaseMaterialid = BaseMaterialid[i];
                                model1.SurfaceTreatment = SurfaceTreatment[i];
                            }
                    ...
                    if (StorageInOtherBus.UpdateStorageInOther(model, modellist, ht, strCustomdetail))
                    {
                        ...
                        //{
                            ...
                            if (productID.Length >= 1)
                            {
                                ...
                                for (int i = 0; i < productID.Length; i++)
                                {
                                    ...
                                    if (((UserInfoUtil)SessionUtil.Session["UserInfo"]).Version == "floor")
                                    {
                                        model2.Pnumber = Pnumber[i];
                                        model2.Pnumberid = Pnumberid[i];
                                        model2.AbrasionResist = AbrasionResist[i];
                                        model2.AbrasionResistid = AbrasionResistid[i];
                                        model2.BalancePaper = BalancePaper[i];
                                        model2.BalancePaperid = BalancePaperid[i];
                                        model2.BaseMaterial = BaseMaterial[i];
                                        model2.BaseMaterialid = BaseMaterialid[i];
                                        model2.SurfaceTreatment = SurfaceTreatment[i];
                                    }
                                    if (IsMoreUnit == "true")
                                    {
                            ...
                            strCustomdetail[0] = context.Request.Params["RowNum"].ToString();
                            strCustomdetail[1] = context.Request.Params["strCustom"].ToString();
                            if (StorageInOtherBus.InsertStorageInOther(model, modellist, ht, out IndexIDentity, strCustomdetail))
                            {
