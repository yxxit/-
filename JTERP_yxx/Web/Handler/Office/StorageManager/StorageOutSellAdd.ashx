        ...
        else
        {
            ...
            if (context.Request.Params["Act"].ToString().Trim() == "Confirm")
            {
                if (ID > 0)
                {
                    ...
                    {
                        if(StorageOutSellBus.ISBigUseCountWhenCant(model) != "" || StorageOutSellBus.ISBigUseCountWhenCant(model) != string.Empty)
                        {
                    ...
                    {
                        if (!((UserInfoUtil)SessionUtil.Session["UserInfo"]).IsStorageZero)
                        {
            ...
            else
            {
                if (ID > 0)
                {
                    ...
                    if (StorageOutSellBus.UpdateStorageOutSell(model,ht, modellist,strCustomdetail))
                    {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        strCustomdetail[0] = context.Request.Params["RowNum"].ToString();
                        strCustomdetail[1] = context.Request.Params["strCustom"].ToString();
                        if (StorageOutSellBus.InsertStorageOutSell(model, modellist, ht, out IndexIDentity, strCustomdetail))
                        {
