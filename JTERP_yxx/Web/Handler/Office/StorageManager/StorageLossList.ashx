...
public class StorageLossList : IHttpHandler, System.Web.SessionState.IRequiresSessionState
{
    ...
    public void ProcessRequest(HttpContext context)
    {
        if (context.Request.RequestType == "POST")
        {
            ...
            string productname = context.Request.QueryString["ProductName"].ToString();
            string ord = orderBy + " " + order;
            int TotalCount = 0;
            DataTable dt = StorageLossBus.GetStorageLossTableBycondition(model, LossDateStart, LossDateEnd, TotalPriceStart, TotalPriceEnd, FlowStatus, EFIndex, EFDesc, pageIndex, pageCount, ord, ref TotalCount, productname);
