...
public class StorageReturnList :IHttpHandler,System.Web.SessionState.IRequiresSessionState
{
    ...
    protected void GetList(HttpContext context)
    {
        ...
        string productname = FormatRequest(context,"ProductName", false);
        ...
        DataTable dt = XBase.Business.Office.StorageManager.StorageReturnBus.GetStorageReturnList(EFIndex,EFDesc,htParas, userinfo.CompanyCD, pageCount, pageIndex, orderBy, ref TotalCount,productname);
        context.Response.ContentType = "text/plain";
