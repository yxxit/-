        ...
        else
        {
            ...
            else
            {
                if (ID > 0)
                {
                    ...
                    if (StorageInPurchaseBus.UpdateStorageInPurchase(model, modellist, ht, strCustomdetail))
                    {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        //{
                            ...
                            if (StorageInPurchaseBus.InsertStorageInPurchase(model, modellist, ht, out IndexIDentity, strCustomdetail))
                            {
