    ...
    public void ProcessRequest(HttpContext context)
    {
        ...
        if (context.Request.RequestType == "POST")
        {
            try
            {
                ...
                string ProductName = context.Request.Params["ProductName"].ToString();
                ...
                DataTable dt = StorageAdjustBus.GetAllAdjust(model, EFIndex, EFDesc, BeginTime, EndTime, FlowStatus, ref TotalCount,ProductName);
