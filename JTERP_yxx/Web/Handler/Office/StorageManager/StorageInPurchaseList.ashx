    ...
    public void ProcessRequest(HttpContext context)
    {
        ...
        if (context.Request.RequestType == "POST")
        {
            ...
            else
            {
                ...
                model.EFIndexP = context.Request.QueryString["EFIndexP"].ToString();
                model.EFDescP = context.Request.QueryString["EFDescP"].ToString();
                ...
                int TotalCount = 0;
                DataTable dt = StorageInPurchaseBus.GetStorageInPurchaseTableBycondition(BatchNo,model, EnterDateStart, EnterDateEnd, FromBillNo, StorageID, pageIndex, pageCount, ord, ref TotalCount,time1,time2,prodid);
