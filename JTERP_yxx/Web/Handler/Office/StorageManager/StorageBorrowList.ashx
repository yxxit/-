...
public class StorageBorrowList : SubBaseHandler
{
    ...
    public void  GetBorrowList()
    {
        ...
        string productname = GetRequestForm("ProductName", false);
      ...
      //  OutputDataTable(
        ...
        DataTable dt = XBase.Business.Office.StorageManager.StorageBorrowBus.GetStorageList(EFIndex, EFDesc,pageIndex, pageCount, orderBy, ref TotalCount, borrow, start, end, SubmitStatus,productname);
