        ...
        else
        {
            ...
            if (context.Request.Params["Act"].ToString().Trim() == "Confirm")
            {
                if (ID > 0)
                {
                    ...
                    if (!((UserInfoUtil)SessionUtil.Session["UserInfo"]).IsStorageOver)
                    {
            ...
            else
            {
                if (ID > 0)
                {
                    ...
                    string PieceCount1 = context.Request.Params["PieceCount"].ToString().Trim();
                    string TotalNumber1 = context.Request.Params["TotalNumber"].ToString().Trim();
                    string PieceNum1 = context.Request.Params["PieceNum"].ToString().Trim();
                    string pakeid1 = context.Request.Params["pakeid"].ToString().Trim();
                    string NoPassAnswer1 = context.Request.Params["NoPassAnswer"].ToString().Trim();
                    string NoPassNum1 = context.Request.Params["NoPassNum"].ToString().Trim();
                    ...
                    model.ModifiedUserID = LoginUserID;
                    model.Userids = context.Request.Params["userids"].ToString().Trim();
                    model.Usernames = context.Request.Params["usernames"].ToString().Trim();
                    ...
                    string[] PieceCount = PieceCount1.Split(',');
                    string[] TotalNumber = TotalNumber1.Split(',');
                    string[] PieceNum = PieceNum1.Split(',');
                    string[] pakeid = pakeid1.Split(',');
                    string[] NoPassNum = NoPassNum1.Split(',');
                    string[] NoPassAnswer = NoPassAnswer1.Split(',');
                    string NewBratchNo = "";
                    if (productID.Length >= 1)
                    {
                        ...
                        for (int i = 0; i < productID.Length; i++)
                        {
                            ...
                            {
                                model1.PieceCount = PieceCount[i];
                                model1.TotalNumber = TotalNumber[i];
                                model1.PieceNum = PieceNum[i];
                                model1.pakeid = pakeid[i];
                                model1.NoPassNum = NoPassNum[i];
                                model1.NoPassAnswer = NoPassAnswer[i];
                            }
                            if (IsMoreUnit == "true")
                            {
                    ...
                    if (StorageInProcessBus.UpdateStorageInProcess(model, modellist, ht, strCustomdetail))
                    {
                    ...
                    else
                    {
                       ...
                       // }                        
                        ...
                        //{
                            ...
                            if (StorageInProcessBus.InsertStorageInProcess(model, modellist, ht, out IndexIDentity, strCustomdetail))
                            {
