    ...
    public void ProcessRequest(HttpContext context)
    {
        if (context.Request.RequestType == "POST")
        {
            ...
            else
            {
                ...
                DataTable dt = StorageOutRedBus.GetStorageOutRedTableBycondition(model, OutDateStart, OutDateEnd, EFIndex, EFDesc, pageIndex, pageCount, ord, ref TotalCount,prodid);
