    ...
    public void ProcessRequest(HttpContext context)
    {
        if (context.Request.RequestType == "POST")
        {
            ...
            else
            {
                ...
                string proname = context.Request.QueryString["proname"].ToString().Trim();
                string ord = orderBy + " " + order;
                int TotalCount = 0;
                DataTable dt = StorageInProcessBus.GetStorageInProcessTableBycondition(BatchNo,model, EnterDateStart, EnterDateEnd, StorageID, FromBillNo, pageIndex, pageCount, ord, ref TotalCount,proname,time1,time2);
