...
public class StorageOutOtherList : IHttpHandler, System.Web.SessionState.IRequiresSessionState
{
    ...
    public void ProcessRequest(HttpContext context)
    {
        if (context.Request.RequestType == "POST")
        {
            ...
            model.OtherCorpName = context.Request.Params["OtherCorpName"];//20121123 添加往来单位
            ...
            int TotalCount = 0;
            DataTable dt = StorageOutOtherBus.GetStorageOutOtherTableBycondition(model, OutDateStart, OutDateEnd,EFIndex,EFDesc, pageIndex, pageCount, ord, ref TotalCount,time1,time2,prodid);
