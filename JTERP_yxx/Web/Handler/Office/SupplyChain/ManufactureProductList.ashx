<%@ WebHandler Language="C#" Class="ManufactureProductList" %>
...
public class ManufactureProductList : IHttpHandler, System.Web.SessionState.IRequiresSessionState
{
    ...
    public void ProcessRequest(HttpContext context)
    {
        if (context.Request.RequestType == "POST")
        {
            ...
            try
            {
                ...
                DataTable dt = ProductInfoBus.GetProductInfoTableBycondition3(model, QueryID, EFIndex, EFDesc, pageIndex, pageCount, ord, ref totalCount);
