<%@ WebHandler Language="C#" Class="ManufactureProduct" %>
...
public class ManufactureProduct : IHttpHandler, System.Web.SessionState.IRequiresSessionState
{
    ...
    public void ProcessRequest (HttpContext context) {
        if (context.Request.RequestType == "POST")
        {
            ...
            try
            {
                ...
                DataTable dt = ProductInfoBus.GetProductInfoTableBycondition4(model, QueryID, EFIndex, EFDesc, pageIndex, pageCount, ord, ref totalCount);
