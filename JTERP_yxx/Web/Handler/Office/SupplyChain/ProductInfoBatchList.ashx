<%@ WebHandler Language="C#" Class="ProductInfoBatchList" %>
...
public class ProductInfoBatchList : IHttpHandler, System.Web.SessionState.IRequiresSessionState
{
    public void ProcessRequest(HttpContext context)
    {
        if (context.Request.RequestType == "POST")
        {
            ...
            try
            {
                ...
                DataTable dt = ProductInfoBus.GetProductInfoBatchTableBycondition(model, QueryID, EFIndex, EFDesc, pageIndex, pageCount, ord, ref totalCount);
