<%@ WebHandler Language="C#" Class="PurchaseProduct" %>
...
public class PurchaseProduct : IHttpHandler, System.Web.SessionState.IRequiresSessionState
{
    public void ProcessRequest(HttpContext context)
    {
        if (context.Request.RequestType == "POST")
        {
            ...
            try
            {
                ...
                DataTable dt = ProductInfoBus.PurchaseSearchProduct(model, pageIndex, pageCount, ord, ref totalCount);
