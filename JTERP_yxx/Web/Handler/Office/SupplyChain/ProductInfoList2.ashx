<%@ WebHandler Language="C#" Class="ProductInfoList2" %>
...
public class ProductInfoList2 : IHttpHandler, System.Web.SessionState.IRequiresSessionState
{
    ...
    public void ProcessRequest (HttpContext context) {
        if (context.Request.RequestType == "POST")
        {
            ...
            try
            {
                ...
                DataTable dt = ProductInfoBus.GetProductInfoTableBycondition2(model, QueryID, EFIndex, EFDesc, pageIndex, pageCount, ord, ref totalCount);
