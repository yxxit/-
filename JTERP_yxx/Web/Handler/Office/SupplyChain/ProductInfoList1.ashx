<%@ WebHandler Language="C#" Class="ProductInfoList1" %>
...
public class ProductInfoList1 : IHttpHandler, System.Web.SessionState.IRequiresSessionState
{
    ...
    public void ProcessRequest(HttpContext context)
    {
        if (context.Request.RequestType == "POST")
        {
            ...
            try
            {
                ...
                if (!string.IsNullOrEmpty(context.Request.Form["bigtype"].ToString().Trim()))
                {
                    model.BigType= context.Request.Form["bigtype"].ToString();
                }
                ...
                string gettype = "";
                if (context.Request.Form["gettype"] != null)
                {
                    gettype = context.Request.Form["gettype"].ToString().Trim();
                }
                model.CompanyCD = companyCD;
                DataTable dt = ProductInfoBus.GetProductInfoTableBycondition1(model, QueryID, EFIndex, EFDesc, pageIndex, pageCount, ord, ref totalCount,gettype);
