...
public class InputPersonalRoyalty : IHttpHandler, System.Web.SessionState.IRequiresSessionState
{
    ...
    private string CreateListTitle(DataTable dtInsuSocial)
    {
        ...
        table.AppendLine("	<tr>                                                                  ");
        table.AppendLine("		<td  class='td_list_fields' style='width:5%'>                                 ");
        table.AppendLine("		   选择<input type='checkbox' id='chkAll' onclick='SelectAll();'/>");
        table.AppendLine("		</td>                                                             ");
        table.AppendLine("		<td  class='td_list_fields' style='width:12%'>员工姓名</td>             ");
        table.AppendLine("		<td  class='td_list_fields' style='width:12%'>订单编号</td>             ");
        table.AppendLine("		<td  class='td_list_fields' style='width:10%'>币种</td>             ");
        table.AppendLine("		<td  class='td_list_fields' style='width:10%'>汇率</td>             ");
        table.AppendLine("		<td  class='td_list_fields' style='width:12%'>含税金额合计</td>             ");
        table.AppendLine("		<td  class='td_list_fields' style='width:13%'>客户名称</td>             ");
        table.AppendLine("		<td  class='td_list_fields' style='width:8%'>提成率</td>             ");
        table.AppendLine("		<td  class='td_list_fields' style='width:8%'>订单日期</td>             ");
