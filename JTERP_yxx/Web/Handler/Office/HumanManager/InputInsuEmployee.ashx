...
public class InputInsuEmployee : IHttpHandler, System.Web.SessionState.IRequiresSessionState
{
    ...
    private string CreateListTitle(DataTable dtInsuSocial)
    {
        ...
        table.AppendLine("	<tr>");
        table.AppendLine("    <td  class='td_list_fields' rowspan='2' style='font-weight: bolder;'  width='7%'>员工编号</td>");
        ...
        if (insuCount > 0)
        {
            ...
            for (int i = 0; i < insuCount; i++)
            {
                ...
                sbInputInsu.AppendLine("<td  class='td_list_fields' style='font-weight: bolder;'> 参保时间</td>");
                sbInputInsu.AppendLine("<td  class='td_list_fields' style='font-weight: bolder;'>参保地</td>");
            }
        }
