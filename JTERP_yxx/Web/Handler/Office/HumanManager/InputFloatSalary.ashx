...
public class InputFloatSalary : IHttpHandler, System.Web.SessionState.IRequiresSessionState
{
    ...
    private string CreateTableTitle(string flag)
    {
        ...
        sbTitle.AppendLine("    <td  class='td_list_fields' style='font-weight: bolder;'>选择<input type=\"checkbox\" id=\"chkCheckAll\" name=\"chkCheckAll\" onclick=\"AllSelect('chkCheckAll', 'chkSelect')\"></td>");
        sbTitle.AppendLine("    <td  class='td_list_fields' style='font-weight: bolder;'>员工编号</td>");
        sbTitle.AppendLine("    <td  class='td_list_fields' style='font-weight: bolder;'>员工姓名</td>");
        sbTitle.AppendLine("    <td  class='td_list_fields' style='font-weight: bolder;'>所在部门</td>");
        sbTitle.AppendLine("    <td  class='td_list_fields' style='font-weight: bolder;'>所在岗位</td>");
        sbTitle.AppendLine("    <td  class='td_list_fields' style='font-weight: bolder;'>岗位职等</td>");

        //计件工资
        if ("1".Equals(flag))
        {
            sbTitle.AppendLine("    <td  class='td_list_fields' style='font-weight: bolder;'>计件项目</td>");
            sbTitle.AppendLine("    <td  class='td_list_fields' style='font-weight: bolder;'>单价</td>");
            sbTitle.AppendLine("    <td  class='td_list_fields' style='font-weight: bolder;'> <span style=\"color:Red\">*</span>数量</td>");
        }
        //计时工资
        else if ("2".Equals(flag))
        {
            sbTitle.AppendLine("    <td  class='td_list_fields' style='font-weight: bolder;'>计时项目</td>");
            sbTitle.AppendLine("    <td  class='td_list_fields' style='font-weight: bolder;'>单价</td>");
            sbTitle.AppendLine("    <td  class='td_list_fields' style='font-weight: bolder;'><span style=\"color:Red\">*</span>时长(小时)</td>");
        }
        //提成工资
        else if ("3".Equals(flag))
        {
            sbTitle.AppendLine("    <td  class='td_list_fields' style='font-weight: bolder;'>提成项目</td>");
            sbTitle.AppendLine("    <td  class='td_list_fields' style='font-weight: bolder;'>提成率</td>");
            sbTitle.AppendLine("    <td  class='td_list_fields' style='font-weight: bolder;'><span style=\"color:Red\">*</span>业务量</td>");
            sbTitle.AppendLine("    <td  class='td_list_fields' style='font-weight: bolder;'>来源</td>");
        }

        sbTitle.AppendLine("    <td  class='td_list_fields' style='font-weight: bolder;'>金额</td>");
        sbTitle.AppendLine("    <td  class='td_list_fields' style='font-weight: bolder;'>日期</td>");
        sbTitle.AppendLine("    <td  class='td_list_fields' style='font-weight: bolder;'>小计</td>");
        sbTitle.AppendLine("    <td  class='td_list_fields' style='font-weight: bolder;'>合计</td>");
        sbTitle.AppendLine("</tr>");
        //返回
