...
public class SalaryPersonalRoyaltySet  : IHttpHandler, System.Web.SessionState.IRequiresSessionState
{
    ...
    private string CreateSalaryListTable()
    {
        ...
        table.AppendLine("		</td>                                                             ");
        //table.AppendLine("		<td  class='td_list_fields' style='width:15%'>员工编号</td>             ");
        table.AppendLine("		<td  class='td_list_fields' style='width:10%'><span style=\"color:Red\">*</span>员工姓名</td>             ");
        table.AppendLine("		<td  class='td_list_fields' style='width:10%'><span style=\"color:Red\">*</span>业绩上限</td>             ");
        table.AppendLine("		<td  class='td_list_fields' style='width:8%'><span style=\"color:Red\">*</span>业绩下限</td>             ");
        table.AppendLine("		<td  class='td_list_fields' style='width:8%'>提成率(%)</td>             ");
        table.AppendLine("		<td  class='td_list_fields' style='width:15%'><span style=\"color:Red\">*</span>是否区分客户提成</td>             ");
        //table.AppendLine("		<td  class='td_list_fields' style='width:15%'>客户编号</td>             ");
        table.AppendLine("		<td  class='td_list_fields' style='width:10%'><span style=\"color:Red\">*</span>客户名称</td>             ");
        table.AppendLine("		<td  class='td_list_fields' style='width:14%'>新客户提成率(%)</td>             ");
        table.AppendLine("		<td  class='td_list_fields' style='width:14%'>老客户提成率(%)</td>             ");
        table.AppendLine("	</tr>                                                                 ");
        //返回表格语句
