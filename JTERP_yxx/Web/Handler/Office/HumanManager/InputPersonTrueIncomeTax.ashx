...
public class InputPersonTrueIncomeTax : IHttpHandler, System.Web.SessionState.IRequiresSessionState
{
    ...
    private string CreateListTitle(DataTable dtInsuSocial)
    {
        ...
        table.AppendLine("	<tr>");
        table.AppendLine("    <td  class='td_list_fields' rowspan='2' style='font-weight: bolder;'>员工编号</td>");
        table.AppendLine("    <td  class='td_list_fields' rowspan='2' style='font-weight: bolder;'>员工姓名</td>");
        table.AppendLine("    <td  class='td_list_fields' rowspan='2' style='font-weight: bolder;'>所在部门</td>");
        table.AppendLine("    <td  class='td_list_fields' rowspan='2' style='font-weight: bolder;'>所在岗位</td>");
        table.AppendLine("    <td  class='td_list_fields' rowspan='2' style='font-weight: bolder;'>岗位职等</td>");

        //变量定义
        StringBuilder sbInsuName = new StringBuilder();
        StringBuilder sbInputInsu = new StringBuilder();
        sbInputInsu.AppendLine("<td  class='td_list_fields'  style='font-weight: bolder;'> 缴税标准</td>");
        sbInputInsu.AppendLine("<td  class='td_list_fields'  style='font-weight: bolder;'>开始缴税时间</td>");
        sbInputInsu.AppendLine("<td  class='td_list_fields'  style='font-weight: bolder;'>税率(%)</td>");
        sbInputInsu.AppendLine("<td  class='td_list_fields'  style='font-weight: bolder;'>速算扣除数</td>");
        ////保险数据存在时
        //if (insuCount > 0)
        //{
        //    //遍历所有社会保险项，设置到表格中
        ...
        //        ////设置社会保险项名称
        //        //sbInsuName.AppendLine("<td colspan='3'  class='td_list_fields' style='font-weight: bolder;' colspan='3'>"
        ...
        //        //                + "</td>");
        //        sbInputInsu.AppendLine("<td  class='td_list_fields' style='font-weight: bolder;'>缴费基数</td>");
        //        sbInputInsu.AppendLine("<td  class='td_list_fields' style='font-weight: bolder;'>开始缴费时间</td>");
        //        sbInputInsu.AppendLine("<td  class='td_list_fields' style='font-weight: bolder;'>税率</td>");
        //        sbInputInsu.AppendLine("<td  class='td_list_fields' style='font-weight: bolder;'>税额</td>");
        //    }
        //}
