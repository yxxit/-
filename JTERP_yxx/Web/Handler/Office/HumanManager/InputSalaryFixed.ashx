...
public class InputSalaryFixed : IHttpHandler, System.Web.SessionState.IRequiresSessionState
{
    ...
    private string InitSalaryDetailInfo(DataTable dtSalaryInfo, DataTable dtEmplInfo, int userCount)
    {
        ...
        for (int i = 0; i < userCount; i++)
        {
            ...
            else
            {
                //工资合计
                sbSalaryInfo.AppendLine("<td class='tdColInputLeft'>"
                            + "<input type='text' disabled style='width:85%;' value='0.00' class='tdinput' id='txtTotalSalary_" + (i + 1).ToString() + "' /></td>");
            }
    ...
    private string CreateSalaryListTable(DataTable dtSalaryItem)
    {
        ...
        table.AppendLine("	<tr>");
        table.AppendLine("    <td  class='td_list_fields' style='font-weight: bolder;' background='../../../images/Main/Table_bg.jpg'>员工编号</td>");
        table.AppendLine("    <td  class='td_list_fields' style='font-weight: bolder;' background='../../../images/Main/Table_bg.jpg'>员工姓名</td>");
        table.AppendLine("    <td  class='td_list_fields' style='font-weight: bolder;' background='../../../images/Main/Table_bg.jpg'>所在部门</td>");
        table.AppendLine("    <td  class='td_list_fields' style='font-weight: bolder;' background='../../../images/Main/Table_bg.jpg'>所在岗位</td>");
        table.AppendLine("    <td  class='td_list_fields' style='font-weight: bolder;' background='../../../images/Main/Table_bg.jpg'>岗位职等</td>");
        ...
        if (dtSalaryItem != null && dtSalaryItem.Rows.Count > 0)
        {
            ...
            for (int i = 0; i < salaryCount; i++)
            {
                ...
                //设置工资项名称
                table.AppendLine("<td  class='td_list_fields' style='font-weight: bolder;' background='../../../images/Main/Table_bg.jpg'>"
        ...
        table.AppendLine("    <td  class='td_list_fields' style='font-weight: bolder;' background='../../../images/Main/Table_bg.jpg'>工资合计");
