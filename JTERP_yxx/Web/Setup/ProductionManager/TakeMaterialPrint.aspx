<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TakeMaterialPrint.aspx.cs"
    Inherits="Pages_PrinttingModel_ProductionManager_TakeMaterialPrint" ValidateRequest="false" %>
            ...
            <!-- End 第二明细 -->
             <table width="700px" border="0" cellpadding="0" cellspacing="1" align="center">
                <tr>
                    <td>
                         <br />
                         <table style="text-align: center; font-family: 宋体; font-size: 18px; font-weight: bold;"
                            width="640px">
                            <tr>
                                <td>
                                    <%=signOne %>
                                                    ...
                                                    <tr>
                                                        <td width="20%" align="left">
                                                            <input type="checkbox" name="ck1TakeNo" id="ck1TakeNo" value="TakeNo" /><input type="text"
                                                                id="txtTakeNo" value="单据编号：" size="20" readonly />
                                                        </td>
                                                        <td width="20%" align="left">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="checkbox" name="ck1TakerReal" id="ck1TakerReal" value="TakerReal" /><input
                                                                type="text" id="txtTakerReal" value="领料人：" size="20" readonly />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td width="20%" align="left">
                                                            <input type="checkbox" name="ck1HandoutReal" id="ck1HandoutReal" value="HandoutReal" /><input
                                                                type="text" id="txtHandoutReal" value="发料人：" size="20" readonly />
                                                        </td>
                                                        <td width="20%" align="left">
                                                            <input type="checkbox" name="ck1TakeDate" id="ck1TakeDate" value="TakeDate" /><input
                                                                type="text" id="txtTakeDate" value="发料时间：" size="20" readonly />
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td width="20%" align="left">
                                                            <input type="checkbox" name="ck1CountTotal" id="ck1CountTotal" value="CountTotal" /><input
                                                                type="text" id="txtCountTotal" value="领料数量合计：" size="20" readonly />
                                                        </td>
                                                        <td width="20%" align="left">
                                                        <input type="checkbox" name="ck1TotalTotalPrice" id="ck1TotalTotalPrice" value="TotalTotalPrice" /><input
                                                                type="text" id="txtTotalTotalPrice" value="金额合计：" size="20" readonly />
                                                        </td>
                                                        <td>
                                                        </td>
                                                    </tr>
                                                        ...
                                                        <td colspan="3">
                                                            <table width="100%" border="0" cellspacing="1" bgcolor="#000000" id="listSetDetail">
                                                                <tr>
                                                                    ...
                                                                    <td bgcolor="#FFFFFF">
                                                                        <input type="checkbox" name="ck2TakeCount" id="ck2TakeCount" value="TakeCount" /><input
                                                                            type="text" id="txtDTakeCount" value="<% if (((XBase.Common.UserInfoUtil)XBase.Common.SessionUtil.Session["UserInfo"]).IsMoreUnit.ToString()=="True")
                                                                       {%>基本数量<%}else{ %>领料数量<%} %>" size="10" readonly />
                                                                    </td>
                                                                    ...
                                                                    <td bgcolor="#FFFFFF">
                                                                        <input type="checkbox" name="ck2StorageName" id="ck2StorageName" value="StorageName" /><input
                                                                            type="text" id="txtDStorageName" value="仓库" size="8" readonly />
                                                                    </td>
                                                                    <% if (((XBase.Common.UserInfoUtil)XBase.Common.SessionUtil.Session["UserInfo"]).IsMoreUnit.ToString() == "True")
                                                                       {%>
                                                                    <td bgcolor="#FFFFFF">
                                                                    ...
                                                                    <%}
                                                                       ...
                                                                       { %>
                                                                    <td bgcolor="#FFFFFF">
                                                                        <input type="checkbox" name="ck2Price" id="ck2Price" value="Price" /><input type="text"
                                                                            id="txtDPrice" value="单价" size="10" readonly />
                                                                    </td>
                                                                    <%} %>
                                                                    <td bgcolor="#FFFFFF">
                                                                        <input type="checkbox" name="ck2TotalPrice" id="ck2TotalPrice" value="TotalPrice" /><input
                                                                            type="text" id="txtDTotalPrice" value="金额" size="8" readonly />
                                                                    </td>
                                                                    <td bgcolor="#FFFFFF">
                                                                        <input type="checkbox" name="ck2BackCount" id="ck2BackCount" value="BackCount" /><input
                                                                            type="text" id="txtDBackCount" value="已退料数量" size="4" readonly />
                                                                    </td>
                                                                    <td bgcolor="#FFFFFF">
                                                                        <input type="checkbox" name="ck2Remark" id="ck2Remark" value="Remark" /><input type="text"
                                                                            id="txtRemark" value="备注" size="10" readonly />
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                            <br />
...
<script language="javascript">
    ...
    printSetObj.PrintTypeFlag = '<%=XBase.Common.ConstUtil.PRINTBILL_TYPEFLAG_TAKE %>';
    /*跳转页面*/
    printSetObj.ToLocation ='TakeMaterialPrint.aspx?ID=' + intTakeID;
    /*表名称*/
    printSetObj.TableName = 'officedba.'+'<%=XBase.Common.ConstUtil.CODING_RULE_TABLE_TAKE %>';
    /*取基本信息及明细信息的字段*/
    if(glb_IsMoreUnit=='True')
    {
        printSetObj.ArrayDB = new Array(    
                                            [   
                                                ...
                                                'TakeNo','Subject','strFromType','TaskNo', 'SaleReal','DeptName','ProcessDeptName','strManufactureType','TakerReal','HandoutReal','ProjectName','CountTotal','TotalTotalPrice',
                                                'strBillStatusText','TakeDate','CreatorReal','CreateDate','ConfirmorReal','ConfirmDate','CloserReal','CloseDate','ModifiedUserID','ModifiedDate','Remark'
                                            ],
                                            [   
                                                'SortNo','ProdNo','ProductName','UnitName','TakeCount','UsedUnitName','UsedUnitCount','StorageName','UsedPrice','TotalPrice', 'BackCount','Remark'
                                            ]
                                        );
    }
    else
    {
        printSetObj.ArrayDB = new Array(    
                                            ...
                                            [   
                                                'SortNo','ProdNo','ProductName','UnitName','TakeCount','StorageName','Price','TotalPrice', 'BackCount','Remark'
                                            ]
                                        );
   }
