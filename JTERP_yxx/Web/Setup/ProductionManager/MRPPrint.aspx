<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MRPPrint.aspx.cs" Inherits="Pages_PrinttingModel_ProductionManager_MRPPrint"
    ...
    <div align="center">
        ...
        <div id="divMain" align="center">
            ...
            <table width="640px" border="0" cellpadding="0" cellspacing="1">
             ...
             <br />
               <table width="640px" border="0" cellpadding="0" cellspacing="1" align="center">
                <tr>
                    <td>
                        <table style="text-align: center; font-family: 宋体; font-size: 18px; font-weight: bold;"  width="640px">
                           <tr>
                                <td>
                                    <%=signOne %>
                                </td>
                        ...
                        <span style="text-align: center; font-family: 宋体; font-size: 14px">
                            <br />
                            <br />
                            <asp:Label ID="lblPrintFoot" runat="server" Text="Label"></asp:Label>
                        </span>
                    </td>
                </tr>
            </table>
                                                ...
                                                <table width="100%" border="0" align="left" cellspacing="0">
                                                    ...
                                                    <tr>
                                                        <td width="20%" align="left">
                                                            <input type="checkbox" name="ck1MRPNo" id="ck1MRPNo" value="MRPNo" /><input type="text"
                                                                id="txtMRPNo" value="单据编号：" size="20" readonly />
                                                        </td>
                                                        <td width="20%" align="left">
                                                        ...
                                                        <td align="left">
                                                            <input type="checkbox" name="ck1PricipalReal" id="ck1PricipalReal" value="PricipalReal" /><input
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="20%" align="left">
                                                            <input type="checkbox" name="ck1PlanNo" id="ck1PlanNo" value="PlanNo" /><input type="text"
                                                                id="txtPlanNo" value="主生产计划：" size="20" readonly />
                                                        </td>
                                                        <td>
                                                            ...
                                                            <table width="100%" border="0" cellspacing="1" bgcolor="#000000" id="listSetDetail">
                                                                <tr>
                                                                    ...
                                                                    <td bgcolor="#FFFFFF">
                                                                        <input type="checkbox" name="ck2ProductName" id="ck2ProductName" value="ProductName" /><input
                                                                            type="text" id="txtDProductName" value="物品名称" size="8" readonly />
                                                                                        ...
                                                                                        <td bgcolor="#FFFFFF">
                                                                        <input type="checkbox" name="ck2Manufacturer" id="ck2Manufacturer" value="Manufacturer" /><input
                                                                            type="text" id="txtDManufacturer" value="供应商" size="8" readonly />
                                                                    </td>
                                                                    <td bgcolor="#FFFFFF">
                                                                    ...
                                                                    <td bgcolor="#FFFFFF">
                                                                       ...
                                                                       {%>基本数量<%}else{ %>应计划数量<%} %>" size="10" readonly />
                                                                    </td>
                                                                    ...
                                                                    <td bgcolor="#FFFFFF">
                                                                        <input type="checkbox" name="ck2UsedUnitName" id="ck2UsedUnitName" value="UsedUnitName" /><input
                                                                            type="text" id="txtDUsedUnitName" value="单位" size="4" readonly />
                                                                                                                                        ...
                                                                                                                                        <td bgcolor="#FFFFFF">
                                                                        <input type="checkbox" name="ck2GrossCount" id="ck2GrossCount" value="GrossCount" /><input
                                                                            type="text" id="txtDGrossCount" value="毛需求量" size="8" readonly />
                                                                    </td>
                                                                    <td bgcolor="#FFFFFF">
                                                                        <input type="checkbox" name="ck2UsedUnitCount" id="ck2UsedUnitCount" value="UsedUnitCount" /><input
                                                                            type="text" id="txtDUsedUnitCount" value="应计划数量" size="4" readonly />
                                                                    </td>
                                                                    <%}
                                                                       else
                                                                       { %>
                                                                                                                                           <td bgcolor="#FFFFFF">
                                                                        <input type="checkbox" name="ck2GrossCount" id="ck2GrossCount" value="GrossCount" /><input
                                                                            type="text" id="Text1" value="毛需求量" size="8" readonly />
                                                                    </td>
                                                                    <%} %>
                                                                    
                                                                    <td bgcolor="#FFFFFF">
                                                                        <input type="checkbox" name="ck2PlanDate" id="ck2PlanDate" value="PlanDate" /><input
                                                                            type="text" id="txtDPlanDate" value="计划供料日期" size="10" readonly />
                                                                    </td>
                                                                    <td bgcolor="#FFFFFF">
                                                                        <input type="checkbox" name="ck2strMaterialSource" id="ck2strMaterialSource" value="strMaterialSource" /><input
                                                                            type="text" id="txtDstrMaterialSource" value="物料来源" size="8" readonly />
                                                                    </td>
                                                                    <td bgcolor="#FFFFFF">
                                                                    ...
                                                                    <td bgcolor="#FFFFFF">
                                                                        <input type="checkbox" name="ck2ProcessedCount" id="ck2ProcessedCount" value="ProcessedCount" /><input
                                                                            type="text" id="txtDProcessedCount" value="已生成采购需求数量" size="10" readonly />
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                            <br />
...
<script language="javascript">
    ...
    printSetObj.PrintTypeFlag = '<%=XBase.Common.ConstUtil.PRINTBILL_TYPEFLAG_MRP %>';
    /*跳转页面*/
    printSetObj.ToLocation ='MRPPrint.aspx?ID=' + intMrpID;
    /*表名称*/
    printSetObj.TableName = 'officedba.'+'<%=XBase.Common.ConstUtil.CODING_RULE_TABLE_MRP %>';
    /*取基本信息及明细信息的字段*/
   ...
   if(glb_IsMoreUnit=='True')
   {
        printSetObj.ArrayDB = new Array(    
                                            [   
                                                ...
                                                'MRPNo','Subject','PricipalReal','DeptName', 'PlanNo','CountTotal','strBillStatusText','CreatorReal','CreateDate','ConfirmorReal','ConfirmDate',
                                                'CloserReal','CloseDate','ModifiedUserID','ModifiedDate','Remark'
                                            ],
                                            [   
                                                 'SortNo','ProdNo','ProductName','Manufacturer','UnitName','PlanCount','UsedUnitName','GrossCount','UsedUnitCount','PlanDate', 'strMaterialSource','Remark','ProcessedCount'
                                            ]
                                        );
   } 
   else
   {
        printSetObj.ArrayDB = new Array(    
                                            ...
                                            [   
                                                'SortNo','ProdNo','ProductName','Manufacturer','UnitName','PlanCount','GrossCount','PlanDate', 'strMaterialSource','Remark','ProcessedCount'
                                            ]
                                        );
   }
