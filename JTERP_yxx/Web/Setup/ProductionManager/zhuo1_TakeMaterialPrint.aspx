<%@ Page Language="C#" AutoEventWireup="true" CodeFile="zhuo1_TakeMaterialPrint.aspx.cs" Inherits="Pages_PrinttingModel_ProductionManager_zhuo1_TakeMaterialPrint" ValidateRequest="false" %>
...
<body >
    ...
    <div align="center">
       <object classid="CLSID:8856F961-340A-11D0-A96B-00C04FD705A2" height="0" id="WB" width="0">
        ...
        <table width="680px" border="0" style="font-size: 12px;" runat="server" id="table_id">
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="1">
                ...
                <tr style="height:16px">
                    ...
                    <td class="trDetail"><%#Eval("Price")%>&nbsp;</td>
                    <td class="trDetail"><%#Eval("TotalPrice")%>&nbsp;</td>
