<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MasterProductSchedulePrint.aspx.cs"
    Inherits="Pages_PrinttingModel_ProductionManager_MasterProductSchedulePrint"
                                                ...
                                                <table width="100%" border="0" align="left" cellspacing="0">
                                                    ...
                                                    <tr>
                                                        <td width="20%" align="left">
                                                            <input type="checkbox" name="ck1PlanNo" id="ck1PlanNo" value="PlanNo" /><input type="text"
                                                                id="txtPlanNo" value="单据编号：" size="20" readonly />
                                                        </td>
                                                        <td width="20%" align="left">
                                                        ...
                                                        <td align="left">
                                                            <input type="checkbox" name="ck1PrincipalReal" id="ck1PrincipalReal" value="PrincipalReal" /><input
                                                                type="text" id="txtPrincipalReal" value="负责人：" size="20" readonly />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td width="20%" align="left">
                                                    ...
                                                    <tr>
                                                        <td width="20%" align="left">
                                                            <input type="checkbox" name="ck1CountTotal" id="ck1CountTotal" value="CountTotal" />
                                                            <input type="text" id="txtCountTotal" value="计划生产数量合计：" size="20" readonly />
                                                        </td>
                                                        <td width="20%" align="left">
                                                        </td>
                                                        <td>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td bgcolor="#FFFFFF">
                                                                        <input type="checkbox" name="ck2CodeName" id="ck2CodeName" value="CodeName" /><input
                                                                            type="text" id="txtDCodeName" value="<% if (((XBase.Common.UserInfoUtil)XBase.Common.SessionUtil.Session["UserInfo"]).IsMoreUnit.ToString()=="True")
                                                                       {%>基本单位<%}else{ %>单位<%} %>" size="4" readonly />
                                                                    </td>
                                                                    <td bgcolor="#FFFFFF">
                                                                        <input type="checkbox" name="ck2ProduceCount" id="ck2ProduceCount" value="ProduceCount" /><input
                                                                            type="text" id="txtDProduceCount" value="<% if (((XBase.Common.UserInfoUtil)XBase.Common.SessionUtil.Session["UserInfo"]).IsMoreUnit.ToString()=="True")
                                                                       {%>基本数量<%}else{ %>计划生产数量<%} %>" size="10" readonly />
                                                                    </td>
                                                                    ...
                                                                    <td bgcolor="#FFFFFF">
                                                                        <input type="checkbox" name="ck2UsedUnitCount" id="ck2UsedUnitCount" value="UsedUnitCount" /><input
                                                                            type="text" id="txtDUsedUnitCount" value="计划生产数量" size="4" readonly />
                                                                    </td>
                                                                    <%} %>
                                                                    <td bgcolor="#FFFFFF">
                                                                        <input type="checkbox" name="ck2ProductCount" id="ck2ProductCount" value="ProductCount" /><input
                                                                            type="text" id="txtDProductCount" value="需求数量" size="8" readonly />
                                                                    </td>
                                                                    <td bgcolor="#FFFFFF">
                                                                        <input type="checkbox" name="ck2StartDate" id="ck2StartDate" value="StartDate" /><input
                                                                            type="text" id="txtDStartDate" value="计划开工日期" size="10" readonly />
                                                                    </td>
                                                                    <td bgcolor="#FFFFFF">
                                                                        <input type="checkbox" name="ck2EndDate" id="ck2EndDate" value="EndDate" /><input
                                                                            type="text" id="txtDEndDate" value="计划完工日期" size="10" readonly />
                                                                    </td>
                                                                    <td bgcolor="#FFFFFF">
                                                                        <input type="checkbox" name="ck2FromBillNo" id="ck2FromBillNo" value="FromBillNo" /><input
                                                                            type="text" id="txtDFromBillNo" value="销售订单编号" size="10" readonly />
                                                                    </td>
                                                                    <td bgcolor="#FFFFFF">
                                                                        <input type="checkbox" name="ck2FromLineNo" id="ck2FromLineNo" value="FromLineNo" /><input
                                                                            type="text" id="txtDFromLineNo" value="销售订单行号" size="10" readonly />
                                                                    </td>
                                                                    <td bgcolor="#FFFFFF">
                                                                        <input type="checkbox" name="ck2DetailRemark" id="ck2DetailRemark" value="DetailRemark" /><input
                                                                            type="text" id="txtDDetailRemark" value="备注" size="4" />
                                                                    </td>
                                                                    <td bgcolor="#FFFFFF">
                                                                        <input type="checkbox" name="ck2PlanCount" id="ck2PlanCount" value="PlanCount" /><input
                                                                            type="text" id="txtDPlanCount" value="已下达数量" size="10" readonly />
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                            <br />
...
<script language="javascript">
    ...
    printSetObj.PrintTypeFlag = '<%=XBase.Common.ConstUtil.PRINTBILL_TYPEFLAG_MASTERPRODUCTSCHEDULE %>';
    /*跳转页面*/
    printSetObj.ToLocation ='MasterProductSchedulePrint.aspx?ID=' + intMasterID;
    /*表名称*/
    printSetObj.TableName = 'officedba.'+'<%=XBase.Common.ConstUtil.CODING_RULE_TABLE_SCHEDULE %>';
    /*取基本信息及明细信息的字段*/
   ...
   if(glb_IsMoreUnit=='True')
   {
        printSetObj.ArrayDB = new Array(    
                                            [   
                                                ...
                                                'PlanNo','Subject','PrincipalReal','DeptName', 'CountTotal','strBillStatusText','CreatorReal','CreateDate','ConfirmorReal','ConfirmDate','CloserReal',
                                                'CloseDate','ModifiedUserID','ModifiedDate','Remark'
                                            ],
                                            [   
                                                'SortNo','ProdNo','ProductName','Specification','CodeName','ProduceCount','UsedUnitName','UsedUnitCount','ProductCount', 'StartDate','EndDate','FromBillNo','FromLineNo','DetailRemark','PlanCount'
                                            ]
                                        );
   } 
   else
   {
        printSetObj.ArrayDB = new Array(    
                                            ...
                                            [   
                                                'SortNo','ProdNo','ProductName','Specification','CodeName','ProduceCount','ProductCount', 'StartDate','EndDate','FromBillNo','FromLineNo','DetailRemark','PlanCount'
                                            ]
                                        );
   }
