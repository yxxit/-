<%@ Page Language="C#" AutoEventWireup="true" CodeFile="lydd2_TakeMaterialPrint.aspx.cs" Inherits="Pages_PrinttingModel_ProductionManager_lydd2_TakeMaterialPrint" ValidateRequest="false" %>
    ...
    <div align="center">
       <object classid="CLSID:8856F961-340A-11D0-A96B-00C04FD705A2" height="0" id="WB" width="0">
        ...
        <span class="noprint2" style="text-align: center; margin-top: 4px; width: 680px;">
            ...
            <asp:Button ID="btnImport" runat="server" Text=" 导 出 " CssClass="busBtn" onclick="btnImport_Click" OnClientClick="return fnGetTable();"
                 />
        </span>
         <div id="divMain" align="center">
        <table width="<%=ht["PrintWidth"]%>" border="0" style="font-size: 16px;"  id="table_id">
                <tr style="height:6px;"><td colspan="9"><span style="text-align: center; width: 680px; font-family:宋体; font-size:22px; font-weight:bold;"><%=ht["CompanyName"] %></span></td></tr>
            ...
            <table width="<%=ht["PrintWidth"]%>" border="0" cellpadding="0" cellspacing="1" >
            <tr  valign="top"> <td>             
            <table width="100%" border="0" cellpadding="0" cellspacing="1">
                ...
                <tr style="height:16px">
                    ...
                    <td class="trDetail"><%#Eval("ProdNo")%>&nbsp;</td>
                    ...
                    <td class="trDetail"><%#Eval("TakeCount")%>&nbsp;</td>
                    <td class="trDetail"><%#Eval("BatchNo")%>&nbsp;</td>
                    <td class="trDetail"><%#Eval("Remark")%>&nbsp;</td>
            ...
            <table width="<%=ht["PrintWidth"]%>" border="0" style="font-size: 16px;">
           <%-- <tr>
            ...
            <td align="left"><asp:Label ID="Lbl_totalprice" runat="server" Text=""></asp:Label></td>
             ...
             <%--<tr style="height:13px">
                    ...
                    <td colspan="8" align="left"  width="20%">
                        <asp:Label ID="lbl_UserMans" runat="server" Text=""></asp:Label>
             ...
             <br />
            <br />
            <table width="<%=ht["PrintWidth"]%>" border="0" style="font-size: 14px;">
                <tr style="height: 20px">
                    <td colspan="2" align="left" >
                       
                    </td>
                    <td colspan="5" align="ceter">
                      ①领料部门(白)  &nbsp;&nbsp;   ②仓库(红)   &nbsp;&nbsp; ③制单(黄) &nbsp;&nbsp;   ④财务(蓝)
                    </td>
                    <td colspan="2" align="left">
