...
<div id="layout">
    ...
    <div id="divFlow">
        ...
        <table style=" margin-left:75px" width="800px" border="0" align="center" cellpadding="0" cellspacing="1" id="pageDataList1"
            bgcolor="#999999" >
            <tbody>
                <tr>
        ...
        <br />
        <table width="800px" style=" margin-left:75px" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#999999"
            class="PageList">
         <tr>
  ...
  requestobj = GetRequest();
    ...
    {document.getElementById("btnAll").checked=false;
        ...
        var MID=   document.getElementById('hfModuleID').Value;
           ...
           url:  '../../../Handler/Office/SystemManager/ApprovalFlowSetList.ashx?TypeCode='+TypeCode+'&TypeFlag='+TypeFlag+'&orderBy='+orderBy+'&UseStatus='+UseStatus+'',//目标地址
           cache:false,
           ...
           success: function(msg){
                    ...
                    $.each(msg.data,function(i,item){ var temp =item.FlowNo+"|"+item.UsedStatus;
