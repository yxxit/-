<%@ Control Language="C#" AutoEventWireup="true" CodeFile="SelectedTaskList.ascx.cs" Inherits="UserControl_Human_SelectedTaskList" %>
            ...
            <tbody>
                <tr>
                    ...
                    <th align="center" class="td_list_fields" style="display:none ">
                        <div class="orderClick" onclick="templateEmpOrderBy('TaskNo','otemplateEmp');return false;">
                            任务编号<span id="otemplateEmp" class="orderTip"></span></div>
                    </th>
                    <th align="center" class="td_list_fields">
                        <div class="orderClick" onclick="templateEmpOrderBy('Title','otemplateEmp1');return false;">
                            任务名称<span id="otemplateEmp1" class="orderTip"></span></div>
                    </th>
                </tr>
            </tbody>
        </table>
 ...
 pop1= document .getElementById ("hidOBJ").value ;
    ...
    function SellTemplateTurnToPage(pageIndex,objInput1,objInput2)
    {
           currentTemplateEmpPageIndex = pageIndex;   
            var postParam ="pageIndex="+pageIndex+"&PageCount="+pageTemplateEmpcount+"&Action=SearchInfo&OrderBy="+orderTemplateEmpBy ; 
           $.ajax({
           type: "POST",//用POST方式传输
           ...
           success: function(msg){
                    ...
                    $.each(msg.data,function(i,item){
                        ...
                        $("<tr class='newrow'></tr>").append("<td height='22' align='center'>"+" <input type=\"radio\" name=\"radioEmp_\"  id=\"radioEmp_"+item.ID+"\" value=\""+item.TaskNo+"\" onclick=\"fnSelectTemplateEmp("+item.ID+",'"+item.Title+"','"+objInput1+"','"+objInput2+"');\" />"+"</td>"+
                         "<td height='22' align='center' style='display:none'>"+ item.TaskNo +"</td>"+
