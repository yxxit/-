        ...
        <table>
            <tr>
                <td>
                    ...
                    <%--<img id="btnclear" alt="清空" src="../../../images/Button/Main_btn_qk.jpg"  onclick="ClearInfo();"  style='cursor: pointer;' />--%>
    ...
    function TurnToPageWorkCenter(pageIndexWorkCenter)
    {
           ...
           success: function(msg){
                    ...
                    $.each(msg.data,function(i,item){
                        ...
                        $("<tr class='newrow'></tr>").append("<td height='22' align='center'>"+"<input id='OptionCheck_"+item.ID+"' name='OptionCheck_"+item.ID+"'  value="+item.ID+" onclick=\"Fun_FillParent_WorkCenter('"+item.ID+"','"+item.WCName+"');\"  type='radio'/>"+"</td>"+
