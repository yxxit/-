<%@ Control Language="C#" AutoEventWireup="true" CodeFile="delete2.ascx.cs" Inherits="UserControl_delete2" %>
...
<div id="deleteBill" style="border: solid 5px #999999; background: #fff; width: 750px;
    z-index: 21; position: absolute; top: 20%; left: 60%; margin: 5px 0 0 -400px">
...
<input  id="txtTRLastIndex" type="hidden" value="1"/></td>
        </tr>
    </table>
    <input id="hfCustID" type="hidden" />
    <input id="hfCustID_Ser" type="hidden" runat="server" />
