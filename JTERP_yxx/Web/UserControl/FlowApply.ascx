...
<div id="divFlowApply" style="border: solid 10px #898989; background: #fff; padding: 10px;
    ...
    <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr id="divApplayToWait" >
            <td width="55" height="30">
                <span class="flowTitle">选择下一步接收人</span>
            </td>
            <td align="left">
                <input id="txtNextPersonID" name="txtNextPersonID" type="hidden" runat="server" />
                <input id="txtNextPersonName" name="txtNextPersonName" runat="server" type="text"  onclick="alertdiv('txtNextPersonName,txtNextPersonID');"  />
            </td>
        </tr>
        ...
        <input type="checkbox" id="isRemind" value="" checked="checked" style="display:none" /> 
        </td>
        </tr>
