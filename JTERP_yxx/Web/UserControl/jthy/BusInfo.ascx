<%@ Control Language="C#" AutoEventWireup="true" CodeFile="BusInfo.ascx.cs" Inherits="UserControl_jthy_BusInfo" %>
...
<script type="text/javascript">
    ...
    popInBusObj.ShowList = function(model) { 
        ...
        $("#InBusNo").val('');
        $("#ColName").val('');
        document.getElementById('HolidaySpan_Bus').style.display = 'block';
        TurnToPageUc_Bus(currentPageIndexUc);
    }
 ...
 function TurnToPageUc_Bus(pageIndex)
    {
           ...
           success: function(msg){
                    ...
                    if (item.ID != null && item.ID != "")
                        ...
                        $("<tr class='newrow'></tr>").append("<td height='22' align='center'>" + "<input  id='CheckboxProdID" + i + "'  name='CheckboxProdID'  value='" + i + "'  type='checkbox'/><input type='hidden' id='arriveId" + i + "' value='" + item.ID + "' /> </td>" +

                        "<td height='22' align='center'>" + "<input id='arriveNo" + i + "'   style='background-color:transparent; border:none' name='arriveNo' value='" + item.ArriveNo + "'  type='text'/></td>" +
                   ...
                   "<%= Request.Url.AbsolutePath %>",//[url]
                    ...
                    onclick:"TurnToPageUc_Bus({pageindex});return false;"}//[attr]
                    );
...
function fnSelect()
{
    ...
    TurnToPageUc_Bus(1);  
    openRotoscopingDiv(false,"divJTNameS_Bus","ifmJTNameS_Bus");//弹遮罩层
    document.getElementById("HolidaySpan_Bus").style.display= "block";
}
...
if(!PositiveInteger(newPageCount))
    ...
    else
    {
        ...
        TurnToPageUc_Bus(parseInt(newPageIndex));
    }
}
//排序
...
<div id="divJTNameS_Bus"  style="display:none">
<iframe id="ifmJTNameS_Bus" frameborder="0" width="100%" ></iframe>
</div>
<div id="HolidaySpan_Bus" style="border: solid 5px #999999; background: #fff;
      ...
      <tr>
        <td bgcolor="#FFFFFF"><table width="100%" border="0"  cellpadding="2" cellspacing="1" bgcolor="#CCCCCC" class="table">
          ...
          <tr>
            ...
            <img id="btn_search" alt="检索" src="../../../Images/Button/Bottom_btn_search.jpg" style='cursor:hand;' onclick='fnSelect()' /> 
           
            <img  id="confim"  alt="确认"  src="../../../Images/Button/Bottom_btn_confirm.jpg"  onclick='GetConfim()'/>  
