           ...
           success: function(msg){
                    ...
                    $.each(msg.data,function(i,item){
                      if(item.id != null && item.id != "")                      
                        $("<tr class='newrow'></tr>").append("<td height='22' align='center'>"+"<input onclick=\"GetLinkMan('"+item.id+"','"+item.LinkManName+"','"+item.WorkTel+"','"+item.HandSet+"','"+item.HomeAddress+"')\" id='Checkbox1' value="+item.id+"  type='radio'/>"+"</td>"+                                                                                                       
...
function GetLinkMan(ID,LinkManName,WorkTel,HandSet,HomeAddress)
{
    document.getElementById("hfLinkmanID").value = ID;   
    //document.getElementById("txtUcLinkMan11").value = LinkManName;
    document.getElementById("txtCustLinkTel").value = WorkTel;
    if (document.getElementById("Telphone")) {
        document.getElementById("Telphone").value = HandSet;
    }
    ...
    if(document.getElementById("tell")){
       document.getElementById("tell").value=WorkTel;
    }
    //-----------------------------------//
    ...
    <table width="99%" border="0" align="center" cellpadding="0" id="searchtable"  cellspacing="0" bgcolor="#CCCCCC">
      <tr>
        <td bgcolor="#FFFFFF"><table width="100%" border="0"  cellpadding="2" cellspacing="1" bgcolor="#CCCCCC" class="table">
          <tr class="table-item">
            <td width="10%" height="20" class="td_list_fields" align="right"> 联系人姓名</td>
            <td width="23%" bgcolor="#FFFFFF"><input id="txtLinkMan"  class="tdinput"  type="text" style="width:95%" /></td>
            
            <td class="td_list_fields" align="right" width="10%">称谓</td>
