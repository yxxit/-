...
//shjp添加
 popSequObj.ShowList1=function(objRow)
{
    popSequObj.RowObj = objRow;
...
//shjp添加
function TurnToPageSequ1(pageIndexSequ)
{
       currentPageIndex = pageIndexSequ;
       var SequNo= "";
       var SequName= "";
...
//                     if(item.Isoutsource==1){tempIsoutsource='是';}else{tempIsoutsource='否';}
                    ...
                    if(item.ID != null && item.ID != "")
                    $("<tr class='newrow'></tr>").append("<td height='22' align='center'>"+"<input id='CheckboxSequ' name='CheckboxSequ'  value="+item.ID+"  type='radio'  onclick=\"Fun_FillParent_SequContent1('"+item.ID+"','"+item.SequNo+"','"+item.SequName+"','"+item.WCName+"','"+item.WCID+"','"+item.TimeUnit+"','"+item.ReadyTime+"','"+item.RunTime+"','"+item.IsCharge+"','"+item.Isoutsource+"','"+item.CheckWay+"','"+item.TimeWage+"','"+item.PieceWage+"');\" />"+"</td>"+
                    "<td height='22' align='center'>"+ item.SequNo +"</td>"+
                    "<td height='22' align='center'>"+ item.SequName +"</td>"+
                    "<td height='22' align='center'>"+item.WCName+"</td>"+
                    "<td height='22' align='center'>"+item.ReadyTime+"</td>"+
