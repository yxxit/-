<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CustNameSelList.ascx.cs" Inherits="UserControl_CustNameSelList" %>
...
<script type="text/javascript">
 ...
 var popSellCustListObj = new Object();
    popSellCustListObj.SearchModel = 'protion'; //查询的模式，all是取出所有的客户，protion时取出所有启用的客户
    popSellCustListObj.returnName = false;

    popSellCustListObj.ShowList = function(model) {
        if (model != null && typeof (model) != "undefined") {
            popSellCustListObj.SearchModel = model;
        }
