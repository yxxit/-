...
<div id="layout">
    ...
    <div id="divStandardProject" style="border: solid 10px #93BCDD; background: #fff;
        padding: 10px; width:650px; height: 200px; overflow: scroll; z-index: 1000;
        position: absolute;display:none;  top: 50px; left: 60%; margin: 5px 0 0 -400px;
        scrollbar-face-color: #ffffff; scrollbar-highlight-color: #ffffff; scrollbar-shadow-color: COLOR:#000000;
        scrollbar-3dlight-color: #ffffff; scrollbar-darkshadow-color: #ffffff;"  onmousedown="javascript:moveStart(event,this.id);">
        <table>
            <tr>
                <td>
                ...
                <tr>
                    <td bgcolor="#FFFFFF">
                        <table width="100%" border="0" cellpadding="2" cellspacing="1" bgcolor="#CCCCCC"
                            class="table">
                            <tr class="table-item">
                                <td width="10%" height="20"  align="right" class="td_list_fields" style="font-size: 13">
                                    项目编号
                                </td>
                                <td width="24%" bgcolor="#FFFFFF">
                                    <input id="ControlProjectNo" type="text" specialworkcheck="项目编号" class="tdinput" size="13" />
                                </td>
                                <td width="10%"  align="right" class="td_list_fields" style="font-size: 13">
                                    项目名称
                                </td>
