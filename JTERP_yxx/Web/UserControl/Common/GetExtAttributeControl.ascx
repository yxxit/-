            ...
            success: function(msg) {
                ...
                if (parseInt(msg.totalCount) > 0) {
                    ...
                    $.each(msg.data, function(i, item) {
                        ...
                        if (iTemp != 2) {
                            Cell += "<td align='right'  width='10%' class='td_list_fields'>" + item.EFDesc + "</td>" +
                    ...
                    switch (iTemp) {
                        case 1:
                            $("<tr></tr>").append(
                        Cell + "<td align='right' width='10%' class='td_list_fields'></td>"
                        + "<td  align=\"right\"  width='23%' bgcolor='#FFFFFF'></td>" + "<td align='right' width='10%' class='td_list_fields'></td>"
                        + "<td   align=\"right\"  width='24%' bgcolor='#FFFFFF'></td>"
                        ).appendTo($("#ExtTab tbody"));
                            break;
                        case 2:
                            $("<tr></tr>").append(Cell +
                        "<td align='right'  width='10%' class='td_list_fields'></td>"
