<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ProductInfoControl.ascx.cs"
    Inherits="UserControl_Common_ProductInfoControl" %>
<%--<%@ Register Src="../../UserControl/ProductDiyAttr.ascx" TagName="ProductDiyAttr" TagPrefix="uc1" %>--%>
<style type="text/css">
    .tdinput
    {
        border-width: 0pt;
...
<div id="divStorageProduct" style="border: solid 8px #93BCDD; background: #fff; padding: 10px; width: 93%;  z-index: 200; top:50px;left:30px; position: absolute; display: none;" onmousedown="javascript:moveStart(event,this.id);">
    <div id="divquery">
        <table width="100%">
            <tr>
                <td>
...
var glbHidAuthority =document.getElementById('ProductInfoControl1_hidIsAuthority').value;  
var glbhidversion=document.getElementById('ProductInfoControl1_hidversion').value; 
    ...
    /*多选*/
    popTechObj.ShowListCheckSpecial = function(objInput, CheckSpecial,StroageId) {
        popTechObj.InputObj = objInput;
        popTechObj.CheckSpecial = CheckSpecial;
        popTechObj.StorageId=StroageId;
       ...
       popTechObj.ShowListCheckSpecial12 = function(objInput, CheckSpecial,StroageId) {
        popTechObj.InputObj = objInput;
        popTechObj.CheckSpecial = CheckSpecial;
        popTechObj.StorageId=StroageId;
        document.getElementById('divStorageProduct').style.display = 'inline';
    ...
    function TurnToPageProduct(pageIndex) {
        ...
        $.ajax({
            ...
            data: "pageIndex=" + pageIndex + "&pageCount=" + pageCountproduct + "&action=" + action + "&orderByP=" + orderByP + "&ProductID=" + escape(ProdNo) + "&ProdName=" + escape(ProdName) + "\
                     ...
                     &QueryID=" + escape(QueryID) + "&typeid=" + escape(typeid) + "&bigtype=" + escape(bigtype) + "&ColorID=" + escape(Color) + "&EFIndex=" + escape(EFIndex) + "&EFDesc=" + escape(EFDesc) + "&StorageId="+escape(popTechObj.StorageId), //数据
...
//                        }
    ...
    *******************/
    ...
    function Fun_FillParent_Content(prodno)
    {
        document.getElementById(popTechObj.CleraInput).value=prodno;
    }
