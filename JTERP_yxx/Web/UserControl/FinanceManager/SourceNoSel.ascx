...
<table width="99%" border="0" align="center" cellpadding="0" id="Table1"  cellspacing="0" >
    ...
    <table width="99%" border="0" align="center" cellpadding="0" id="searchtable"  cellspacing="0" bgcolor="#CCCCCC">
      <tr>
        <td bgcolor="#FFFFFF"><table width="100%" border="0"  cellpadding="2" cellspacing="1" bgcolor="#CCCCCC" class="table">
          <tr class="table-item">
            <td width="10%" height="20" class="td_list_fields" align="right"> 单据编号</td>
            <td width="23%" bgcolor="#FFFFFF"><input name="UctxtSourceNo" id="UctxtSourceNo"  class="tdinput"  type="text" style="width:95%" /></td>
            
            <td class="td_list_fields" align="right" width="10%">往来单位名称</td>
    ...
    <tbody>
      <tr>
        ...
        <th align="center" class="td_list_fields"><div class="orderClick" onclick="OrderByUc('BillNo','oBillNo');return false;">单据编号<span id="oBillNo" class="orderTip"></span></div></th>
        <th align="center" class="td_list_fields"><div class="orderClick" onclick="OrderByUc('CustName','oCustName');return false;">往来单位<span id="oCustName" class="orderTip"></span></div></th>                
        <th align="center" class="td_list_fields"><div class="orderClick" onclick="OrderByUc('CreateDate','oCreateDate');return false;">日期<span id="oCreateDate" class="orderTip"></span></div></th>        
        <th align="center" class="td_list_fields"><div class="orderClick" onclick="OrderByUc('TotalPrice','oTotalPrice');return false;">金额<span id="oTotalPrice" class="orderTip"></span></div></th>
        <th align="center" class="td_list_fields"><div class="orderClick" onclick="OrderByUc('IsFeesAccount','oIsFeesAccount');return false;">是否开票<span id="oIsFeesAccount" class="orderTip"></span></div></th>
