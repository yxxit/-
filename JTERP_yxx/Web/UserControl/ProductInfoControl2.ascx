<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ProductInfoControl2.ascx.cs" Inherits="UserControl_ProductInfoControl2" %>
...
<div id="divzhezhao1" style="filter: Alpha(opacity=0); width: 93%; padding: 1px;height: 500px; z-index: 199; bottom:0px; left:0px;position: absolute; display: none;">
    <!--<iframe style="border: 0; width: 100%; height: 100%; position: absolute;z-index: -1;"></iframe>-->
</div>
<div id="divStorageProduct" style="border: solid 8px #93BCDD; background: #fff; padding: 10px; width: 93%;z-index: 200; top:50px;left:50px; position: absolute; display: none;" onmousedown="javascript:moveStart(event,this.id);">
    <div id="divquery">
...
var glbHidAuthority =document.getElementById('ProductInfoControl21_hidIsAuthority').value;  
    ...
    function TurnToPageProduct(pageIndex) {
        ...
        $.ajax({
            ...
            url: '../../../Handler/Office/SupplyChain/ProductInfoList2.ashx', //目标地址
            cache: false,
            data: "pageIndex=" + pageIndex + "&pageCount=" + pageCountproduct + "&action=" + action + "&orderByP=" + orderByP + "&ProductID=" + escape(ProdNo) + "&ProdName=" + escape(ProdName) + "\
                     ...
                     &QueryID=" + escape(QueryID) + "&typeid=" + escape(typeid) + "&bigtype=" + escape(bigtype)+ "&ColorID=" + escape(Color) + "&EFIndex=" + escape(EFIndex) + "&EFDesc=" + escape(EFDesc) + "", //数据
    ...
    function Fun_Search_Product(aa) {
        ...
        Material = document.getElementById("ProductInfoControl21_sel_Material").value;
    ...
    function closeProductdiv() {
        ...
        document.getElementById("ProductInfoControl21_sel_Material").value = "0";
