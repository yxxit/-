...
<div id="layout">
  ...
  <img alt="确定" src="../../../images/Button/Bottom_btn_ok.jpg" style='cursor: hand;'
                                                onclick="getdetailid();" id="imgsure" />
                </td>
                 <td width="15">
           ...
           success: function(msg){
                    ...
                    $.each(msg.data,function(i,item){   
                        ...
                        if(item.ID != null && item.ID != "")
                        {
                            ...
                            $("<tr class='newrow'></tr>").append("<td height='22' align='center'>"+" <input type=\"checkbox\" name=\"radioTech\" id=\"radioTech_"+item.deid+"\" value=\""+item.deid+","+item.TakeNo+","+item.ID+"\"  />"+"</td>"+
...
{
    var boxs=document.getElementsByName("radioTech");
    var deids="";
    var tano="";
    ...
    {   
        ...
        {
            var str=boxs[i].value;
            var taskno=str.split(',')[1];
            var ID=str.split(',')[2];
            if(tano=="")
            {
                tano=taskno;
    ...
    Fun_FillParent_TakeContent(deids,tano,ID);
}
...
//function onclick=\"Fun_FillParent_TakeContent("+item.deid+",'"+item.TakeNo+"');\"
