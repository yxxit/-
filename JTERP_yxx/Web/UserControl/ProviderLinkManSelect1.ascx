<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ProviderLinkManSelect1.ascx.cs" Inherits="UserControl_ProviderLinkManSelect1" %>
        ...
        $.ajax({
            ...
            success: function(msg) {
                ...
                if (item.ID != null && item.ID != "") {
                        $("<tr class='newrow'></tr>").append("<td height='22' align='center'>" + " <input type=\"radio\" name=\"radioTech\" id=\"radioTech_" + item.ID + "\" value=\"" + item.ID + "\" onclick=\"FillFromProviderLink('" + item.ID + "','" + item.LinkManName + "','"+item.WorkTel+"','"+item.Handset+"','"+item.HomeAddress+"');\" />" + "</td>" +
