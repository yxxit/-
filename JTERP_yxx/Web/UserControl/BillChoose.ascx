    ...
    <div id="divBillChoose" style="border: solid 10px #93BCDD; background: #fff; padding: 10px;
        ...
        <table width="100%" border="0" cellpadding="2" cellspacing="1" bgcolor="#CCCCCC"
            ...
            <tr class="table-item">
                ...
                <td width="2%"  align="right" class="td_list_fields">
                    ~
                </td>
                <td bgcolor="#FFFFFF" style="width: 15%">
            ...
            <tbody>
                <tr>
                    ...
                    <th align="center" class="td_list_fields">
                       ...
                       <th align="center" class="td_list_fields" id="sspUsedUnitName">
                    ...
                    <th align="center" class="td_list_fields">
                      ...
                      <th align="center" class="td_list_fields" id="sspUsedUnitCount">
