      ...
      <tr>
        <td bgcolor="#FFFFFF"><table width="100%" border="0"  cellpadding="2" cellspacing="1" bgcolor="#CCCCCC" class="table">
          ...
          <tr class="table-item">
            ...
            <td width="10%" height="20"  align="right" class="td_list_fields" >设备状态</td>
  ...
  <tr>
    ...
    <tbody>
      <tr>
        ...
        <th align="center" class="td_list_fields"><div class="orderClick" onclick="OrderBy('EquipmentNo','oGroup');return false;">设备编号<span id="oGroup" class="orderTip"></span></div></th>
        <th align="center" class="td_list_fields"><div class="orderClick" onclick="OrderBy('EquipmentName','oC2');return false;">设备名称<span id="oC2" class="orderTip"></span></div></th>
        <th align="center" class="td_list_fields"><div class="orderClick" onclick="OrderBy('CodeName','oC3');return false;">设备分类<span id="oC3" class="orderTip"></span></div></th>
        <th align="center" class="td_list_fields"><div class="orderClick" onclick="OrderBy('BuyDate','oC5');return false;">购入日期<span id="oC5" class="orderTip"></span></div></th>
        <th align="center" class="td_list_fields"><div class="orderClick" onclick="OrderBy('FittingFlag','oC8');return false;">配件<span id="oC8" class="orderTip"></span></div></th>
        <th align="center" class="td_list_fields"><div class="orderClick" onclick="OrderBy('Status','oC9');return false;">设备状态<span id="oC9" class="orderTip"></span></div></th>
      </tr>
    </tbody>
    </table>
