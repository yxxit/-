<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CustNameSel_Con.ascx.cs" Inherits="UserControl_CustNameSel_Con" %>
           ...
           success: function(msg){
                    ...
                    $.each(msg.data,function(i,item){
                      if(item.id != null && item.id != "")                      
                        $("<tr class='newrow'></tr>").append("<td height='22' align='center'>"+"<input  onclick=\"GetCust('"+item.id+"','"+item.CustNo+"','"+item.CustName+"','"+item.BillUnit+"','"+item.ReceiveAddress+"')\" id='Checkbox1' value="+item.ID+"  type='radio'/>"+"</td>"+
...
function GetCust(CustID,CustNo,CustName,BillUnit,ReceiveAddress)
{
    try
    {
    ...
    <table width="99%" border="0" align="center" cellpadding="0" id="searchtable"  cellspacing="0" bgcolor="#CCCCCC">
      <tr>
        <td bgcolor="#FFFFFF"><table width="100%" border="0"  cellpadding="2" cellspacing="1" bgcolor="#CCCCCC" class="table">
          <tr class="table-item">
            <td width="10%" height="20" align="right"> 客户编号</td>
