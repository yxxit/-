...
//      }
    ...
    function TurnToPage(pageIndex)
    {
           ...
           var fields="[ID],[BillNo],[FlowName],ApplyUserId,[FlowStatus],[BillTypeFlag] ,[BillTypeCode],BillID,[StepNo] ,[StepName] ,[ModifiedUserID]";
          ...
          var prams = "Fields="+fields;
           ...
           //return;//"[ID],[FlowName],[PageUrl],[FlowStatus],[BillTypeFlag] ,[BillTypeCode],[BillID],[StepNo] ,[StepName] ,[ModifiedUserID]
                    //数据获取完毕，填充页面据显示
                    //数据列表
                    ...
                    $.each(result.data.list,function(i,item){
                        ...
                        $("<tr class='newrow'></tr>").append("<td height='22' align='center'>"+"<input id='Checkbox1' name='Checkbox1'  value="+item.ID+"  type='checkbox'/>"+"</td>"+
                         "<td height='22' align='center'><a href='/"+sessionSection+billtypeitem.u+item.BillID+"&intFromType=3&ListModuleID=10711' title='点击查看"+item.BillNo+"的详细信息' >"+ item.BillNo+"</a></td>"+
                      ...
                      "<td height='22' align='center'>"+item.ApplyUserId+"</td>"+
