...
//      }
    ...
    function TurnToPage(pageIndex)
    {
          ...
          var action="LoadFlowWaitProcess";
           ...
           var fields="[ID],[BillNo],[FlowName],ApplyUserId,[FlowStatus],[BillTypeFlag] ,[BillTypeCode],BillID,[StepNo] ,[StepName] ,[ModifiedUserID],[ApplyUserName]";
           ...
           //return;//"[ID],[FlowName],[FlowStatus],[BillTypeFlag] ,[BillTypeCode],[StepNo] ,[StepName] ,[ModifiedUserID]
                    ...
                    $.each(result.data.list,function(i,item){
                     if(item.ID != null && item.ID != "")
                        ...
                        "<td height='22' align='center'><input type='text' id='itd' name='itd'  style='background-color:transparent;border:none;text-align:center;' value='"+(billtypeitem.t)+"'  />"+""+"</td>"+
