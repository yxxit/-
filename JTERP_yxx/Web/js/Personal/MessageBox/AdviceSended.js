function DelMessage()
{
    if(!confirm("确认删除吗"))
    {
        ...
        //删除
         $.ajax({ 
              type: "POST",
              url: "../../../Handler/Personal/MessageBox/AdviceSend.ashx",
...
//            condition += " AND a.Title like '%"+txtTitle+"%'";
              condition += " AND a.DoUserID In ("+selUsers+")";
           }
           ...
           var fields="a.[ID],a.FromUserID,a.CreateDate,a.DoUserID,a.Title,a.Content,DisplayName,AdviceType,b.EmployeeName";
          ...
          var prams = "Fields="+fields;
           ...
           url:  '../../../Handler/Personal/MessageBox/AdviceSend.ashx',//目标地址
           cache:false,
