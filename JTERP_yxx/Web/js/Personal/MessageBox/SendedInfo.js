...
function TurnToPage(pageIndex) {
 ...
 //   var condition = "1=1";
    ...
    var condition = "Status="+document.getElementById("strau").value;//短信状态
          
    var txtTitle = document.getElementById("txtTitle").value;//主题

    var createDate1 = document.getElementById("createDate1").value;//开始日期
    var createDate2 = document.getElementById("createDate2").value;//结束日期
   // var zhuantai=document.getElementById("strau").value;//短信状态
 // var receive=document.getElementById("txtPPerson").value;//接收人
  
 var receive=document.getElementById("txtPPersonID").value
   ...
   if(receive +""!=""){
     ...
     condition += " AND a.ReceiveUserID='"+receive+"'";
   }
