...
//var xxtt = encodeURIComponent(str);
//var xxtt = encodeURIComponent("的，发的是。的");
var xxtt = escape(str);
    return xxtt;
    ...
    { 
        ...
        var c=str2asc(chr).toString(16);
       
        //tt += chr+":"+c+"n"; 
        if(parseInt("0x"+c) > 0x7f)
        {            
           //12290,%a1%a3 
          //ret+="%"+c.slice(0,2)+"%"+c.slice(-2); //3002;%a1%a3
                      //  c += 29089;
...
function showLoading(tbEle)
{
    ...
    csstxt += "background-color:#999999;border:solid 1px #f1f1f1;";
