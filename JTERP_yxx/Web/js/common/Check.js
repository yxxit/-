 ...
 *------------2012-12-21---------*
  时    间：2012年12月21日
  修 改 人：DYG
  修改原因：因洛阳电镀系统中“*”是经常使用的符号，因此禁止的特殊字符中不可包含该字符。
  修改内容：CheckSpecialWord()方法上添加注释，该注释用于说明如果是给洛阳电镀更新系统，
            需要将禁止的符号“*”从数组中去掉。
...
//显示隐藏栏目 预警提醒专用
function oprItem1(itemId,clickId,tr1,tr2)
{
	if(document.getElementById(itemId).style.display== 'none')
	{
		...
		document.getElementById(clickId).innerHTML = '<img src="../../../images/Main/Close.jpg" onmouseover=document.getElementById("' + clickId +'").style.cursor = "pointer" onclick=oprItem1("'+ itemId +'","'+ clickId +'","'+ tr1 +'","'+ tr2 +'")></img>';
	}
	else
	{
	    ...
	    document.getElementById(clickId).innerHTML = '<img src="../../../images/Main/Open.jpg" style="CURSOR: pointer" onmouseover=document.getElementById("' + clickId +'").style.cursor = "pointer" onclick=oprItem1("'+ itemId +'","'+ clickId +'","'+ tr1 +'","'+ tr2+'")></img>';
	}
}
...
/***********************************************
 *验证是否包含特殊字符 pdd    如果是给洛阳电镀更新系统，需要将禁止的符号“*”从数组中去掉。 add by dyg 20121221
 **********************************************/
