                      ...
                      { 
                        ...
                        { 
                           ...
                           //  
                            ...
                            {
                           //  
                               GetFlowButton_Content(true,false,false,false,false,false,false,glb_BillID);//暂时注释
                                 
                            }
                        }
                        if(data.sta==1 || data.sta==2) GetFlowButton_Content(false,true,false,false,false,true,true,glb_BillID);
                       // if(data.sta==3) GetFlowButton_Content(false,false,true,false,false,true,true,glb_BillID);//2014-04-16注销  审批完继续可以提交
                        if(data.sta==3) GetFlowButton_Content(true,false,true,false,false,true,true,glb_BillID);
...
function GetFlowButton_Content(glbBtn_IsShow_Tjsp,glbBtn_IsShow_Sp,glbBtn_IsShow_Qr,glbBtn_IsShow_Jd,glbBtn_IsShow_Qxjd,glbBtn_IsShow_Cxsp,glbBtn_IsShow_Record,billID)
{
    ...
    if(glbBtn_IsShow_Qr)
    {
        ...
        //2014-04-16 bsd new add 审批完成后，提交审批按钮可用 
        if(glbBillStatus==3)
        {
            glbBtn_IsShow_Tjsp=true;
        }
    }
...
//                document.getElementById('GlbFlowButtonSpan').innerHTML ="<input type='button' id='a' value='aa' />";
            }
            else
            {
             //  
