...
function getsubcompany(ControlID)	
{
          ...
          if(Array.length==2)
          {
             var url="../../../Pages/Common/SelectUserOrRole.aspx?ShowType=1&Subflag=sub";
          ...
          {
             var url="../../../Pages/Common/SelectUserOrRole.aspx?ShowType=2&Subflag=sub";
             var returnValue = window.showModalDialog(url, "", "dialogWidth=350px;dialogHeight=400px;scroll:no;");
             if(returnValue!="" &&  returnValue!=null &&  returnValue!="ClearInfo")
             {
                 var ID="";
...
function SelectUserOrRole(ControlID)
{

      var Array = ControlID.split(",");
      if(Array[0].indexOf("Role") >= 0)
      {
          if(Array.length==3)
          {
             var url="../../../Pages/Common/SelectUserOrRole.aspx?ShowType=1&OprtType=1";
             var returnValue = window.showModalDialog(url, "", "dialogWidth=350px;dialogHeight=400px;scroll:no;");
             if(returnValue!="" &&  returnValue!=null && returnValue!="ClearInfo")
             {
             var splitInfo=returnValue.split("|");
          ...
          {
             var url="../../../Pages/Common/SelectUserOrRole.aspx?ShowType=1&OprtType=2";
             var returnValue = window.showModalDialog(url, "", "dialogWidth=350px;dialogHeight=400px;scroll:no;");
             if(returnValue!="" &&  returnValue!=null &&  returnValue!="ClearInfo")
             {
                 var ID="";
        ...
        if(Array[0].indexOf("User") >= 0) 
         {
                ...
                if(Array.length==2)
                {
                    var url="../../../Pages/Common/SelectUserOrRole.aspx?ShowType=2&OprtType=1";
                    var returnValue = window.showModalDialog(url, "", "dialogWidth=350px;dialogHeight=400px;scroll:no;");
                    if(returnValue!="" &&  returnValue!=null  &&  returnValue!="ClearInfo")
                    {
                        var splitInfo=returnValue.split("|");
          ...
          {
             var url="../../../Pages/Common/SelectUserOrRole.aspx?ShowType=2&OprtType=2";
             var returnValue = window.showModalDialog(url, "", "dialogWidth=350px;dialogHeight=400px;scroll:no;");
             if(returnValue!="" &&  returnValue!=null  &&  returnValue!="ClearInfo")
             {
                 var ID="";
...
function alertdiv(ControlID,showtype)
{
      var Array = ControlID.split(",");
      if(Array[0].indexOf("Role") >= 0)
      {
          ...
          else
          {
             ...
             if(showtype=="2")
             {
                 url="../../../Pages/Common/SelectUserOrRole.aspx?ShowType=1&OprtType=2&mul=true";
             }
            else
            {
                url="../../../Pages/Common/SelectUserOrRole.aspx?ShowType=1&OprtType=2";
            }
