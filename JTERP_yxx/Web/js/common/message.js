...
popMsgObj.ShowMsg = function(msgInfo) {
    ...
    document.getElementById('mydiv').innerHTML = "<table width=\"310\" border=\"0\" cellspacing=\"10\" cellpadding=\"0\" ><tr><td width=\"290\" style=\"word-wrap:break-word;color:Black;\">" + popMsgObj.content + "</td> </tr></table><table width=\"200\"><tr><td align=\"right\"><img src=\"../../../Images/Button/closelabel.gif\" onclick=\"document.getElementById('mydiv').style.display='none';closeRotoscopingDiv(false,'divMsgShadow');\" /></td></tr></table>";
    document.getElementById('mydiv').style.display = 'block';
}
//调用方法三(字段,提示信息)
