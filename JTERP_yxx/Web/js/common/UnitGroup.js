...
//function CalCulateNum1(UsedUnitId, UsedNumId, NumId, UsedPrice, Price, SelPoint) //销售订单专用
//{
//    if ($("#" + UsedNumId).val() != "") 
//    {
//        $("#" + NumId).val(FormatAfterDotNumber(parseFloat(parseFloat($("#" + UsedUnitId).val().split('|')[1]) * parseFloat($("#" + UsedNumId).val())).toString(), parseInt(SelPoint)));
...
//    if (UsedPrice != "") 
//    {   
//        $("#" + UsedPrice).val(FormatAfterDotNumber(parseFloat(parseFloat(parseFloat($("#" + Price).val())).toString() / $("#" + UsedUnitId).val().split('|')[1]) ,parseInt(SelPoint)));
//    }
//}
