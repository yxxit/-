                    ...
                    if(typeof(msg.dataRecord)!='undefined')
                    {
                        ...
                        $.each(msg.dataRecord,function(i,item)
                        {
                            ...
                            if(item.StepNo==null || item.StepNo=='')
                            {
                                ...
                                tempRecordListHtml = tempRecordListHtml +'<tr><td bgcolor=\"#FFFFFF\" class=\"flowFont\">'+item.Operator+'</td><td bgcolor=\"#FFFFFF\" class=\"flowFont\">提交审批</td><td bgcolor=\"#FFFFFF\" class=\"flowFont\"></td><td bgcolor=\"#FFFFFF\" class=\"flowFont\">&nbsp;</td></tr>';
                            }
                            else
                            {
                                if(item.StepNo==0)
                                {
                                    tempRecordListHtml = tempRecordListHtml +'<tr><td bgcolor=\"#FFFFFF\" class=\"flowFont\">'+item.Operator+'</td><td bgcolor=\"#FFFFFF\" class=\"flowFont\">'+tempAction+'</td><td bgcolor=\"#FFFFFF\" class=\"flowFont\">'+tempStatus+'</td><td bgcolor=\"#FFFFFF\" class=\"flowFont\">'+item.Note+'</td></tr>';
                                }
                                else
                                {
                                    tempRecordListHtml = tempRecordListHtml +'<tr><td bgcolor=\"#FFFFFF\" class=\"flowFont\">'+item.Operator+'</td><td bgcolor=\"#FFFFFF\" class=\"flowFont\">'+tempAction+'</td><td bgcolor=\"#FFFFFF\" class=\"flowFont\">'+tempStatus+'</td><td bgcolor=\"#FFFFFF\" class=\"flowFont\">'+item.Note+'</td></tr>';
