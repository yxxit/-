...
//        {}
    ...
    for (i = 1; i < signFrame.rows.length; i++) {
        ...
        //var InC = "OutCount_SignItem_TD_Text_" + i;
...
//        if (document.getElementById(InC).value == "" || parseFloat(document.getElementById(InC).value) < 0) {
//            ifProductC = "1";
//        }
    ...
    if (parseFloat(document.getElementById("txtTotalCount").value) == 0) {
        isFlag = false;
        fieldText = fieldText + "红冲数量|";
        msgText = msgText + "红冲总量不能小于等于0|";
    }
//    if (ifProductC == "1") {
//        isFlag = false;
//        fieldText = fieldText + "红冲数量|";
...
newBatchNo.innerHTML = "<table border='0' cellspacing='0' cellpadding='0' width='100%'><input name='chk' id='PC_SignItem_TD_Text_" + rowID + "' value=\"" + BatchNo + "\" type='text' class=\"tdinput\"  style='width:90%'  /></td></tr></table>"; //添加列内容
