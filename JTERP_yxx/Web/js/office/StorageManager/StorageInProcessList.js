...
function DoSearch(currPage)
{
    ...
    var proname=document.getElementById("txtproname").value;//物品
    var time1= $("#time1").val();
    var time2= $("#time2").val();
   ...
   "&EFDesc=" + escape(EFDesc) +"&proname=" + escape(proname) +
   "&Flag=1"+"&time1="+escape(time1)+"&time2="+escape(time2);
                ...
                if (item.ID != null && item.ID != "")
                    $("<tr class='newrow'></tr>").append("<td height='22' align='center'>" + "<input id='OptionCheck_" + item.ID + "' name='Checkbox1'  value=" + item.ID + " onclick=IfSelectAll('Checkbox1','checkall')  type='checkbox'/>" + "</td>" +
                        ...
                        "<td height='22' align='center' title=\"" + item.TaskNo + "\">" + fnjiequ(item.TaskNo, 10) + "</td>" +
                         "<td height='22' align='center' title=\"" + item.TaskNo + "\">" + fnjiequ(item.productname, 10) + "</td>" +
                          "<td height='22' align='center' title=\"" + item.TaskNo + "\">" + fnjiequ(item.specification, 10) + "</td>" +
                           "<td height='22' align='center' title=\"" + item.TaskNo + "\">" + fnjiequ(item.codename, 10) + "</td>" +
