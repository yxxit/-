...
function AddOneRow()
{
    ...
    // 物品名称
    rowHtml+="<td class='cell'><input type='text' id='ProName"+rowID+"' readOnly onclick='popTechObj.ShowList("+rowID+");' class='tdinput' style='width:95%'  /><input id='hidProductName"+rowID+"' value='0' type='hidden' /></td>";

    // 物品编号
    rowHtml+="<td class='cell'><input id='ProductNo"+rowID+"'type='text' class='tdinput'  style='width:95%' /></td>";
