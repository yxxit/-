...
function DoSearch(currPage)
{
   ...
   var OtherCorpName=$("#txtOtherCorp").val();//20121123 添加 往来单位
...
//       }
   ...
   var UrlParam="&action="+action+
               ...
               "&OtherCorpName="+escape(OtherCorpName)+//20121123 添加 往来单位 
    ...
    function TurnToPage(pageIndex)
    {
           ...
           success: function(msg){
                    ...
                    $.each(msg.data,function(i,item){
                        ...
                        if(parseFloat(item.CountTotal)!=0&&parseFloat(item.CountTotal).toString()!="NaN")
                        {
                            total1+=parseFloat(item.CountTotal);
                        }
