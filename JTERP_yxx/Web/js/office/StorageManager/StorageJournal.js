...
function dosearch() {
    ...
    var hidurl = "StorageID=" + ddlStorage + "&ProductID=" + ProductID + "&StartDate=" + StartDate + "&EndDate=" + EndDate +
                 "&BatchNo=" + BatchNo + "&SourceType=" + SourceType + "&SourceNo=" + SourceNo +"&ProviderID="+ProviderID+
                 "&CreatorID=" + CreatorID + "&EFIndex=" + EFIndex + "&EFDesc=" + EFDesc +"&ckbIsM=" + ckbIsM;
    window.open("../../PrinttingModel/StorageManager/CrystalStorageJournalNew.aspx?" + hidurl, 'storagerpt');
}
