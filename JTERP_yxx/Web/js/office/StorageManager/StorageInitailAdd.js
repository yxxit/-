...
//         if (document.getElementById(ProductC).value == "" || parseFloat(document.getElementById(ProductC).value) <= parseFloat(0)) 
//        {
//            ifProductC = "1";
//        }
...
//    }
    ...
    if (ifUnitPrice == "1") {
        ...
        msgText = msgText + "请输入有效的数值（大于或等于0）|";
    }
    if (ifRemark == "1") {
        isFlag = false;
...
function AddRow(id, ProNo, ProdName,UnitName, Specification, UnitPrice,UnitID,IsBatchNo)//增加一个空白行
{
    ...
    newFitNametd.innerHTML = "<table border='0' cellspacing='0' cellpadding='0' width='100%'><input type=\"text\" id=\"ProductNo_SignItem_TD_Text_" + rowID + "\" value=\"" + ProNo + "\" title=\"" + id + "\"  class=\"tdinput\"  readonly=\"readonly\" onclick=\"popTechObj.ShowListSpecial(this.id,'');\" style='width:100%'  /></td></tr></table>"; //添加列内容

    var newFitDesctd = newTR.insertCell(3); //添加列:物品名称
    newFitDesctd.className = "cell";
    newFitDesctd.id = 'SignItem_TD_ProductName_' + rowID;
    newFitDesctd.innerHTML = "<table border='0' cellspacing='0' cellpadding='0' width='100%'><input id='ProductName_SignItem_TD_Text_" + rowID + "' value=\"" + ProdName + "\" type='text' class=\"tdinput\" readonly=\"readonly\"   style='width:100%' /></td></tr></table>"; ; //添加列内容
    ...
    newFitNametd.innerHTML = "<input type=\"text\" id=\"BaseUnitID_SignItem_TD_Text_" + rowID + "\" value=\"" + UnitName + "\" title=\""+UnitID+"\" class=\"tdinput\" readonly=\"readonly\"  style='width:85%'  />"; //添加列内容
    ...
    newFitDesctd.innerHTML = "<input name='chk' id='UnitPrice_SignItem_TD_Text_" + rowID + "' value=\"" + ReUnitPrice + "\" type='text' class=\"tdinput\"  style='width:85%' onblur=\"check(this.id);Number_roundBegin(this,2);TotalPrice_a(this.id);CountNum();\"/>"; //添加列内容

    var newFitNametd = newTR.insertCell(10); //添加列:物品总价（金额）
    newFitNametd.className = "cell";
    newFitNametd.id = 'SignItem_TD_TotalPrice_' + rowID;
    newFitNametd.innerHTML = "<input type=\"text\" id=\"TotalPrice_SignItem_TD_Text_" + rowID + "\" value=\"0\" class=\"tdinput\"  style='width:85%' readonly=\"readonly\" />"; //添加列内容
...
colProductNo.innerHTML = "<table border=\"0\" cellspacing=\"0\" cellpadding=\"0\" width=\"100%\">" +
                            "<tr><td><input id=\"ProductNo_SignItem_TD_Text_" + rowID + "\" onblur=\"SetMatchProduct(" + rowID + ",this.value,'ProductNo_SignItem_TD_Text_" + rowID + "');\" onkeydown=\"" + SetFunNo + "\"  class=\"tdinput\"  type=\"text\"></td>" +
    ...
    newFitDesctd1.innerHTML = "<table border='0' cellspacing='0' cellpadding='0' width='100%'><input id='ProductName_SignItem_TD_Text_" + rowID + "' value=\"\" type='text' class=\"tdinput\" readonly=\"readonly\"   style='width:100%' disabled /></td></tr></table>"; ; //添加列内容
    ...
    newFitDesctd2.innerHTML = "<table border='0' cellspacing='0' cellpadding='0' width='100%'><input id='Specification_SignItem_TD_Text_" + rowID + "' value=\"\" type='text' class=\"tdinput\" readonly=\"readonly\"   style='width:100%' disabled /></td></tr></table>"; //添加列内容

    var newFitNametd = newTR.insertCell(5); //添加列:jiben单位
    newFitNametd.className = "cell";
    newFitNametd.id = 'SignItem_TD_UnitID_' + rowID;    
    newFitNametd.innerHTML = "<table border='0' cellspacing='0' cellpadding='0' width='100%'><input type=\"text\" id=\"BaseUnitID_SignItem_TD_Text_" + rowID + "\" value=\"\" title=\"\" class=\"tdinput\" readonly=\"readonly\"  style='width:95%' disabled /></td></tr></table>"; //添加列内容

    var newFitNametd = newTR.insertCell(6); //添加列:jiben数量
    newFitNametd.className = "tdinput";
    newFitNametd.id = 'SignItem_TD_ProductCount_' + rowID;
    newFitNametd.innerHTML = "<table border='0' cellspacing='0' cellpadding='0' width='100%'><input type=\"text\" id=\"BaseProductCount_SignItem_TD_Text_" + rowID + "\" value=\"\"  class=\"tdinput\" readonly=\"readonly\"  style='width:90%' onblur=\"check(this.id);Number_roundBegin(this,2);TotalPrice(this.id);CountNum();\"   onkeydown=\"SetEventFocus('BaseProductCount_SignItem_TD_Text_','ProductNo_SignItem_TD_Text_'," + rowID + ",true);\"  /></td></tr></table>"; //添加列内容
    ...
    newShuLiangtd.className = "tdinput";
    newShuLiangtd.id = 'SignItem_TD_ProductCount_' + rowID;
    newShuLiangtd.innerHTML = "<input type=\"text\" id=\"OutCount_SignItem_TD_Text_" + rowID + "\" value=\"\"  class=\"tdinput\"  style='width:90%' onblur=\"check(this.id);Number_roundBegin(this,2);TotalPrice_z(this.id);CountNum();\"    onkeydown=\"SetEventFocus('OutCount_SignItem_TD_Text_','ProductNo_SignItem_TD_Text_'," + rowID + ",true);\"   />"; //添加列内容
...
//    var ReUnitPrice = NumberSetPoint(UnitPrice);
    ...
    newFitDesctd.className = "cell";
    newFitDesctd.id = 'SignItem_TD_UnitPrice_' + rowID;
    newFitDesctd.innerHTML = "<table border='0' cellspacing='0' cellpadding='0' width='100%'><input name='chk' id='UnitPrice_SignItem_TD_Text_" + rowID + "' value=\"\" type='text' class=\"tdinput\"  style='width:95%' onblur=\"check(this.id);Number_roundBegin(this,2);TotalPrice_a(this.id);CountNum();\"/></td></tr></table>"; //添加列内容

    var newFitNametd = newTR.insertCell(10); //添加列:物品总价（金额）
    newFitNametd.className = "cell";
    newFitNametd.id = 'SignItem_TD_TotalPrice_' + rowID;
    newFitNametd.innerHTML = "<table border='0' cellspacing='0' cellpadding='0' width='100%'><input type=\"text\" id=\"TotalPrice_SignItem_TD_Text_" + rowID + "\" value=\"\" class=\"tdinput\"  style='width:95%' readonly=\"readonly\" /></td></tr></table>"; //添加列内容
...
//}
    ...
    newFitDesctd.className = "cell";
    newFitDesctd.id = 'SignItem_TD_Remark_' + rowID;
    newFitDesctd.innerHTML = "<table border='0' cellspacing='0' cellpadding='0' width='100%'><input name='chk' id='Remark_SignItem_TD_Text_" + rowID + "' value=\"\" type='text' class=\"tdinput\"  style='width:90%'  /></td></tr></table>"; //添加列内容

    var newBatchNo = newTR.insertCell(12); //添加列:pici
    newBatchNo.className = "cell";
    newBatchNo.id = 'SignItem_TD_BatchNo_' + rowID;
    newBatchNo.innerHTML = "<table border='0' cellspacing='0' cellpadding='0' width='100%'><input name='chk' id='BatchNo_SignItem_TD_Text_" + rowID + "' value=\"\" type='text' class=\"tdinput\"  style='width:90%'  /></td></tr></table>"; //添加列内容
    newBatchNo.style.display="none";
    
    var newJiBen_DanJia = newTR.insertCell(13); //添加列:基本单价
    newJiBen_DanJia.className = "cell";
    newJiBen_DanJia.id = 'TD_JiBen_DanJia_' + rowID;
    newJiBen_DanJia.innerHTML = "<table border='0' cellspacing='0' cellpadding='0' width='100%'><input name='chk' id='JiBen_DanJia_" + rowID + "' value=\"\" type='text' class=\"tdinput\"  style='width:90%'  /></td></tr></table>"; //添加列内容
    newJiBen_DanJia.style.display="none";
...
if(document.getElementById("hidMoreUnit").value == "true")
{
    ...
    newFitNametd.innerHTML = "<table border=\"0\" cellspacing=\"0\" cellpadding=\"0\" width=\"100%\">" +
                            "<tr><td><input id=\"ProductNo_SignItem_TD_Text_" + rowID + "\" value=\"" + ProductNo + "\" title=\"" + ProductID + "\"  onblur=\"SetMatchProduct(" + rowID + ",this.value,'ProductNo_SignItem_TD_Text_" + rowID + "');\" onkeydown=\"" + SetFunNo + "\"  class=\"tdinput\"  type=\"text\"></td>" +
                            "<td align=\"right\"><img style=\"cursor: hand\"  onclick=\"BeforeShowListSpecial('ProductNo_SignItem_TD_Text_" + rowID + "','');\"  align=\"absMiddle\" src=\"../../../Images/search.gif\" height=\"21\"></td>" +
    ...
    newFitDesctd.className = "cell";
    newFitDesctd.id = 'SignItem_TD_ProductName_' + rowID;
    newFitDesctd.innerHTML = "<table border='0' cellspacing='0' cellpadding='0' width='100%'><input id='ProductName_SignItem_TD_Text_" + rowID + "' value=\"" + ProductName + "\" type='text' class=\"tdinput\" readonly=\"readonly\"   style='width:100%' disabled /></td></tr></table>"; ; //添加列内容

    var newFitDesctd = newTR.insertCell(4); //添加列:物品规格
    newFitDesctd.className = "cell";
    newFitDesctd.id = 'SignItem_TD_Specification_' + rowID;
    newFitDesctd.innerHTML = "<table border='0' cellspacing='0' cellpadding='0' width='100%'><input id='Specification_SignItem_TD_Text_" + rowID + "' value=\"" + Specification + "\" type='text' class=\"tdinput\" readonly=\"readonly\"   style='width:100%' disabled /></td></tr></table>"; ; //添加列内容

    var newFitNametd = newTR.insertCell(5); //添加列:单位
    newFitNametd.className = "cell";
    newFitNametd.id = 'SignItem_TD_UnitID_' + rowID;
    newFitNametd.innerHTML = "<table border='0' cellspacing='0' cellpadding='0' width='100%'><input type=\"text\" id=\"BaseUnitID_SignItem_TD_Text_" + rowID + "\" value=\"" + UnitID + "\" class=\"tdinput\" readonly=\"readonly\"  style='width:95%' disabled /></td></tr></table>"; //添加列内容

    var newFitNametd = newTR.insertCell(6); //添加列:入库数量
    newFitNametd.className = "tdinput";
    newFitNametd.id = 'SignItem_TD_ProductCount_' + rowID;
    newFitNametd.innerHTML = "<table border='0' cellspacing='0' cellpadding='0' width='100%'><input type=\"text\" id=\"BaseProductCount_SignItem_TD_Text_" + rowID + "\" value=\"" + NumberSetPoint(ProductCount) + "\"  class=\"tdinput\"  style='width:90%'  onblur=\"check(this.id);Number_roundBegin(this,2);TotalPrice(this.id);CountNum();\"  onkeydown=\"SetEventFocus('BaseProductCount_SignItem_TD_Text_','ProductNo_SignItem_TD_Text_'," + rowID + ",true);\"   /></td></tr></table>"; //添加列内容
...
newShuLiangtd.className = "tdinput";
newShuLiangtd.id = 'SignItem_TD_ProductCount_' + rowID;
newShuLiangtd.innerHTML = "<table border='0' cellspacing='0' cellpadding='0' width='100%'><input type=\"text\" id=\"OutCount_SignItem_TD_Text_" + rowID + "\" value=\"" + NumberSetPoint(UsedUnitCount) + "\"  class=\"tdinput\"  style='width:90%' onblur=\"check(this.id);Number_roundBegin(this,2);TotalPrice_z(this.id);CountNum();\"    onkeydown=\"SetEventFocus('OutCount_SignItem_TD_Text_','ProductNo_SignItem_TD_Text_'," + rowID + ",true);\"    /></td></tr></table>"; //添加列内容
...
else
{
    ...
    newFitDesctd.className = "cell";
    newFitDesctd.id = 'SignItem_TD_UnitPrice_' + rowID;
    newFitDesctd.innerHTML = "<table border='0' cellspacing='0' cellpadding='0' width='100%'><input id='UnitPrice_SignItem_TD_Text_" + rowID + "' value=\"" + NumberSetPoint(danjia) + "\" type='text' class=\"tdinput\"  style='width:95%'  onblur=\"check(this.id);Number_roundBegin(this,2);TotalPrice_a(this.id);CountNum();\"/></td></tr></table>"; //添加列内容

    var newFitNametd = newTR.insertCell(10); //添加列:物品总价（金额）
    newFitNametd.className = "cell";
    newFitNametd.id = 'SignItem_TD_TotalPrice_' + rowID;
    newFitNametd.innerHTML = "<table border='0' cellspacing='0' cellpadding='0' width='100%'><input type=\"text\" id=\"TotalPrice_SignItem_TD_Text_" + rowID + "\" value=\"" + NumberSetPoint(TotalPrice) +"\"  class=\"tdinput\"  style='width:95%' readonly=\"readonly\" /></td></tr></table>"; //添加列内容
...
//绑定单位组
    ...
    newFitDesctd.className = "cell";
    newFitDesctd.id = 'SignItem_TD_Remark_' + rowID;
    newFitDesctd.innerHTML = "<table border='0' cellspacing='0' cellpadding='0' width='100%'><input name='chk' id='Remark_SignItem_TD_Text_" + rowID + "' value=\"" + Remark + "\" type='text' class=\"tdinput\"  style='width:90%'  /></td></tr></table>"; //添加列内容

    var newBatchNo = newTR.insertCell(12); //添加列:pici
    newBatchNo.className = "cell";
    newBatchNo.id = 'SignItem_TD_BatchNo_' + rowID;
    newBatchNo.innerHTML = "<table border='0' cellspacing='0' cellpadding='0' width='100%'><input name='chk' id='BatchNo_SignItem_TD_Text_" + rowID + "' value=\"" + IsBatchNo + "\" type='text' class=\"tdinput\"  style='width:90%'  /></td></tr></table>"; //添加列内容
    newBatchNo.style.display="none";
    
    var newJiBen_DanJia = newTR.insertCell(13); //添加列:基本单价
    newJiBen_DanJia.className = "cell";
    newJiBen_DanJia.id = 'TD_JiBen_DanJia_' + rowID;
    newJiBen_DanJia.innerHTML = "<table border='0' cellspacing='0' cellpadding='0' width='100%'><input name='chk' id='JiBen_DanJia_" + rowID + "' value=\"" + UnitPrice + "\" type='text' class=\"tdinput\"  style='width:90%'  /></td></tr></table>"; //添加列内容
    newJiBen_DanJia.style.display="none";
}
...
function checku(str) {
    ...
    if (document.getElementById(str).value.length > 0) {
        if (!IsNumeric(document.getElementById(str).value)) {
            isFlag = false;
            fieldText = fieldText + "输入有误|";
            msgText = msgText + "输入有误，请输入有效的数值（大于或等于0）！";
            document.getElementById(str).value = "0";
            document.getElementById(str).focus();
        }
    }
...
else
{
   ...
   newShuLiangtd.style.display = "none";
    ...
    newFitDesctd.className = "cell";
    newFitDesctd.id = 'SignItem_TD_UnitPrice_' + rowID;
    newFitDesctd.innerHTML = "<input name='chk' id='UnitPrice_SignItem_TD_Text_" + rowID + "' value=\"" +NumberSetPoint(UnitPrice) + "\" type='text' class=\"tdinput\"  style='width:95%' onblur=\"checku(this.id);Number_roundBegin(this,2);TotalPrice_a(this.id);CountNum();\"/>"; //添加列内容
