...
function AddRow() {
    ...
    cellProductNo.innerHTML = "<table border='0' cellspacing='0' cellpadding='0' width='100%'><input type=\"text\" id=\"txtProductNo_" + RowID + "\" class=\"tdinput tboxsize textAlign\" value=\"\"  onclick=\"getProdcutList(" + RowID + ");\"  readonly /></td></tr></table>";
    ...
    newBatchNotd.innerHTML = "<select  id='BatchNo_SignItem_TD_Text_" + RowID + "'  disabled=\"true\" />"; //添加列内容
...
function fnSelectProductInfo(ID, ProductNo, ProductName, ProductSpec, NowCount, ProdcutUnitName
    ...
    if ($("#HiddenMoreUnit").val() == "True") {
        ...
        else//页面查看时
        {
            ...
            document.getElementById("BaseCount_SignItem_TD_Text_" + rowid).value = parseFloat(ChenkCount).toFixed($("#HiddenPoint").val()); //基本数量
