       ...
       $.ajax({
           ...
           {    
                   ...
                   $.each(msg.data,function(i,item){
                        ...
                        if(parseFloat( item.DTotalPrice)!=0&&parseFloat( item.DTotalPrice).toString()!="NaN")
                        {
                            total2+=parseFloat( item.DTotalPrice);
                        }
                        $("<tr class='newrow'></tr>").append(
                            ...
                            "<td align=\"center\" ><a href=\"StorageBorrowAdd.aspx?ModuleID="+document.getElementById("MoudleID").value+"&action=EDIT&id="+item.ID+"&BorrowRealNo="+item.BorrowNo+"\">"+item.BorrowNo+"</a></td>"+
                             ...
                             "<td align=\"center\" >"+parseFloat( item.DTotalPrice).toFixed(2)+"</td>"+
