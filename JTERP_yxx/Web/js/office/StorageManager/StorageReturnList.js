           ...
           {    
              document.getElementById("chk_StorageList").checked=false;
                    ...
                    $.each(msg.data,function(i,item){
                        if(item!=null && item!="")
                        {
                          if(parseFloat( item.ReturnCount)!=0&&parseFloat( item.ReturnCount).toString()!="NaN")
                        {
                            total1+=parseFloat( item.ReturnCount);
                        }
                        if(parseFloat( item.TotalPrice)!=0&&parseFloat( item.TotalPrice).toString()!="NaN")
                        {
                        ...
                        $("<tr class='newrow'></tr>").append(
                         ...
                         "<td align=\"center\" >"+fnjiequ(item.ProductName,15)+"</td>"+
                         "<td align=\"center\" >"+parseFloat(item.ReturnCount).toFixed(2)+"</td>"+
                   ...
                   $("<tr class='newrow'></tr>").append(
                         ...
                         "<td align=\"center\" ></td>"+
                         "<td align=\"center\" ></td>"+
                         "<td align=\"center\" >"+parseFloat(total1).toFixed(2)+"</td>"+
                         "<td align=\"center\" >"+parseFloat(total2).toFixed(2)+"</td>"+
                         "<td align=\"center\" ></td>"+
                         "<td align=\"center\" ></td>"+
                        "<td align=\"center\" ></td>"+
                        "<td align=\"center\" ></td>"+
