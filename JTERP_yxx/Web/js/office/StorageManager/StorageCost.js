        ...
        success: function(msg) {
            ...
            $.each(msg.data, function(i, item) {
                ...
                $("<tr class='newrow'></tr>").append(createTd(item.YearMonth) +
                  ...
                  createTd("<span id=\"span_PeriodEndCost_" + i.toString() + "\">" + ToFixed(item.PeriodEndCost)+ "</span>" + "<a href=\"javascript:void(0);\" onclick=\"editPeriodEndCost(" + item.ID + ",'" + item.PeriodEndCost + "'," + item.PeriodEndCount + "," + i + ");\">修改</a>") +//钱锋锋 2010-10-19
    ...
    $.ajax({
        ...
        success: function(msg) {
            if (msg.result) {
                ...
                $("#span_PeriodEndCost_" + index).html(ToFixed(parseFloat(cost) ));//钱锋锋 2010-10-19
