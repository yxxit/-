...
//       }
   ...
   "&ProductName="+escape($("#txtProductName").val())+
    ...
    {   
           ...
           success: function(msg){
                    ...
                    $.each(msg.data,function(i,item){
                        ...
                        {
                         if(parseFloat( item.ProductCount)!=0&&parseFloat( item.ProductCount).toString()!="NaN")
                        {
                            total1+=parseFloat( item.ProductCount);
                        }
                        if(parseFloat( item.CostPrice)!=0&&parseFloat( item.CostPrice).toString()!="NaN")
                        {
                            total2+=parseFloat( item.CostPrice);
                        }
...
//                        "<td height='22' align='center' title=\""+item.BatchNo+"\">"+ fnjiequ(item.BatchNo,10) +"</td>"+
                        ...
                        "<td height='22' align='center' title=\""+parseFloat(item.ProductCount).toFixed(point)+"\">"+parseFloat(item.ProductCount).toFixed(point)+"</td>"+
                        "<td height='22' align='center' title=\""+parseFloat(item.CostPrice).toFixed(point)+"\">"+parseFloat(item.CostPrice).toFixed(point)+"</td>"+
