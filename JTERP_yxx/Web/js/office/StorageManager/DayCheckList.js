           ...
           if(!CheckInput())
           {
               ...
               success: function(msg){
                        ...
                        $.each(msg.data,function(i,item){
                            if(item.daytime != null && item.daytime != "" && item.daytime !="undefined")
                            {
                                if(parseFloat(item.productcount) != 0)
                                {
                                    pcount += parseFloat(item.productcount);
                                }
                                ...
                                if(parseFloat(item.incount) != 0)
                                {
                                  ...
                                  if(parseFloat(item.storageincount) != 0)
                                {
                                    innum += parseFloat(item.storageincount);
                                }
                                  if(parseFloat(item.storageoutcount) != 0)
                                {
                                    outnum += parseFloat(item.storageoutcount);
                                }
                                ...
                                $("<tr class='newrow'></tr>").append("<td height='22' align='center'>"+item.daytime+"</td>"+
                                ...
                                "<td height='22' align='center'>"+parseFloat(item.productcount).toFixed( $("#point").val())+"</td>"+
                                "<td height='22' align='center'>"+parseFloat(item.storageoutcount).toFixed( $("#point").val())+"</td>"+
                                "<td height='22' align='center'>"+parseFloat(item.storageincount).toFixed( $("#point").val())+"</td>"+
                                "<td height='22' align='center'>"+parseFloat(item.roadcount).toFixed( $("#point").val())+"</td>"+
                                "<td height='22' align='center'>"+parseFloat(item.ordercount).toFixed( $("#point").val())+"</td>"+
                                "<td height='22' align='center'>"+parseFloat(item.incount).toFixed( $("#point").val())+"</td>"+
                                "<td height='22' align='center'>"+parseFloat(item.outcount).toFixed( $("#point").val())+"</td>").appendTo($("#pageDataList1 tbody"));
                            }
                       });
