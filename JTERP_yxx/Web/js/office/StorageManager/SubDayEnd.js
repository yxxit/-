...
function fnLinkEdit(ProductID,BatchNo,DailyDate,DeptID)
{
    //检索条件
 ...
 window.location.href='SubDayEndDetails.aspx?'+URLParams;
}
...
currentPageIndex = pageIndex;
    ...
    $.ajax({
        ...
        url:  '../../../Handler/Office/StorageManager/SubDayEnd.ashx',//目标地址
        cache:false,
        data: URLParams,
        ...
        success: function(msg){
                ...
                $.each(msg.data,function(i,item){
                    ...
                    $("<tr class='newrow'></tr>").append("<td height='22' align='center'><a href='#' onclick=fnLinkEdit('"+item.ProductID+"','"+item.BatchNo+"','"+item.DailyDate+"','"+item.DeptID+"')>"+ item.DailyDate +"</a></td>"+
...
var day=document .getElementById ("txtStartPlanDate").value.Trim();
    ...
    $.ajax({
        type: "POST",
        url: "../../../Handler/Office/StorageManager/SubDayEnd.ashx",
        dataType: 'json', //返回json格式数据
        cache: false,
        data: URLParams,
        beforeSend: function() {
