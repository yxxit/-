            ...
            $.each(msg.data, function(i, item) {
                if (item != null && item != "") {
                    ...
                    if ($("#txtIsMoreUnit").val() == "1") {
                        ...
                        html += "<td  class=\"cell\" id=\"tboxUsedUnit_listtd_" + item.SortNo + "\" disabled=\"true\"></td>";
                    }

                    //计量单位开启
                    if ($("#txtIsMoreUnit").val() == "1") {
                        html += "<td  class=\"cell\" ><input type=\"hidden\" id=\"txtTransferPrice_" + item.SortNo + "\" value=\"" + parseFloat(item.TranPrice).toFixed(2) + "\" disabled=\"true\"/>";
                    ...
                    if ($("#txtIsMoreUnit").val() == "1") {
                        ...
                        html += "<td class=\"cell\" ><input type=\"text\" id=\"txtTransferCount_" + item.SortNo + "\" class=\"tdinput tboxsize textAlign\" value=\"" + parseFloat(item.TranCount).toFixed(2) + "\"  onblur=\"_cDetail(" + item.SortNo + ")\"  onchange=\"Number_round(this,"+selPoint+")\" disabled=\"true\"/></td>";
                    }
                    ...
                    html += "<td  class=\"cell\" ><input type=\"text\" id=\"txtInCount_" + item.SortNo + "\" class=\"tdinput tboxsize textAlign\" value=\"" + getDefaultInCount(item.InCount, item.OutCount, item.ExRate) + "\"    onblur=\"cInPrice(" + getDefaultInCount(item.InCount, item.OutCount, item.ExRate) + "," + item.SortNo + ");\" onchange=\"Number_round(this,"+selPoint+")\" disabled=\"true\"/></td>";
