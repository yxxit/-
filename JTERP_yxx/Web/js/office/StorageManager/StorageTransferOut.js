...
function AddRow() {
    ...
    cellTransferCount.innerHTML = "<input type=\"text\" id=\"txtTransferCount_" + RowID + "\" class=\"tdinput tboxsize textAlign\" value=\"\"  onblur=\"_cDetail(" + RowID + ")\"  disabled=\"true\" />";
        ...
        success: function(msg) {
            ...
            $.each(msg.data, function(i, item) {
                ...
                if (item != null && item != "") {
                    ...
                    html += "<td  class=\"cell\" ><input type=\"text\" id=\"txtOutCount_" + item.SortNo + "\" class=\"tdinput tboxsize textAlign\" value=\"" + getDefaultOutCount(item.OutCount, item.UsedUnitCount, item.TranCount) + "\"   onblur=\"cOutPrice(" + getDefaultOutCount(item.OutCount, item.UsedUnitCount, item.TranCount) + "," + item.SortNo + ")\" onchange=\"Number_round(this,2)\" disabled=\"true\"/></td>";
