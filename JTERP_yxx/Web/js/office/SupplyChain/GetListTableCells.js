...
function TurnToPage(pageIndex) 
{
    ...
    $.ajax({
        ...
        url: "../../../Handler/Office/SupplyChain/TableCellsInfo.ashx", //目标地址
        cache: false,
        data: strUrl,
...
{
    window.location.href='AddTableCells.aspx?ModuleID='+escape(ModuleID)+'&ModelNo='+escape(ModelNo);
}
//更新打开窗口
...
function Show()
{
    window.location.href='AddTableCells.aspx?ModuleID='+escape(ModuleID);
}
