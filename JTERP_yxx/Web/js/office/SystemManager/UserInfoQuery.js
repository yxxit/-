    ...
    $.ajax({
        ...
        success: function(msg) {
            ...
            $.each(msg.data, function(i, item) {
                ...
                var te = item.RoleName + "|" + item.RoleRangeName;
                if (item.UserID != null && item.UserID != "")
                    $("<tr class='newrow'></tr>").append("<td height='22' align='center'>" + "<input id='Checkbox1' name='Checkbox1'  value=" + temp + " onclick=IfSelectAll('Checkbox1','btnAll') type='checkbox'/>" + "</td>" +
                        ...
                        "<td height='22' align='center'>" + item.EmployeeName.substring(0, 10) + "</td>" +
                        "<td height='22' align='center'>" + item.DeptName.substring(0, 10) + "</td>" +
                        "<td height='22' align='center'>" + te + "</td>" +
...
function Fun_Search_UserInfo(currPage) {
    ...
    if (!isFlag) {
        ...
        search+="&EmployeeName="+escape(EmployeeName);
        //设置检索条件
