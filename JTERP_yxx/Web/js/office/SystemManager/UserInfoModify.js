...
function DoBack()
{
    ...
    window.onload = function() {
        ...
        if (flag == "1") {
            ...
            document.getElementById("usbkey").style.display = "";
        }
        else {
     ...
     function ReadUsbSN() 
{
    ...
    if(bfUsb==true)
    {
        ...
        var intCount=0;
                 //说明：在VS2008中添加该句，并且取消浏览器中禁用脚本调试选项（浏览器高级设置里）

        //并在VS2008里运行该代码时，程序会停止在该行（该语句主要用于调试用）
        for (;!e.atEnd();e.moveNext ())
        {
            ...
            if(sn.indexOf("VID")>0)
            {
                ...
                intCount=intCount+1;
                document.getElementById("usbkey").value=strSN;
            }  
        } 
    }
