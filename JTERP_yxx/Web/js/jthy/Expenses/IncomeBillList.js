...
function NewBilling()
{
    ...
    window.parent.addTab(null,'8880101','新建收款单','Pages/JTHY/Expenses/IncomeBill_Add.aspx?ModuleID=8880501');
...
/**
    跳转到添加页面
*/
function SelectDept(id,incomeNo){
	...
	window.parent.addTab(null,'8880101','新建收款单','Pages/JTHY/Expenses/IncomeBill_Add.aspx?ModuleID=8880501&intMasterID='+escape(id)+'&incomeNo='+incomeNo+'');
}
...
function TurnToPage(pageIndex)
{
    ...
    $.ajax({ 
              type:"POST",
              url: "../../../Handler/JTHY/Expenses/IncomeBill_list.ashx?"+postParam,
              dataType:'json',//返回json格式数据
              cache:false,
              beforeSend:function()
              { 
        ...
        success: function(data)
        {
            ...
            $.each(data.data, function(i, item) {
                if (item.ID != null && item.ID != "") {
                            ...
                            "</td>"+
                            "<td height='22'  align='center'><a href='#' onclick=\"SelectDept('" + item.ID + "','" + item.InComeNo + "')\">" + item.InComeNo + "</a></td>" +
                            "<td height='22' align='center' ><span title=\"" + item.CustName + "\">"+ item.CustName +"</span></td>"+
                                                     
                            "<td height='22'  align='center'>" + item.BillingID + "</td>"+                                                       
                            "<td height='22'  align='center'>" + item.AcceDate + "</td>"+
