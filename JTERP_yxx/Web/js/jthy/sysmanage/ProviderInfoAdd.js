        ...
        success: function(msg) {
            ...
            $.each(msg.data, function(i, item) {
                if (item.ID != null && item.ID != "") {
                    ...
                    $("#txtCustType").attr("value", item.CustType); //供应商类别
                    ...
                    if (item.CustType != 0 && item.CustType != 5) item.CustType = 0; // 强制数据类型转换
                    $("#txtCustType").attr("value", item.CustType); //供应商简称
...
function InsertProviderInfo() {
    ...
    var CustType = document.getElementById("txtCustType").value.Trim();
    ...
    $.ajax({
        ...
        data: "custNo=" + escape(custNo) + "&custName=" + escape(custName) + "&custNam=" + escape(custNam) + "\
                        &pYShort=" + escape(pYShort) + "&CustType=" + escape(CustType) + "&manager=" + escape(manager) + "&managerName=" + escape(managerName) + "&areaID=" + escape(areaID) + "\
