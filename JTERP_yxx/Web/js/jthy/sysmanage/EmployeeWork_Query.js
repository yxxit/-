...
* 查询在职人员
*/
function SearchEmployeeWork(currPage)
{
    if(!CheckInput())
    {
        return;
    ...
    //search += "&EnterEndDate=" + document.getElementById("txtEnterEndDate").value;
...
//                     }                                          
                        $("<tr class='newrow'></tr>").append("<td height='22' align='center'><a href='" + GetLinkParam() + "&ID=" + item.ID + "')>" + item.EmployeeNo + "</a></td>" //编号
                            ...
                            + "<td height='22' align='center' style='display:none'>" + item.PositionName + "</td>"//职称
                            + "<td height='22' align='center'>" + item.EntryDate + "</td>").appendTo($("#tblDetailInfo tbody")//入职时间
                        );
                    }
            });
            //页码
...
function GetLinkParam()
{
    ...
    linkParam = "EmployeeInfo_Add.aspx?FromPage=1&ModuleID=" + ModuleID 
