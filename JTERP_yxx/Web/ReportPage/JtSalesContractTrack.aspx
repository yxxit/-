<%@ Page Language="C#" AutoEventWireup="true" CodeFile="JtSalesContractTrack.aspx.cs" Inherits="ReportPage_JtSalesContractTrack" %>
...
<head runat="server">
    ...
    <script src="JtSalesContractTrack.js" type="text/javascript"></script>
...
<%--<uc3:CustOrProvider_Per ID="CustOrProvider_Per" runat="server" />--%>
    ...
    <input  type="hidden" runat="server"  ID="txtCompanyCD" value="jthy4" />
       <table id="headerTable">
          ...
          <tr>
            <td colspan="10" align="center"><input type="button" runat="server" ID="btnLoad" value="检索" />
