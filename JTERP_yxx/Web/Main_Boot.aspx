<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Main_Boot.aspx.cs" Inherits="Main123" %>
...
<link rel="stylesheet" href="boot20140311/css/bootstrap.min.css" />
<link rel="stylesheet" href="boot20140311/css/bootstrap-responsive.min.css" />
<link rel="stylesheet" href="boot20140311/css/fullcalendar.css" />
<link rel="stylesheet" href="boot20140311/css/matrix-style.css" />
<link rel="stylesheet" href="boot20140311/css/matrix-media.css" />
<link href="boot20140311/font-awesome/css/font-awesome.css" rel="stylesheet" />
<link rel="boot20140311/stylesheet" href="boot20140311/css/jquery.gritter.css" />
...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
  <ul>
    ...
    <li class="submenu"> <a href="#"><i class="icon icon-th-list"></i> <span>系统管理</span> <span class="label label-important">3</span></a>
      <ul>
        <li><a href="Login.aspx">退出登录</a></li>
        <li><a href="error.html">错误日志</a></li>
        <li><a href="Login.aspx">Form with Wizard</a></li>
      </ul>
    </li>
...
<script src="boot20140311/js/excanvas.min.js"></script> 
<script src="boot20140311/js/jquery.min.js"></script> 
<script src="boot20140311/js/jquery.ui.custom.js"></script> 
<script src="boot20140311/js/bootstrap.min.js"></script> 
<script src="boot20140311/js/jquery.flot.min.js"></script> 
<script src="boot20140311/js/jquery.flot.resize.min.js"></script> 
<script src="boot20140311/js/jquery.peity.min.js"></script> 
<script src="boot20140311/js/fullcalendar.min.js"></script> 
<script src="boot20140311/js/matrix.js"></script> 
<script src="boot20140311/js/matrix.dashboard.js"></script> 
<script src="boot20140311/js/jquery.gritter.min.js"></script> 
<script src="boot20140311/js/matrix.interface.js"></script> 
<script src="boot20140311/js/matrix.chat.js"></script> 
<script src="boot20140311/js/jquery.validate.js"></script> 
<script src="boot20140311/js/matrix.form_validation.js"></script> 
<script src="boot20140311/js/jquery.wizard.js"></script> 
<script src="boot20140311/js/jquery.uniform.js"></script> 
<script src="boot20140311/js/select2.min.js"></script> 
<script src="boot20140311/js/matrix.popover.js"></script> 
<script src="boot20140311/js/jquery.dataTables.min.js"></script> 
<script src="boot20140311/js/matrix.tables.js"></script> 
