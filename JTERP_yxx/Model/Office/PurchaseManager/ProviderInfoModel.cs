...
namespace XBase.Model.Office.PurchaseManager
{
    ...
    public class ProviderInfoModel
    {
        ...
        private DateTime? _usedata;
        private DateTime? _certidata;
        private DateTime? _wardata;
        private DateTime? _powerdata;
        private string _pagestatus;
        private DateTime? _gmspdata;
        private string _billunit; //开票单位
       
        private string _category;//所属分类

        //-----附件属性  20140402 刘锦旗--------//
        public string AnnFileName { set; get; }
        
        public string AnnAddr{ set; get; }

        public string AnnRemark{ set; get; }
        ...
        /// 经营许可证有效期
        /// </summary>
        public DateTime? Certidata
        {
            get { return _certidata; }
            set { _certidata = value; }
        }

        /// <summary>
        /// 质保书有效期
        /// </summary>
        public DateTime? Wardata
        {
            get { return _wardata; }
            set { _wardata = value; }
        }
        ...
        /// gms有效期
        /// </summary>
        public DateTime? Gmspdata
        {
            get { return _gmspdata; }
            set { _gmspdata = value; }
        }
        /// <summary>
        /// 开票单位
