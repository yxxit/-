...
namespace XBase.Model.Office.HumanManager
{
    ...
    public class EmployeeInfoModel
    {
        ...
        private int _corrlinkman;//客户员工关联客户联系人
        private string _ufpersonId;//用友用户
        private string _ufpersonname;

        private string _ufEmployeeId;//用友用户
        private string _ufEmployeename;

        private string _custid;//客户单位     
        private string _custname;

        private string _roletype;//角色分类
        ...
        public string UfEmployeeId
        {
            get { return _ufEmployeeId; }
            set { _ufEmployeeId = value; }
        }
       

        public string UfEmployeename
        {
            get { return _ufEmployeename; }
            set { _ufEmployeename = value; }
        }

        public string UfpersonId
        {
            get { return _ufpersonId; }
            set { _ufpersonId = value; }
        }
      
        public string Ufpersonname
        {
            get { return _ufpersonname; }
            set { _ufpersonname = value; }
        }
        /// <summary>
        /// 专业描述
        /// </summary>
        ...
        public int CorrLinkMan
        {
            set { _corrlinkman = value; }
            get { return _corrlinkman; }
        }
        #endregion Model
